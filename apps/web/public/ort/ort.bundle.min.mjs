  ...
  La = V(() => {
    (Na = (t, e) => {
      ...
      if (n != null) {
        ...
        for (let w = 0; w < i; w++)
          for (let S = 0; S < o; S++) {
            const x = (t.data[m++] - c[0]) * d[0],
              $ = (t.data[g++] - c[1]) * d[1],
              T = (t.data[b++] - c[2]) * d[2],
              I = y === -1 ? 255 : (t.data[y++] - c[3]) * d[3];
            (n.fillStyle = 'rgba(' + x + ',' + $ + ',' + T + ',' + I + ')'),
              n.fillRect(S, w, 1, 1);
          }
      ...
      (Va = (t, e) => {
        ...
        if (r != null) {
          let o, i, s;
          e?.tensorLayout !== void 0 && e.tensorLayout === 'NHWC'
            ? ((o = t.dims[2]), (i = t.dims[1]), (s = t.dims[3]))
            : ((o = t.dims[3]), (i = t.dims[2]), (s = t.dims[1]));
          ...
          for (let E = 0; E < i * o; b += g, y += g, w += g, S += g, E++)
            (n.data[b] = (t.data[x++] - p[0]) * c[0]),
              (n.data[y] = (t.data[$++] - p[1]) * c[1]),
              (n.data[w] = (t.data[T++] - p[2]) * c[2]),
    ...
    (qn = (t, e) => {
      ...
      for (let E = 0; E < c; E++, g += m, y += m, b += m, w += m)
        (p[S++] = (t[g] + s[0]) / i[0]),
          (p[x++] = (t[b] + s[1]) / i[1]),
          (p[$++] = (t[y] + s[2]) / i[2]),
          T !== -1 && w !== -1 && (p[T++] = (t[w] + s[3]) / i[3]);
      return d === 'RGBA'
        ? new De('float32', p, [1, 4, r, n])
        : new De('float32', p, [1, 3, r, n]);
    }),
      (Wa = async (t, e) => {
        ...
        if (r) {
          ...
          if (m != null) {
            ...
            if (
              (e !== void 0 &&
                ...
                ((g = e.resizedHeight), (b = e.resizedWidth)),
              e !== void 0)
            ) {
          ...
          if (m != null) {
            const g = t.height,
              b = t.width;
            return (
              m.drawImage(t, 0, 0, b, g),
              (s = m.getImageData(0, 0, b, g).data),
              (u.height = g),
              (u.width = b),
              qn(s, u)
            );
            ...
            return new Promise((p, m) => {
              ...
              (y.crossOrigin = 'Anonymous'),
                ...
                (y.onload = () => {
                  (g.width = y.width),
                    (g.height = y.height),
                    b.drawImage(y, 0, 0, g.width, g.height);
                  const w = b.getImageData(0, 0, g.width, g.height);
      ...
      (Ga = (t, e) => {
        const { width: r, height: n, download: o, dispose: i } = e,
          s = [1, n, r, 4];
        return new De({
          location: 'texture',
          type: 'float32',
      ...
      (Ha = (t, e) => {
        const { dataType: r, dims: n, download: o, dispose: i } = e;
        return new De({
          location: 'gpu-buffer',
          type: r ?? 'float32',
          gpuBuffer: t,
  ...
  Qa = V(() => {
    (Pt = new Map([
      ...
      (Za = () => {
        if (!ja) {
          ja = !0;
          const t = typeof BigInt64Array < 'u' && BigInt64Array.from,
            e = typeof BigUint64Array < 'u' && BigUint64Array.from,
            r = globalThis.Float16Array,
            n = typeof r < 'u' && r.from;
          t && (Pt.set('int64', BigInt64Array), Xt.set(BigInt64Array, 'int64')),
            e &&
              (Pt.set('uint64', BigUint64Array),
              Xt.set(BigUint64Array, 'uint64')),
            n
              ? (Pt.set('float16', r), Xt.set(r, 'float16'))
              : Pt.set('float16', Uint16Array);
        }
      });
  });
var Ya,
...
var Sr,
  ...
  jn = V(() => {
    Fn();
    (Sr = (t, e) => {
      (typeof ke.trace > 'u' ? !ke.wasm.trace : !ke.trace) ||
      ...
      async run(e, r, n) {
        ...
        if (typeof r == 'object') {
          ...
          if (Array.isArray(r)) {
            ...
            for (const m of this.outputNames)
              if (p.indexOf(m) !== -1) {
                const g = r[m];
                (g === null || g instanceof Ke) &&
                  ((c = !0), (s = !1), (o[m] = g));
              }
            if (c) {
              if (typeof n == 'object' && n !== null) i = n;
        ...
        if (s) for (const c of this.outputNames) o[c] = null;
        const u = await this.handler.run(e, o, i),
          d = {};
        for (const c in u)
          if (Object.hasOwn(u, c)) {
            ...
            p instanceof Ke
              ? (d[c] = p)
              : (d[c] = new Ke(p.type, p.data, p.dims));
          }
        ...
        if (typeof e == 'string') {
          ...
          if (typeof r == 'object' && r !== null) s = r;
            ...
            if (m < 0 || m >= p.byteLength)
              throw new RangeError(
                `'byteOffset' is out of range [0, ${p.byteLength}).`
              );
            if (((g = e.byteLength - m), typeof n == 'number')) {
              ...
              if (g <= 0 || m + g > p.byteLength)
                throw new RangeError(
                  `'byteLength' is out of range (0, ${p.byteLength - m}].`
                );
        ...
        try {
          switch (e) {
            ...
            case 'run': {
              ...
              zr(n, o, i, s, new Array(s.length).fill(null), u).then(
                (d) => {
                  d.some((c) => c[3] !== 'cpu')
                    ? postMessage({
                        type: e,
                    ...
                    : postMessage({ type: e, out: d }, Br([...i, ...d]));
                },
                (d) => {
...
async function ps(t = {}) {
  ...
  (e.mountExternalData = (a, l) => {
    a.startsWith('./') && (a = a.substring(2)),
      (e.Zc || (e.Zc = new Map())).set(a, l);
  }),
    (e.unmountExternalData = () => {
      delete e.Zc;
    }),
    globalThis.SharedArrayBuffer ??
      new WebAssembly.Memory({ initial: 0, maximum: 0, ae: !0 }).buffer
        .constructor;
  const i =
    (a) =>
    async (...l) => {
...
`)
  ...
  e.jsepInit = (a, l) => {
    if (a === 'webgpu') {
      ...
      const h = e.gd;
      (e.jsepRegisterBuffer = (f, _, C, P) => h.registerBuffer(f, _, C, P)),
        (e.jsepGetBuffer = (f) => h.getBuffer(f)),
        (e.jsepCreateDownloader = (f, _, C) => h.createDownloader(f, _, C)),
      ...
      ([
        ...
        (e.webnnReleaseTensorId = e.vd),
        (e.webnnUploadTensor = e.xd),
        (e.webnnRegisterMLContext = e.Yd),
        (e.webnnOnRunStart = (f) => h.onRunStart(f)),
        (e.webnnOnRunEnd = h.onRunEnd.bind(h)),
        (e.webnnOnReleaseSession = (f) => {
          h.onReleaseSession(f);
        }),
        (e.webnnCreateMLTensorDownloader = (f, _) =>
          h.createMLTensorDownloader(f, _)),
        (e.webnnRegisterMLTensor = (f, _, C, P) =>
          h.registerMLTensor(f, _, C, P)),
        (e.webnnCreateMLContext = (f) => h.createMLContext(f)),
        (e.webnnRegisterMLConstant = (f, _, C, P, B, G) =>
          h.registerMLConstant(f, _, C, P, B, e.Zc, G)),
        ...
        (e.webnnIsGraphInputOutputTypeSupported =
          h.isGraphInputOutputTypeSupported.bind(h));
    }
  };
  let s = () => {
    const a =
    ...
    (() => {
      ...
      i !== void 0 &&
        ((e._OrtRun = i(e._OrtRun)),
        (e._OrtRunWithBinding = i(e._OrtRunWithBinding))),
      (s = void 0);
  };
  e.asyncInit = () => {
    s?.();
  ...
  if (o) {
    const a = (l) => {
      try {
        ...
        if (f === 'load') {
          const _ = [];
          (self.onmessage = (C) => _.push(C)),
            (x = () => {
              postMessage({ Uc: 'loaded' });
              for (const C of _) a(C);
              self.onmessage = a;
            });
          for (const C of h.Ad)
            (e[C] && !e[C].proxy) ||
  ...
  function Te() {
    ...
    (e.HEAP8 = N = new Int8Array(a)),
      ...
      (e.HEAPU32 = W = new Uint32Array(a)),
      (j = new Float32Array(a)),
      (Y = new Float64Array(a)),
      (Z = new BigInt64Array(a)),
      (te = new BigUint64Array(a));
  }
  function re() {
    (we = !0), o ? x() : ct.tb();
  }
  ...
  async function Se() {
    function a(f, _) {
      ...
      return (
        ...
        (Mi = f.vb),
        (e._OrtInit = f.wb),
        (e._OrtGetLastError = f.xb),
        (e._OrtCreateSessionOptions = f.yb),
        (e._OrtAppendExecutionProvider = f.zb),
        (e._OrtAddFreeDimensionOverride = f.Ab),
        (e._OrtAddSessionConfigEntry = f.Bb),
        (e._OrtReleaseSessionOptions = f.Cb),
        (e._OrtCreateSession = f.Db),
        (e._OrtReleaseSession = f.Eb),
        (e._OrtGetInputOutputCount = f.Fb),
        (e._OrtGetInputOutputMetadata = f.Gb),
        (e._OrtFree = f.Hb),
        (e._OrtCreateTensor = f.Ib),
        (e._OrtGetTensorData = f.Jb),
        (e._OrtReleaseTensor = f.Kb),
        (e._OrtCreateRunOptions = f.Lb),
        (e._OrtAddRunConfigEntry = f.Mb),
        (e._OrtReleaseRunOptions = f.Nb),
        (e._OrtCreateBinding = f.Ob),
        (e._OrtBindInput = f.Pb),
        (e._OrtBindOutput = f.Qb),
        (e._OrtClearBoundOutputs = f.Rb),
        (e._OrtReleaseBinding = f.Sb),
        (e._OrtRunWithBinding = f.Tb),
        (e._OrtRun = f.Ub),
        (e._OrtEndProfiling = f.Vb),
        (e._JsepOutput = f.Wb),
        (e._JsepGetNodeName = f.Xb),
        (_r = f.Yb),
        (tt = e._free = f.Zb),
        (Zt = e._malloc = f._b),
        (Dn = f.bc),
    ...
    return e.instantiateWasm
      ...
      : o
        ? a(new WebAssembly.Instance(b, X()), b)
        : ((ie ??= e.locateFile
            ? e.locateFile
  ...
  var ze = (a) => {
    ...
    ve = (a, l, ...h) => {
      ...
      for (f of h)
        typeof f == 'bigint'
          ? (((v(), Z)[B++ >>> 0] = 1n), ((v(), Z)[B++ >>> 0] = f))
          : (((v(), Z)[B++ >>> 0] = 0n), ((v(), Y)[B++ >>> 0] = f));
    ...
    new Promise((l) => {
      (a.onmessage = (_) => {
        ...
        if (((_ = C.Uc), C.ad && C.ad != _r())) {
          var P = It[C.ad];
          P
            ? P.postMessage(C, C.ud)
            : E(
                `Internal error! Worker sent a message "${_}" to target pthread ${C.ad}, but that thread no longer exists!`
              );
        } else
          _ === 'checkMailbox'
            ? fr()
                ...
                : _ === 'loaded'
                  ...
                  : C.target === 'setimmediate'
                    ...
                    : _ === 'uncaughtException'
                      ...
                      : _ === 'callHandler'
                        ? e[C.zd](...C.args)
                        : _ && E(`worker sent an unknown command ${_}`);
      }),
        (a.onerror = (_) => {
          throw (
            (E(`worker sent an error! ${_.filename}:${_.lineno}: ${_.message}`),
            _)
          );
        });
      var h,
  ...
  function Zo(a, l, h, f) {
    ...
    return o && _.length === 0
      ? jo(a, l, h, f)
      : ((a = { Od: h, Tc: a, dd: f, ud: _ }),
        o ? ((a.Uc = 'spawnThread'), postMessage(a, _), 0) : Fe(a));
  }
  function mp(a) {
    throw ((Ut ||= a >>> 0), Ut);
  }
  var Qo = globalThis.TextDecoder && new TextDecoder(),
    Yo = (a, l, h, f) => {
      if (((h = l + h), f)) return h;
      for (; a[l] && !(l >= h); ) ++l;
      return l;
    ...
    Xo = (a, l = 0, h, f) => {
      if (16 < (h = Yo(a, (l >>>= 0), h, f)) - l && a.buffer && Qo)
        return Qo.decode(
          a.buffer instanceof ArrayBuffer ? a.subarray(l, h) : a.slice(l, h)
        );
      for (f = ''; l < h; ) {
        var _ = a[l++];
        if (128 & _) {
  ...
  function lt(a, l, h = {}) {
    return ((f, _, C = {}) => {
      ...
      (xn[f] = _),
        delete hp[f],
        Object.hasOwn($n, f) &&
          ((_ = $n[f]), delete $n[f], _.forEach((B) => B()));
    })(a, l, h);
  }
  var pi = (a, l, h) => {
    switch (l) {
  ...
  function xp(a, l, h) {
    function f(C) {
      var P = (v(), W)[(C >>> 2) >>> 0];
      return (
        (C = (v(), W)[((C + 4) >>> 2) >>> 0]), new _((v(), N).buffer, C, P)
      );
    }
    var _ = [
      Int8Array,
    ...
    lt((a >>>= 0), { name: (h = Je(h >>> 0)), Qc: f, Wc: f }, { Bd: !0 });
  }
  var gt = (a, l, h) => {
      var f = (v(), K);
      if (((l >>>= 0), 0 < h)) {
  ...
  function Sp(a, l) {
    lt((a >>>= 0), {
      ...
      Xc(h, f) {
        ...
        var C = _ ? pr(f) : f.length,
          P = Zt(4 + C + 1),
          B = P + 4;
        return (
          ((v(), W)[(P >>> 2) >>> 0] = C),
          _ ? gt(f, B, C + 1) : (v(), K).set(f, B >>> 0),
          h !== null && h.push(tt, P),
          P
        );
      },
  ...
  var fi = globalThis.TextDecoder ? new TextDecoder('utf-16le') : void 0,
    Tp = (a, l, h) => {
  ...
  function In(a) {
    (a >>>= 0),
      Dp ||
        (Atomics.waitAsync((v(), D), a >>> 2, a).value.then(fr),
        (a += 128),
        Atomics.store((v(), D), a >>> 2, 1));
  }
  var fr = () =>
    mr(() => {
      var a = _r();
  ...
  function Bp(a, l) {
    (a >>>= 0) == l >>> 0
      ? setTimeout(fr)
      : o
        ? postMessage({ ad: a, Uc: 'checkMailbox' })
        : (a = It[a]) && a.postMessage({ Uc: 'checkMailbox' });
  }
  var Cn = [];
  function Mp(a, l, h, f, _) {
    for (
      l >>>= 0, _ >>>= 0, Cn.length = 0, h = _ >>> 3, f = (_ + f) >>> 3;
      h < f;
    ) {
      var C;
      (C = (v(), Z)[h++ >>> 0] ? (v(), Z)[h++ >>> 0] : (v(), Y)[h++ >>> 0]),
        Cn.push(C);
    }
      ...
      try {
        ...
        A ||
          ...
          et &&
            yt === 1 &&
            gr.length === 0 &&
            ((yt = 0), (Ue += 1), hr(ka), typeof Fibers < 'u' && Fibers.ce()));
      }
    };
    return yi.set(a, l), l;
  }
          ...
          if (yt === 0) {
            ...
            l((_ = 0) => {
              if (!A && ((hi = _), (h = !0), f)) {
                (yt = 2),
                  hr(() => Pa(et)),
                  typeof MainLoop < 'u' && MainLoop.yd && MainLoop.resume(),
                  (_ = !1);
                try {
                  var C = (() => {
                    var G = (v(), D)[((et + 8) >>> 2) >>> 0];
            ...
            yt === 2
              ? ((yt = 0), hr(Oa), tt(et), (et = null), Wp.forEach(mr))
              : U(`invalid state: ${yt}`);
          return hi;
        }
      })((l) => {
  ...
  function jp(a, l, h) {
    ...
    switch (
      ...
      case 3:
        ...
        break;
      case 1:
        (P.getStringOrSymbol = yr),
          (B = 'toValue(handle)[getStringOrSymbol(methodName)]');
    }
    return (
      (B += `(${a})`),
      f.Cd ||
        ((P.toReturnWire = l),
        (P.emval_returnValue = qp),
  ...
  ${B}
      ...
      (B = `methodCaller<(${_.map((G) => G.name)}) => ${f.name}>`),
      Hp(Object.defineProperty(h, 'name', { value: B }))
    );
  }
  function Zp(a, l) {
  ...
  function sm(a, l) {
    (a = -9007199254740992 > a || 9007199254740992 < a ? NaN : Number(a)),
      (l >>>= 0),
      (a = new Date(1e3 * a)),
      ((v(), D)[(l >>> 2) >>> 0] = a.getUTCSeconds()),
      ((v(), D)[((l + 4) >>> 2) >>> 0] = a.getUTCMinutes()),
      ((v(), D)[((l + 8) >>> 2) >>> 0] = a.getUTCHours()),
      ((v(), D)[((l + 12) >>> 2) >>> 0] = a.getUTCDate()),
      ((v(), D)[((l + 16) >>> 2) >>> 0] = a.getUTCMonth()),
      ((v(), D)[((l + 20) >>> 2) >>> 0] = a.getUTCFullYear() - 1900),
      ((v(), D)[((l + 24) >>> 2) >>> 0] = a.getUTCDay()),
      (a =
  ...
  var _i = (a) => a % 4 == 0 && (a % 100 != 0 || a % 400 == 0),
    vi = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
    $i = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
  function um(a, l) {
    (a = -9007199254740992 > a || 9007199254740992 < a ? NaN : Number(a)),
      (l >>>= 0),
      (a = new Date(1e3 * a)),
      ((v(), D)[(l >>> 2) >>> 0] = a.getSeconds()),
      ((v(), D)[((l + 4) >>> 2) >>> 0] = a.getMinutes()),
      ((v(), D)[((l + 8) >>> 2) >>> 0] = a.getHours()),
      ((v(), D)[((l + 12) >>> 2) >>> 0] = a.getDate()),
      ((v(), D)[((l + 16) >>> 2) >>> 0] = a.getMonth()),
      ((v(), D)[((l + 20) >>> 2) >>> 0] = a.getFullYear() - 1900),
      ((v(), D)[((l + 24) >>> 2) >>> 0] = a.getDay());
    var h =
      ((_i(a.getFullYear()) ? vi : $i)[a.getMonth()] + a.getDate() - 1) | 0;
    ((v(), D)[((l + 28) >>> 2) >>> 0] = h),
      ((v(), D)[((l + 36) >>> 2) >>> 0] = -60 * a.getTimezoneOffset()),
      (h = new Date(a.getFullYear(), 6, 1).getTimezoneOffset());
    var f = new Date(a.getFullYear(), 0, 1).getTimezoneOffset();
    (a = 0 | (h != f && a.getTimezoneOffset() == Math.min(f, h))),
      ((v(), D)[((l + 32) >>> 2) >>> 0] = a);
  }
  function dm(a) {
    a >>>= 0;
    var l = new Date(
      ...
      _ = new Date(l.getFullYear(), 6, 1).getTimezoneOffset(),
      C = new Date(l.getFullYear(), 0, 1).getTimezoneOffset(),
      P = Math.min(C, _);
    return (
      0 > h
        ? ((v(), D)[((a + 32) >>> 2) >>> 0] = +(_ != C && P == f))
        : 0 < h != (P == f) &&
          ((_ = Math.max(C, _)),
          l.setTime(l.getTime() + 6e4 * ((0 < h ? P : _) - f))),
      ((v(), D)[((a + 24) >>> 2) >>> 0] = l.getDay()),
      (h =
        ((_i(l.getFullYear()) ? vi : $i)[l.getMonth()] + l.getDate() - 1) | 0),
      ((v(), D)[((a + 28) >>> 2) >>> 0] = h),
      ((v(), D)[(a >>> 2) >>> 0] = l.getSeconds()),
      ((v(), D)[((a + 4) >>> 2) >>> 0] = l.getMinutes()),
      ((v(), D)[((a + 8) >>> 2) >>> 0] = l.getHours()),
      ((v(), D)[((a + 12) >>> 2) >>> 0] = l.getDate()),
      ((v(), D)[((a + 16) >>> 2) >>> 0] = l.getMonth()),
      ((v(), D)[((a + 20) >>> 2) >>> 0] = l.getYear()),
      (a = l.getTime()),
      BigInt(isNaN(a) ? -1 : a / 1e3)
    );
  }
  ...
  var jt = {},
    lm = () => performance.timeOrigin + performance.now();
  function Ti(a, l) {
  ...
  function cm(a, l, h, f) {
    ...
    ((v(), W)[(a >>> 2) >>> 0] = 60 * P),
      ...
      (l = l(_)),
      _ < C ? (gt(a, h, 17), gt(l, f, 17)) : (gt(a, f, 17), gt(l, h, 17));
  }
  var pm = () => Date.now(),
    mm = 1;
  function fm(a, l, h) {
    ...
    return (
      (a = Math.round(1e6 * a)), ((v(), Z)[(h >>> 3) >>> 0] = BigInt(a)), 0
    );
  }
  var Pn = [],
    Ii = (a, l) => {
  ...
  var vm = () => navigator.hardwareConcurrency,
    At = {},
    br = (a) => {
      var l;
      return (l = /\bwasm-function\[\d+\]:(0x[0-9a-f]+)/.exec(a))
        ? +l[1]
        : (l = /:(\d+):\d+(?:\)|$)/.exec(a))
          ? 2147483648 | +l[1]
          : 0;
...
`);
  ...
  function xm(a) {
    ...
    for (var h = 1; 4 >= h; h *= 2) {
      ...
      e: {
        f =
          ((Math.min(4294901760, 65536 * Math.ceil(Math.max(a, f) / 65536)) -
  ...
  var Bi,
    ...
    Nn = {
      929356: (a, l, h, f, _) => {
        ...
        if (
          ((a = Ae(Number(a >>> 0))).startsWith('./') && (a = a.substring(2)),
          !(a = e.Zc.get(a)))
        )
          return 2;
        if (
      ...
      932940: (a, l, h, f, _) => {
        e.ac('ReduceMean', a, {
          ...
          noopWithEmptyAxes: !!h,
          axes: f
            ? Array.from((v(), D).subarray(Number(f) >>> 0, Number(_) >>> 0))
            : [],
        });
      },
      933115: (a, l, h, f, _) => {
      ...
      934748: (a, l, h) => {
        e.ac('Transpose', a, {
          perm: l
            ? Array.from((v(), D).subarray(Number(l) >>> 0, Number(h) >>> 0))
            : [],
        });
      },
      934872: (a, l, h, f) => {
      ...
      935138: (a, l, h, f, _, C, P, B, G, H, ue, pe, _e, xe, bt) => {
        e.ac('ConvTranspose', a, {
          ...
          wIsConst: () => !!(v(), N)[H >>> 0],
          outputPadding: ue
            ? Array.from((v(), D).subarray(Number(ue) >>> 0, Number(pe) >>> 0))
            : [],
          outputShape: _e
            ? Array.from((v(), D).subarray(Number(_e) >>> 0, Number(xe) >>> 0))
            : [],
          activation: Ae(bt),
        });
      },
      935571: (a, l, h, f, _, C, P, B, G, H, ue, pe, _e, xe) => {
        e.ac('ConvTranspose', a, {
          ...
          dilations: Array.from(
            (v(), D).subarray(Number(h) >>> 0, (2 + (Number(h) >>> 0)) >>> 0)
          ),
          group: f,
          kernelShape: Array.from(
            (v(), D).subarray(Number(_) >>> 0, (2 + (Number(_) >>> 0)) >>> 0)
          ),
          pads: Array.from(
            (v(), D).subarray(Number(C) >>> 0, (4 + (Number(C) >>> 0)) >>> 0)
          ),
          strides: Array.from(
            (v(), D).subarray(Number(P) >>> 0, (2 + (Number(P) >>> 0)) >>> 0)
          ),
          wIsConst: () => !!(v(), N)[G >>> 0],
          outputPadding: H
            ? Array.from((v(), D).subarray(Number(H) >>> 0, Number(ue) >>> 0))
            : [],
          outputShape: pe
            ? Array.from((v(), D).subarray(Number(pe) >>> 0, Number(_e) >>> 0))
            : [],
          activation: Ae(xe),
        });
      },
      ...
      937417: (a, l, h, f, _, C, P, B, G, H, ue, pe, _e, xe) => {
        e.ac('AveragePool', a, {
          ...
          storage_order: _,
          dilations: C
            ? Array.from((v(), D).subarray(Number(C) >>> 0, Number(P) >>> 0))
            : [],
          kernel_shape: B
            ? Array.from((v(), D).subarray(Number(B) >>> 0, Number(G) >>> 0))
            : [],
          pads: H
            ? Array.from((v(), D).subarray(Number(H) >>> 0, Number(ue) >>> 0))
            : [],
      ...
      940526: (a, l, h, f, _, C, P, B, G, H, ue) => {
        e.ac('Resize', a, {
          antialias: l,
          axes: h
            ? Array.from((v(), D).subarray(Number(h) >>> 0, Number(f) >>> 0))
            : [],
      ...
      942659: (a, l, h, f, _, C, P, B, G) => {
        e.ac('Attention', a, {
          ...
          qkvHiddenSizes: P
            ? Array.from(
                (v(), D).subarray(Number(B) >>> 0, (Number(B) + P) >>> 0)
              )
            : [],
      ...
      943103: (a, l, h, f, _, C, P, B, G, H, ue, pe, _e, xe, bt, Vn) => {
        e.ac('Conv', a, {
          ...
          activation: Ae(xe),
          activation_params: bt
            ? Array.from((v(), j).subarray(Number(bt) >>> 0, Number(Vn) >>> 0))
            : [],
        });
      },
      943687: (a) => {
...
var ys,
  ...
  Cr = V(() => {
    Ir();
    (ys = typeof location > 'u' ? void 0 : location.origin),
      ...
      (Tf = () => {
        if (1) {
          if (Xn) {
            const t = URL;
            return new URL(
              new t('ort.bundle.min.mjs', import.meta.url).href,
              ys
            ).href;
          }
      ...
      (Cf = (t, e) => `${e ?? './'}${t}`),
      (ws = async (t) => {
        const r = await (await fetch(t, { credentials: 'same-origin' })).blob();
        return URL.createObjectURL(r);
      }),
      (Af = async (t) =>
        (await import(/*webpackIgnore:true*/ /*@vite-ignore*/ t)).default),
      (hs = (cs(), Yt(ls)).default),
      (_s = async () => {
        if (!Le)
          throw new Error(
      ...
      (vs = async (t, e, r, n) => {
        ...
        {
          const i = 'ort-wasm-simd-threaded.jsep.mjs',
            s = t ?? If(i, e),
            u = !!1 && r && s && !Yn(s, e),
            d = u ? await ws(s) : (s ?? Cf(i, e));
    ...
    (We = (t, e) => {
      ...
      (me = (t) => {
        ...
        try {
          ...
          const i = Number(e.getValue(o, n === 4 ? 'i32' : 'i64')),
            s = e.getValue(o + n, '*'),
            u = s ? e.UTF8ToString(s) : '';
    ...
    xs = (t) => {
      ...
      try {
        ...
        return (
          ...
          t?.extra !== void 0 &&
            er(t.extra, '', new WeakSet(), (s, u) => {
              const d = We(s, n),
                c = We(u, n);
              e._OrtAddRunConfigEntry(r, d, c) !== 0 &&
                me(`Can't set a run config entry: ${s} - ${u}.`);
            }),
          [r, n]
        );
      } catch (i) {
  ...
  Is = V(() => {
    ...
    (Of = (t) => {
      ...
      (Ur = (t, e, r, n) => {
        const o = We(e, n),
          i = We(r, n);
        ge()._OrtAddSessionConfigEntry(t, o, i) !== 0 &&
          me(`Can't set a session config entry: ${e} - ${r}.`);
      }),
      (Bf = async (t, e, r) => {
        const n = e.executionProviders;
        for (const o of n) {
          ...
          let u = We(i, r),
            ...
            p = 0;
          if (d > 0) {
            (c = ge()._malloc(d * ge().PTR_SIZE)),
              r.push(c),
              (p = ge()._malloc(d * ge().PTR_SIZE)),
              r.push(p);
            for (let m = 0; m < d; m++)
              ge().setValue(c + m * ge().PTR_SIZE, s[m][0], '*'),
                ge().setValue(p + m * ge().PTR_SIZE, s[m][1], '*');
          }
          (await ge()._OrtAppendExecutionProvider(t, u, c, p, d)) !== 0 &&
      ...
      (Ts = async (t) => {
        ...
        try {
          ...
          if (
            ...
            o.executionProviders && (await Bf(r, o, n)),
          ...
          if (o.freeDimensionOverrides)
            for (const [m, g] of Object.entries(o.freeDimensionOverrides)) {
              if (typeof m != 'string')
                throw new Error(
                  `free dimension override name must be a string: ${m}`
                );
              ...
              const b = We(m, n);
              e._OrtAddFreeDimensionOverride(r, b, g) !== 0 &&
                me(`Can't set a free dimension override: ${m} - ${g}.`);
            }
          return (
            o.extra !== void 0 &&
              er(o.extra, '', new WeakSet(), (m, g) => {
                Ur(r, m, g, n);
              }),
            [r, n]
          );
          ...
          throw (
            (r !== 0 &&
              ...
              me("Can't release session options."),
            n.forEach((s) => e._free(s)),
            i)
          );
        }
  ...
  ro = V(() => {
    ...
    rr = async (t) => {
      if (typeof t == 'string')
        if (!1)
          try {
            const { readFile: e } = Gn('node:fs/promises');
            return new Uint8Array(await e(t));
          } catch (e) {
            if (e.code === 'ERR_FS_FILE_TOO_LARGE') {
              const { createReadStream: r } = Gn('node:fs'),
                n = r(t),
                o = [];
              for await (const i of n) o.push(i);
    ...
    (no = class {
      ...
      (ot = class {
        static calcShape(e, r, n = !1) {
          ...
          if (o === 0) return r;
          if (i === 0) return e;
          const s = Math.max(e.length, r.length),
            u = new Array(s);
          if (n) {
            if (o < 2 || i < 2) return;
            const d = no.calcMatMulShape(
              [e[o - 2], e[o - 1]],
              [r[i - 2], r[i - 1]]
            );
            if (d === void 0) return;
        ...
        static isValidBroadcast(e, r) {
          ...
          if (n > o) return !1;
          for (let i = 1; i <= n; i++)
            if (e[n - i] !== 1 && e[n - i] !== r[o - i]) return !1;
          return !0;
        }
      }),
      (k = class t {
        ...
        static normalizeAxes(e, r) {
          return e.map((n) => t.normalizeAxis(n, r ?? e.length));
        }
          ...
          if (d && d !== 'NOTSET')
            switch (d) {
              ...
              case 'SAME_UPPER':
                ...
                {
                  const m = ((e + r - 1) / r - 1) * r + o - e;
                  return (
                    (i[s] = Math.floor(
                      d === 'SAME_LOWER' ? (m + 1) / 2 : m / 2
                    )),
                    (i[u] = m - i[s]),
                    Math.floor((e + m - o) / r + 1)
                  );
                }
              default:
      ...
      (Es = -34028234663852886e22),
      (ks = 34028234663852886e22);
  });
var Gr,
  oo = V(() => {
    J();
  ...
  Ms = V(() => {
    ...
    (Os = new Map([
      ...
      (ao = (t, e) => {
        ...
        const o = t.byteLength / n,
          i = new (Lt(e))(t.buffer, t.byteOffset, o);
        switch (e) {
          case 'int64':
          case 'uint64': {
          ...
          case 'uint32': {
            ...
            const s = Int32Array.from(i, Number);
            return new Uint8Array(s.buffer);
          }
          default:
      ...
      (zs = (t, e) => {
        ...
        switch (e) {
          case 'int64': {
            const o = BigInt64Array.from(n, BigInt);
          ...
          case 'uint64': {
            ...
            const o = BigUint64Array.from(n, BigInt);
            return new Uint8Array(o.buffer);
          }
          case 'int8': {
            ...
            const o = Int8Array.from(n, Number);
            return new Uint8Array(o.buffer);
          }
          case 'uint8': {
          ...
          case 'uint32': {
            ...
            const o = Uint32Array.from(n, Number);
            return new Uint8Array(o.buffer);
          }
          default:
      ...
      (Ds = (t, e) => {
        ...
        return e.length > 0
          ? Math.ceil((e.reduce((n, o) => n * o) * r) / 8)
          : 0;
      }),
      (Hr = class {
        constructor(e) {
        ...
        destroy() {
          se('verbose', () => '[WebNN] TensorWrapper.destroy'),
        ...
        async read(e) {
          if (this.fallbackDataType) {
            const r = await this.mlContext.readTensor(this.mlTensor),
              n = zs(new Uint8Array(r), this.dataType);
            if (e) {
              (e instanceof ArrayBuffer
                ? new Uint8Array(e)
      ...
      (Fr = class {
        ...
        async ensureTensor(e, r, n, o) {
          let i = this.tensorManager.getMLContext(e),
            s = this.tensorManager.getMLOpSupportLimits(e),
            u;
        ...
        async download(e) {
          if (this.activeUpload) {
            const r = this.wrapper?.isDataConverted
              ? zs(this.activeUpload, this.wrapper?.type)
              : this.activeUpload;
            if (e) {
              e instanceof ArrayBuffer
      ...
      (io = class {
        ...
        getMLContext(e) {
          const r = this.backend.getMLContext(e);
        ...
        releaseTensorId(e) {
          const r = this.tensorTrackersById.get(e);
          r &&
        ...
        async ensureTensor(e, r, n, o, i) {
          ...
          const s = this.tensorTrackersById.get(r);
          if (!s) throw new Error('Tensor not found.');
          return s.ensureTensor(e, n, o, i);
        }
        upload(e, r) {
          const n = this.tensorTrackersById.get(e);
        ...
        releaseTensorsForSession(e) {
          for (const r of this.freeTensors) r.sessionId === e && r.destroy();
          this.freeTensors = this.freeTensors.filter((r) => r.sessionId !== e);
        }
        registerTensor(e, r, n, o) {
          const i = this.getMLContext(e),
            s = Ps(),
            u = new Hr({
              sessionId: e,
              context: i,
          ...
          return (
            this.tensorTrackersById.set(s, new Fr(this, u)),
            this.externalTensors.add(u),
            s
          );
        }
        async getCachedTensor(e, r, n, o, i, s, u) {
          const d = this.getMLContext(e);
          for (const [p, m] of this.freeTensors.entries())
            if (m.canReuseTensor(d, r, n)) {
              ...
              const g = this.freeTensors.splice(p, 1)[0];
  ...
  Rs = V(() => {
    ...
    (qr = new Map([
      ...
      (Kr = class {
        ...
        onRunStart(e) {
          se('verbose', () => `[WebNN] onRunStart {sessionId: ${e}}`),
            (this.activeSessionId = e);
        }
        onRunEnd(e) {
          se('verbose', () => `[WebNN] onRunEnd {sessionId: ${e}}`);
          const r = this.temporarySessionTensorIds.get(e);
          if (r) {
            for (const n of r)
              se(
                'verbose',
        ...
        async createMLContext(e) {
          if (e instanceof GPUDevice) {
            const n = this.mlContextCache.findIndex((o) => o.gpuDevice === e);
            if (n !== -1) return this.mlContextCache[n].mlContext;
            {
              const o = await navigator.ml.createContext(e);
              return (
                this.mlContextCache.push({ gpuDevice: e, mlContext: o }), o
              );
            }
          } else if (e === void 0) {
            const n = this.mlContextCache.findIndex(
              (o) => o.options === void 0 && o.gpuDevice === void 0
            );
            if (n !== -1) return this.mlContextCache[n].mlContext;
            {
              const o = await navigator.ml.createContext();
              return this.mlContextCache.push({ mlContext: o }), o;
            }
          }
          const r = this.mlContextCache.findIndex((n) => Lf(n.options, e));
          if (r !== -1) return this.mlContextCache[r].mlContext;
          {
            const n = await navigator.ml.createContext(e);
        ...
        onReleaseSession(e) {
          ...
          const r = this.mlContextBySessionId.get(e);
          if (!r) return;
          ...
          const n = this.sessionIdsByMLContext.get(r);
          if ((n.delete(e), n.size === 0)) {
            this.sessionIdsByMLContext.delete(r);
            const o = this.mlContextCache.findIndex((i) => i.mlContext === r);
        ...
        async createTemporaryTensor(e, r, n) {
          se(
            'verbose',
            () =>
              `[WebNN] createTemporaryTensor {onnxDataType: ${r}, shape: ${n}}`
          );
          const o = qr.get(r);
          if (!o) throw new Error(`Unsupported ONNX data type: ${r}`);
          const i = this.tensorManager.reserveTensorId();
          await this.tensorManager.ensureTensor(e, i, o, n, !1);
          const s = this.temporarySessionTensorIds.get(e);
        ...
        createMLTensorDownloader(e, r) {
          return async () => {
            const n = await this.tensorManager.download(e);
            return Gr(n, r);
          };
        }
        registerMLTensor(e, r, n, o) {
          ...
          const s = this.tensorManager.registerTensor(e, r, i, o);
          return (
            se(
              'verbose',
              () =>
                `[WebNN] registerMLTensor {tensor: ${r}, dataType: ${i}, dimensions: ${o}} -> {tensorId: ${s}}`
            ),
            s
          );
        }
        registerMLConstant(e, r, n, o, i, s, u = !1) {
          ...
          switch (i.dataType) {
            ...
            case 'int64':
              if (u) {
                const g = ao(new Uint8Array(p), 'int64');
          ...
          return (
            se(
              'verbose',
              () =>
                `[WebNN] registerMLConstant {dataType: ${i.dataType}, shape: ${i.shape}}} ${u ? '(Note: it was int64 data type and registered to int32 as workaround)' : ''}`
            ),
            o.constant(i, m)
          );
        }
        ...
        isGraphInput(e, r) {
          const n = this.sessionGraphInputs.get(e);
          return n ? n.includes(r) : !1;
        }
        isGraphOutput(e, r) {
          const n = this.sessionGraphOutputs.get(e);
          return n ? n.includes(r) : !1;
        }
  ...
  Ws = V(() => {
    ...
    (Us = new Map([
      ...
      (co = async (t, e, r, n) => {
        ...
        try {
          const s = t.getCommandEncoder();
          t.endComputePass(),
            s.copyBufferToBuffer(e, 0, i, 0, o),
            t.flush(),
            await i.mapAsync(GPUMapMode.READ);
          const u = i.getMappedRange();
          if (n) {
            const d = n();
      ...
      (lo = class {
        ...
        upload(e, r) {
          ...
          const d = this.backend.device.createBuffer({
              mappedAtCreation: !0,
              size: s,
          ...
          const p = this.backend.device.createCommandEncoder();
          p.copyBufferToBuffer(d, 0, u.gpuData.buffer, 0, s),
            this.backend.device.queue.submit([p.finish()]),
            d.destroy(),
        ...
        memcpy(e, r) {
          ...
          const o = this.storageCache.get(r);
          if (!o)
          ...
          const i = uo(n.originalSize),
            s = this.backend.getCommandEncoder();
          this.backend.endComputePass(),
            s.copyBufferToBuffer(n.gpuData.buffer, 0, o.gpuData.buffer, 0, i);
        }
        ...
        create(
          ...
          let n = Wf(e),
            ...
            s = (r & GPUBufferUsage.UNIFORM) === GPUBufferUsage.UNIFORM;
          if (i || s) {
            const c = (i ? this.freeBuffers : this.freeUniformBuffers).get(n);
            c
              ? c.length > 0
                ? (o = c.pop())
          ...
          return (
            ...
            se(
              'verbose',
              () => `[WebGPU] GpuDataManager.create(size=${e}) => id=${u.id}`
            ),
            u
          );
        }
        ...
        release(e) {
          const r = typeof e == 'bigint' ? Number(e) : e,
        ...
        async download(e, r) {
          const n = this.storageCache.get(Number(e));
        ...
        refreshPendingBuffers() {
          if (this.buffersPending.length !== 0)
            if (this.backend.sessionStatus === 'default') {
              for (const e of this.buffersPending) {
                const r = Us.get(e.size);
                if (
                  (e.usage & GPUBufferUsage.STORAGE) ===
                  GPUBufferUsage.STORAGE
                ) {
                  const n = this.freeBuffers.get(e.size) || [];
                  r === void 0 || n.length >= r ? e.destroy() : n.push(e);
                } else if (
                  (e.usage & GPUBufferUsage.UNIFORM) ===
                  GPUBufferUsage.UNIFORM
                ) {
                  const n = this.freeUniformBuffers.get(e.size) || [];
                  r === void 0 || n.length >= r ? e.destroy() : n.push(e);
                } else e.destroy();
              }
              this.buffersPending = [];
              ...
              for (const r of this.buffersPending) e.push(r);
              this.buffersPending = [];
            }
        }
        dispose() {
        ...
        onReleaseSession(e) {
          const r = this.capturedPendingBuffers.get(e);
          r &&
            (r.forEach((n) => {
              n.destroy();
            }),
...
var Dt,
        ...
        return (
          t.forEach((r) => {
            r.length !== 0 &&
              e.push(
                { type: 12, data: r },
                { type: 12, data: k.computeStrides(r) }
              );
          }),
          e
        );
  ...
  fn o2i_${t}(offset: u32) -> ${g.indices} {
    ...
    return indices;
          ...
          I = (U) => ((y.offsetToIndices = !0), s < 2 ? U : `o2i_${t}(${U})`),
          E = [];
        if (s >= 2)
          for (let U = s - 1; U >= 0; U--)
  ...
  fn i2o_${t}(indices: ${g.indices}) -> u32 {
    return ${E.join('+')};
          ...
          z = (U) => ((y.indicesToOffset = !0), s < 2 ? U : `i2o_${t}(${U})`),
          v = (...U) =>
            s === 0 ? '0u' : `${g.indices}(${U.map(b).join(',')})`,
          M = (U, X) => (s < 2 ? `${U}` : `${F(U, X, s)}`),
          N = (U, X, Se) => (s < 2 ? `${U}=${Se};` : `${F(U, X, s)}=${Se};`),
          K = {},
          q = (U, X) => {
            y.broadcastedIndicesToOffset = !0;
            const Se = `${X.name}broadcastedIndicesTo${t}Offset`;
            if (Se in K) return `${Se}(${U})`;
            const Be = [];
            for (let ze = s - 1; ze >= 0; ze--) {
              const Xe = X.indicesGet('outputIndices', ze + X.rank - s);
              Be.push(`${M(x, ze)} * (${Xe} % ${M(S, ze)})`);
            }
            return (
              (K[Se] = `fn ${Se}(outputIndices: ${X.type.indices}) -> u32 {
    ...
    return ${D(`i2o_${t}(indices)`)};
          ...
          j =
            s < 2
              ? ''
              : (() => {
                  const U = u.map((Se) => `d${Se}: u32`).join(', '),
                    X = u.map((Se) => `d${Se}`).join(', ');
                  return `
  fn get_${t}(${U}) -> ${p} {
        ...
        return {
          impl: () => {
            let U = [],
              X = !1;
            return (
              y.offsetToIndices && (U.push(T), (X = !0)),
              y.indicesToOffset && (U.push(A), (X = !0)),
              y.broadcastedIndicesToOffset &&
                (Object.values(K).forEach((Se) => U.push(Se)), (X = !0)),
              y.set && (U.push(ie), (X = !0)),
              y.setByIndices && (U.push(te), (X = !0)),
              y.get && (U.push(j), (X = !0)),
              y.getByIndices && (U.push(W), (X = !0)),
              !i &&
                X &&
                U.unshift(
...
`)
          ...
          set: (...U) => {
            ...
            const Se = U.slice(0, s).map(b).join(',');
            return s === 0
              ? Q('0u', X)
              : s === 1
                ? Q(Se[0], X)
      ...
      (O = (t, e, r, n = 1) => Zr(t, e, r, 'input', n)),
      (R = (t, e, r, n = 1) => Zr(t, e, r, 'output', n)),
      (Gs = (t, e, r) => Zr(t, e, r, 'atomicOutput', 1)),
      (Qr = (t, e, r, n = 1) => Zr(t, e, r, 'internal', n)),
      (mo = class {
        constructor(e, r) {
...
`);
        ...
        uniformDeclaration() {
          ...
          const e = [];
          for (const { name: r, type: n, length: o } of this.uniforms)
            if (o && o > 4)
              n === 'f16'
                ? e.push(
                    `@align(16) ${r}:array<mat2x4<${n}>, ${Math.ceil(o / 8)}>`
                  )
                : e.push(`${r}:array<vec4<${n}>, ${Math.ceil(o / 4)}>`);
            else {
              const i = o == null || o === 1 ? n : `vec${o}<${n}>`;
              e.push(`${r}:${i}`);
            }
          return `
...
var Hf,
  ...
  pt = V(() => {
    ...
    (Hf = (t, e) => {
      ...
      if (e.length !== 0 && e.length !== t[0].dims.length)
        throw new Error(
          `perm size ${e.length} does not match input rank ${t[0].dims.length}`
        );
    }),
      (Fs = (t, e) =>
        e.length !== 0 ? e : [...new Array(t).keys()].reverse()),
      (Ff = (t, e) => k.sortBasedOnPerm(t, Fs(t.length, e))),
      (qf = (t, e, r, n) => {
  ...
  ${w.mainStart()}
    ...
    output[global_idx] = input[global_idx];
        ...
        const { newShape: p, newPerm: m } = Kf(t.dims, o),
          g = k.areEqual(m, [2, 3, 1]),
          b = k.areEqual(m, [3, 1, 2]);
        if (p.length === 2 || g || b) {
          (s = g ? [p[0], p[1] * p[2]] : b ? [p[0] * p[1], p[2]] : p),
            (u = [s[1], s[0]]);
          const w = 16;
          return (
            (c = (S) => {
              const x = O('a', r, s.length),
                $ = R('output', r, u.length);
              return `
            ...
            }),
            {
              ...
              getRunData: () => {
                ...
                return {
                  ...
                  programUniforms: [{ type: 12, data: S }, ...L(s, u)],
                };
              },
              getShaderSource: c,
            }
          ...
          }),
          {
            ...
            getRunData: () => {
              ...
              return {
                ...
                programUniforms: [{ type: 12, data: w }, ...L(s, u)],
              };
            },
            getShaderSource: c,
          }
...
var Zf,
  ...
  ou = V(() => {
    ...
    (Zf = {
      ...
      (rh = (t, e) => {
        for (let r = 0; r < t.length; ++r)
          if (t[t.length - r - 1] !== e - 1 - r) return !1;
        return !0;
      }),
      (nh = (t, e) => {
        const r = [];
      ...
      (it = (t, e, r, n) => {
        let o = t.inputs.length === 1 ? r : go(t.inputs, r),
          i = o.axes;
        i.length === 0 &&
          !o.noopWithEmptyAxes &&
          (i = t.inputs[0].dims.map((b, y) => y));
        let s = k.normalizeAxes(i, t.inputs[0].dims.length),
          u = s,
          d = t.inputs[0],
          c = nh(u, t.inputs[0].dims.length);
        c.length > 0 &&
          ((d = t.compute(Oe(t.inputs[0], c), {
            inputs: [0],
            outputs: [-1],
          })[0]),
          (u = Jf(u.length, d.dims.length)));
        let [p, m] = eh(d.dims, u),
          g = p;
        o.keepDims && (g = th(p, s)),
          t.compute(oh(e, o.cacheKey, [d], n, t.inputs[0].dataType, g, m), {
            inputs: [d],
          });
      }),
      (js = (t, e) => {
          ...
          getShaderSource: (S) => {
            ...
            for (let A = 0, z = 0; A < p; A++)
              g || m.indexOf(A) >= 0
                ...
                : (x.push(
                    `${$.indicesSet('input_indices', A, T.indicesGet('output_indices', z))};`
                  ),
                  z++);
            return `
...
`)
          ...
          getRunData: () => ({
            ...
            programUniforms: [{ type: 12, data: y }, ...L(c, d)],
          }),
        };
      }),
      (go = (t, e) => {
        ...
        return (
          t[1].dims[0] > 0 &&
            t[1].getBigInt64Array().forEach((n) => r.push(Number(n))),
          ee({
            axes: r,
            keepDims: e.keepDims,
      ...
      (st = (t, e, r, n) => {
        const o = t.inputs,
          i = o.length === 1 ? r : go(o, r);
        t.compute(
          Xr(
            e,
            { hint: i.cacheKey, inputDependencies: ['rank'] },
            [o[0]],
            i.noopWithEmptyAxes && i.axes.length === 0 ? ih : n,
            i.axes,
            o[0].dataType,
            i.keepDims,
            i.noopWithEmptyAxes
        ...
        at(t.inputs),
          st(t, 'ReduceMax', e, (n, o, i) => {
            ...
            for (let u = 0; u < n.rank; u++)
              (i.indexOf(u) >= 0 || i.length === 0) &&
                s.push(n.indicesSet('input_indices', u, 0));
            return [
              `${s.join(`
`)}`,
  ...
  Jr = V(() => {
    ...
    (gh = (t, e) => {
      ...
      if (e.qkvHiddenSizes.length > 0) {
        ...
        for (const T of e.qkvHiddenSizes)
          if (T % e.numHeads !== 0)
            throw new Error(
              'qkv_hidden_sizes should be divisible by num_heads'
            );
        (m = e.qkvHiddenSizes[0]),
          (g = e.qkvHiddenSizes[1]),
          (b = e.qkvHiddenSizes[2]);
      }
      const y = c;
      if (m !== g)
        throw new Error(
    ...
    `),
      (yh = (t, e, r, n, o, i, s, u) => {
        ...
        const S = (x) => {
          const $ = R('x', t.dataType, t.dims, d),
            T = [$],
            I = s ? O('seq_lens', s.dataType, s.dims) : void 0;
          I && T.push(I);
          const E = u
            ? O('total_sequence_length_input', u.dataType, u.dims)
            : void 0;
          E && T.push(E);
          const A = Pe(t.dataType),
            z = [
    ...
    if (sum == 0) {
      ...
      ${
        ...
        return {
          ...
          shaderCache: { hint: `${c};${b};${d}`, inputDependencies: w },
          getShaderSource: S,
          getRunData: () => ({
            outputs: [],
      ...
      (bh = (t, e, r, n, o, i, s, u, d) => {
        const c = s + i.kvSequenceLength,
          p = [i.batchSize, i.numHeads, i.sequenceLength, c],
          m = t > 1 && n,
          g = i.kvNumHeads ? i.kvNumHeads : i.numHeads,
          b = m ? [i.batchSize, g, c, i.headSize] : void 0,
          y = i.nReps ? i.nReps : 1,
          w = i.scale === 0 ? 1 / Math.sqrt(i.headSize) : i.scale,
          S = fe(i.headSize),
          x = i.headSize / S,
          $ = 12,
          T = {
        ...
        E && A.push('type'),
          ...
          u && A.push('type'),
          d && A.push('type');
        const z = [{ dims: p, dataType: e.dataType, gpuDataType: 0 }];
        m && z.push({ dims: b, dataType: e.dataType, gpuDataType: 0 });
        const v = (M) => {
          const N = O('q', e.dataType, e.dims, S),
            K = O('key', r.dataType, r.dims, S),
            q = [N, K];
          if (E) {
            const te = O('past_key', n.dataType, n.dims, S);
            q.push(te);
          }
          o && q.push(O('attention_bias', o.dataType, o.dims));
          const Q = u ? O('seq_lens', u.dataType, u.dims) : void 0;
          Q && q.push(Q);
          const D = d
            ? O('total_sequence_length_input', d.dataType, d.dims)
            : void 0;
          D && q.push(D);
          const W = R('output', e.dataType, p),
            j = [W];
  ...
  ${M.mainStart([$, $, 1])}
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      (wh = (t, e, r, n, o, i, s = void 0, u = void 0) => {
        const d = i + o.kvSequenceLength,
          c = o.nReps ? o.nReps : 1,
          p = o.vHiddenSize * c,
          m = t > 1 && n,
          g = o.kvNumHeads ? o.kvNumHeads : o.numHeads,
          b = m ? [o.batchSize, g, d, o.headSize] : void 0,
          y = [o.batchSize, o.sequenceLength, p],
          w = 12,
          S = {
        ...
        const I = [{ dims: y, dataType: e.dataType, gpuDataType: 0 }];
        m && I.push({ dims: b, dataType: e.dataType, gpuDataType: 0 });
        const E = (A) => {
          const z = O('probs', e.dataType, e.dims),
            v = O('v', r.dataType, r.dims),
            M = [z, v];
          $ && M.push(O('past_value', n.dataType, n.dims));
          const N = s ? O('seq_lens', s.dataType, s.dims) : void 0;
          s && M.push(N);
          const K = u
            ? O('total_sequence_length_input', u.dataType, u.dims)
            : void 0;
          u && M.push(K);
          const Q = [R('output', e.dataType, y)];
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
      ...
      (Wt = (t, e, r, n, o, i, s, u, d, c, p = void 0, m = void 0) => {
        const g = Math.min(t.outputCount, 1 + (s ? 1 : 0) + (u ? 1 : 0)),
          b = g > 1 ? c.pastSequenceLength : 0,
          y = b + c.kvSequenceLength,
          w = d && k.size(d.dims) > 0 ? d : void 0,
          S = [e, r];
        g > 1 && s && k.size(s.dims) > 0 && S.push(s),
          w && S.push(w),
          p && S.push(p),
          m && S.push(m);
        const x = t.compute(bh(g, e, r, s, w, c, b, p, m), {
          inputs: S,
          outputs: g > 1 ? [-1, 1] : [-1],
        })[0];
        t.compute(
          yh(x, c.batchSize, c.numHeads, b, c.sequenceLength, y, p, m),
          { inputs: p && m ? [x, p, m] : [x], outputs: [] }
        );
        const $ = [x, n];
        g > 1 && u && k.size(u.dims) > 0 && $.push(u),
          p && $.push(p),
          m && $.push(m),
          t.compute(wh(g, x, n, u, c, b, p, m), {
            inputs: $,
            outputs: g > 1 ? [0, 2] : [0],
          });
      }),
      (_h = (t, e) => {
        const r = [e.batchSize, e.numHeads, e.sequenceLength, e.headSize],
          n = e.sequenceLength,
          o = e.inputHiddenSize,
          i = e.headSize,
          s = 12,
          ...
          p = (m) => {
            const g = R('output_q', d[0].dataType, r),
              b = R('output_k', d[0].dataType, r),
              y = R('output_v', d[0].dataType, r),
              w = O('input', d[0].dataType, d[0].dims),
...
var vh,
  ...
  vu = V(() => {
    ...
    (vh = (t, e) => {
        ...
        const n =
          e.format === 'NHWC'
            ? e.spatial
              ...
              : t[0].dims
                  .slice(-1)
                  .concat(t[0].dims.slice(1, t[0].dims.length - 1))
      ...
      ($h = (t, e) => {
        const { epsilon: r, spatial: n, format: o } = e,
          i = t[0].dims,
          s = n ? fe(i[i.length - 1]) : 1,
          u = o === 'NHWC' && i.length > 1 ? s : 1,
          d = k.size(i) / s,
          c = n,
          p = c ? i.length : i,
          m = O('x', t[0].dataType, t[0].dims, s),
          g = O('scale', t[1].dataType, t[1].dims, u),
          b = O('bias', t[2].dataType, t[2].dims, u),
          y = O('inputMean', t[3].dataType, t[3].dims, u),
          w = O('inputVar', t[4].dataType, t[4].dims, u),
          S = R('y', t[0].dataType, p, s),
          x = () => {
            let T = '';
            if (n)
  ...
  ${T.guardAgainstOutOfBoundsWorkgroupSizes('uniforms.outputSize')}
    ...
    ${S.setByOffset('global_idx', 'value')}
      ...
      (xh = (t) => ee(t)),
      (_u = (t, e) => {
        const { inputs: r, outputCount: n } = t,
          o = xh({ ...e, outputCount: n });
  ...
  ${t.mainStart()}
    ...
    ${p.setByOffset('global_idx', d)}
      ...
      (he = (t, e, r, n, o, i = t.dataType, s, u) => {
        const d = [{ type: 12, data: Math.ceil(k.size(t.dims) / 4) }];
        return (
          s && d.push(...s),
          {
            name: e,
            ...
            getShaderSource: (c) =>
              Ih(c, k.size(t.dims), t.dataType, i, r, n, u),
            getRunData: (c) => ({
      ...
      (zu = (t, e) => {
        const r = e || Ch(t.inputs),
          n = Pe(t.inputs[0].dataType);
        t.compute(
          he(
            t.inputs[0],
            'Clip',
            (o) =>
              `clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`,
            void 0,
            r.cacheKey,
            void 0,
            [
      ...
      (nr = (t) => ee(t)),
      (Ru = (t, e) => {
        const r = Pe(t.inputs[0].dataType);
        t.compute(
          he(
            t.inputs[0],
            'Elu',
...
fn erf_vf32(v: vec4<${t}>) -> vec4<${t}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
      ...
      (Uu = (t) => {
        const e = Pe(t.inputs[0].dataType);
      ...
      (qu = (t) => {
        ...
        t.compute(
          he(
            t.inputs[0],
            'Relu',
            (r) => `select(vec4<${e}>(0.0), ${r}, ${r} > vec4<${e}>(0.0))`
          )
        );
      }),
      (Ku = (t) => {
        t.compute(
          he(t.inputs[0], 'Sigmoid', (e) => `(1.0 / (1.0 + exp(-${e})))`)
        );
      }),
      (ju = (t) => ee(t)),
      (Zu = (t, e) => {
      ...
      (ed = (t) =>
        `sign(${t}) * (1 - exp(-2 * abs(${t}))) / (1 + exp(-2 * abs(${t})))`),
      (td = (t) => {
...
`),
      ...
      (rd = (t) => {
        const e = Pe(t.inputs[0].dataType);
        t.compute(
          he(t.inputs[0], 'FastGelu', _o, wo(e), void 0, t.inputs[0].dataType)
        );
      }),
      (nd = (t, e) => {
        const r = Pe(t.inputs[0].dataType);
...
var kh,
  ...
  ud = V(() => {
    ...
    (kh = (t) => {
      ...
      (Ph = (t) => {
        const e = t[0].dims.slice();
        e[2] = e[2] / 2;
        const r = O('input', t[0].dataType, t[0].dims, 4),
  ...
  wd = V(() => {
    ...
    (Oh = (t, e, r, n, o, i, s, u, d, c, p, m) => {
      ...
      typeof u == 'string'
        ...
        : typeof u == 'function'
          ? (g = b = u)
          : ((g = u.scalar), (b = u.vector));
      let y = R('outputData', p, n.length, 4),
        w = O('aData', d, e.length, 4),
      ...
      if (o)
        if (i) {
          ...
          $ || T
            ? (x = y.setByOffset(
                ...
                b(
                  ...
                  T
                    ? `${S.type.value}(${S.getByOffset('0')}.x)`
          ...
          x = y.setByOffset(
            'global_idx',
            b(w.getByOffset('global_idx'), S.getByOffset('global_idx'))
          );
      else {
        if (!i)
          throw new Error(
        ...
        const $ = (T, I, E = '') => {
          const A = `aData[indexA${I}][componentA${I}]`,
            z = `bData[indexB${I}][componentB${I}]`;
          return `
      ...
      (zh = (t, e, r, n, o, i, s = r.dataType) => {
        ...
        return (
          y.push(g),
          {
            ...
            getShaderSource: (w) =>
              Oh(w, u, d, p, g, c, b, o, r.dataType, n.dataType, s, i),
            getRunData: () => ({
              outputs: [{ dims: p, dataType: s }],
              dispatchGroup: { x: Math.ceil(m / 64 / 4) },
              programUniforms: [
                { type: 12, data: Math.ceil(k.size(p) / 4) },
                ...L(u, d, p),
              ],
            }),
          }
      ...
      (md = (t) => {
        const e = O('input', t.inputs[0].dataType, t.inputs[0].dims).type.value;
        dt(
          t,
          'Pow',
          {
    ...
    return ${t}u;
      ...
      (Rh = (t, e) => {
        const r = t.length,
          n = [];
        for (let o = 0; o < r; ++o) {
          const i = e.setByOffset('global_idx', t[o].getByIndices('indices'));
          r === 1
            ? n.push(i)
            : o === 0
...
`);
      ...
      (Uh = (t, e, r, n) => {
        ...
        for (let w = 0; w < t.length; ++w)
          (u += t[w].dims[e]),
            (i[w] = u),
            c.push(t[w].dims.length),
            (s[w] = O(`input${w}`, n, c[w])),
            d.push('rank'),
            p.push({ type: 12, data: i[w] });
        for (let w = 0; w < t.length; ++w) p.push(...L(t[w].dims));
        p.push(...L(r));
        const m = R('output', n, r.length),
          g = m.indicesGet('indices', e),
          b = Array.from(Array(i.length).keys())
  ...
  ${w.mainStart()}
    ...
    ${Rh(s, m)}
      ...
      (_d = (t, e) => {
        ...
        const s = r.filter((u) => k.size(u.dims) > 0);
      ...
      (Qe = (t, e) => {
        t.activation === 'Clip'
          ...
          : t.activation === 'HardSigmoid'
            ...
            : t.activation === 'LeakyRelu' &&
              e.push({ type: 1, data: t.alpha });
      }),
      (Ye = (t, e) => {
        t.activation === 'Clip'
          ? e.push(
          ...
          : t.activation === 'HardSigmoid'
            ...
            : t.activation === 'LeakyRelu' &&
              e.push({ name: 'alpha', type: 'f32' });
      }),
      (rn = (t) => {
        const e = t?.activation || '';
        if (e === 'HardSigmoid') {
          const [r, n] = t?.activation_params || [0.2, 0.5];
          return { activation: e, alpha: r, beta: n };
        } else if (e === 'Clip') {
          const [r, n] = t?.activation_params || [Es, ks];
          return { activation: e, clipMax: n, clipMin: r };
        } else if (e === 'LeakyRelu') {
          const [r] = t?.activation_params || [0.01];
...
`;
      ...
      (on = (t, e, r, n, o = !1, i) => {
        ...
        Qe(e, T),
          ...
          T.push(...L($));
        const I = (E) => {
          let A = Qr('batch_dims', t[0].dataType, S.length),
            z = O('a', t[0].dataType, s.length, g),
            v = O('b', t[1].dataType, u.length, m),
            M = R('output', t[0].dataType, $.length, m),
            N = be(M.type.tensor),
            K = Ze(e, M.type.value, N),
            q = [z, v],
            Q = '';
          if (w) {
            const j = o ? m : 1;
            q.push(O('bias', t[2].dataType, t[2].dims.length, j)),
              (Q = `${o ? `value += bias[col / ${j}];` : `value += ${M.type.value}(bias[row + i]);`}`);
          }
          const D = [
...
`;
          ...
          return `
  ${E.registerUniforms(D)
    .registerInternalVariables(A)
    .declareVariables(...q, M)}
  ${E.mainStart()}
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      ...
      ($o = (t, e, r = 'f32', n, o = !1, i = 32, s = !1, u = 32, d = !1) => {
        const c = t[1] * e[1],
          p = t[0] * e[0],
          m = o ? c : i,
          g = o ? i : c;
...
`;
    ...
    `;
      ...
      (ir = (t, e, r, n, o = !1, i) => {
        ...
        const q = (Q) => {
          const D = p.length,
            W = Qr('batchDims', t[0].dataType, D, 1),
            j = be(t[0].dataType),
            Y = O('a', t[0].dataType, E, T),
            Z = O('b', t[1].dataType, z, T),
            te = R('result', t[0].dataType, v.length, T),
            ie = [Y, Z];
          if (K) {
            const X = o ? T : 1;
          ...
          Ye(e, we);
          const Te = be(te.type.tensor),
            re = Ze(e, te.type.value, Te),
            U = Wh(T, K, re, [W, Y, Z, te], o);
          return `
  ${Q.registerUniforms(we)
    .registerInternalVariables(W)
    .declareVariables(...ie, te)}
  ${U}
...
var Gh,
  ...
  Ad = V(() => {
    ...
    let coords = vec4<i32>(
      ...
      col % outWidth);
    `,
        y = t ? 'i32(uniforms.x_shape[1])' : 'i32(uniforms.x_shape[2])',
        w = t ? 'i32(uniforms.x_shape[2])' : 'i32(uniforms.x_shape[3])',
        S = t ? 'row' : 'col',
        x = t ? 'col' : 'row',
        $ = `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
      ...
      (Cd = (t, e, r, n, o, i, s, u, d) => {
        const c = e.format === 'NHWC',
          p = c ? t[0].dims[3] : t[0].dims[1],
          m = r[0],
          g = c ? r[2] : r[3],
          b = c ? r[1] : r[2],
          y = c ? r[3] : r[1],
          w = c && (p % 4 === 0 || p % 3 === 0) && y % 4 === 0,
          S = c ? y : g * b,
          x = c ? g * b : y,
          $ = [8, 8, 1],
          T = n <= 8 ? [4, 1, 1] : [4, 4, 1],
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${w ? `vec4<${te}>` : te}) {
        ...
        setOutputAtIndex(flatIndex ${w ? '/ 4' : ''}, value);
            ...
            we = O('x', t[0].dataType, t[0].dims.length, E === 3 ? 1 : E),
            Te = O('w', t[1].dataType, t[1].dims.length, Z),
            re = [we, Te],
            U = R('result', t[0].dataType, r.length, Z);
          if (s) {
            const X = O('bias', t[2].dataType, t[2].dims.length, Z);
            re.push(X),
              (ie += `
...
var Hh,
  ...
  zd = V(() => {
    ...
    (Hh = (t) => {
      ...
      (Ed = (t) => (typeof t == 'number' ? [t, t, t] : t)),
      (un = (t, e) => (e <= 1 ? t : t + (t - 1) * (e - 1))),
      (Fh = (t, e, r, n = 1) => {
        const o = un(e, n);
      ...
      (kd = (t, e, r, n, o) => {
        ...
        for (let s = 0; s < 3; s++)
          t[s] + 2 * o >= e[s] &&
            (i[s] = Math.trunc((t[s] - e[s] + 2 * o) / n[s] + 1));
        return i;
      }),
      (qh = (t, e, r, n, o, i, s, u, d, c) => {
        ...
        if ((t === 'VALID' && (t = 0), typeof t == 'number')) {
          ...
          const y = kd([e, r, n, 1], [u, d, c], 1, [o, i, s], t);
          (m = y[0]), (g = y[1]), (b = y[2]);
          ...
          const y = kd([e, r, n, 1], [u, d, c], 1, [o, i, s], t[0]);
          (m = y[0]), (g = y[1]), (b = y[2]);
      ...
      (Pd = (t, e, r, n, o, i = !1, s = 'channelsLast') => {
        ...
        let [g, , b, y, w] = e,
          ...
          v = un(w, E),
          {
            ...
            outHeight: K,
            outWidth: q,
          } = qh(o, d, c, p, S, x, $, A, z, v),
          Q = i ? g * m : g,
          D = [0, 0, 0, 0, 0];
        return (
          s === 'channelsFirst'
            ? (D = [u, Q, N, K, q])
            : s === 'channelsLast' && (D = [u, N, K, q, Q]),
          {
            batchSize: u,
            dataFormat: s,
            inDepth: d,
      ...
      (Od = (t, e, r, n, o, i) => {
        const s = i === 'channelsLast',
          u = s ? t[0].dims[3] : t[0].dims[1],
          d = !1,
          c = [64, 1, 1],
          p = { x: r.map(($, T) => T) },
          m = [Math.ceil(Hh(p.x.map(($) => r[$])) / c[0]), 1, 1];
        se('verbose', () => `[conv3d_naive_webgpu] dispatch = ${m}`);
        const g = d ? (s && u % 4 !== 0 ? 3 : 4) : 1,
          b = k.size(r),
          y = [
            { type: 12, data: b },
            { type: 12, data: n },
        ...
        const x = ($) => {
          ...
          let I = d ? 4 : 1,
            ...
            z = O('W', t[1].dataType, t[1].dims.length, I),
            v = [A, z],
            M = R('result', t[0].dataType, r.length, I),
            N = '';
          if (S) {
            const Q = O('bias', t[2].dataType, t[2].dims.length, I);
            v.push(Q),
              (N += `
...
var Dd,
  ...
  Md = V(() => {
    ...
    (Dd = (t, e, r, n) => {
      ...
      const y = o ? ['rank', 'rank', 'rank'] : ['rank', 'rank'];
      b.push(...L([r[0], r[1], r[2], r[3] / m]));
      const w = (S) => {
        const x = R('output', t[0].dataType, r.length, m),
          $ = be(x.type.tensor),
          T = Ze(e, x.type.value, $),
          I = O('x', t[0].dataType, s.length),
  ...
  ${S.mainStart()}
    ...
    ${x.setByOffset('global_idx', 'value')}
      ...
      return {
        name: 'GroupedConv',
        shaderCache: { hint: `${e.cacheKey}_${m}`, inputDependencies: y },
        getRunData: () => ({
      ...
      (Bd = (t, e, r, n) => {
        ...
        const g = (s - 1) * e.strides[1] + c[1],
          b = (y) => {
            const w = R('output', t[0].dataType, p.length, i),
              S = be(w.type.tensor),
              x = Ze(e, w.type.value, S),
              $ = O('x', t[0].dataType, d.length, i),
              T = O('w', t[1].dataType, c.length, i),
              I = [$, T];
            o && I.push(O('b', t[2].dataType, t[2].dims, i));
            const E = o ? 'value += b[output_channel];' : '',
              A = [
                { name: 'output_size', type: 'u32' },
  ...
  Ud = V(() => {
    ...
    (Kh = (t, e, r, n, o, i) => {
      const s = t[0],
        ...
        d = u.length,
        c = e[0],
        m = e.slice(2).map((y, w) => y + (y - 1) * (r[w] - 1)),
        b = u
          .map((y, w) => y + n[w] + n[w + d])
          .map((y, w) => Math.floor((y - m[w] + o[w]) / o[w]));
      ...
      (jh = (t, e) => {
        ...
        const r = t[0].dims[e.format === 'NHWC' ? t[0].dims.length - 1 : 1],
          n = t[1].dims[1] * e.group;
        if (r !== n)
          throw new Error('FILTER_IN_CHANNEL should be equal to DATA_CHANNEL');
        if (
          t.length === 3 &&
          (t[2].dims.length !== 1 || t[1].dims[0] !== t[2].dims[0])
        )
          throw new Error('invalid bias');
        const o = t[0].dims.length - 2;
      ...
      (Rd = (t, e, r, n) => {
        const o = r.format === 'NHWC',
          i = Kh(e[0].dims, e[1].dims, r.dilations, r.pads, r.strides, o);
        if (r.group !== 1) {
          const A = [e[0]];
          if (o) {
            const v =
            ...
            r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = v),
              A.push(v);
          } else A.push(e[1]);
          e.length === 3 && A.push(e[2]),
            ...
            r.dilations[0] === 1 &&
            r.dilations[1] === 1
              ? t.compute(Bd(A, r, i, n), { inputs: A })
              : t.compute(Dd(A, r, i, n), { inputs: A });
          return;
        }
        const s = e.length === 3,
          u = e[0].dims[o ? 1 : 2],
          ...
          b = i[o ? 2 : 3],
          y = i[o ? 3 : 1],
          w = o && p === u && m === d && r.pads[0] === 0 && r.pads[1] === 0;
        if (
          w ||
          (p === 1 &&
            m === 1 &&
          ...
          if (o) {
            ...
            if (
              ...
              (z = e[0].reshape([A, u * d, c])),
                (v = Q.reshape([1, c, y])),
                (M = [A, g * b, y]);
            N.push(z), N.push(v);
          } else
            (z = e[0].reshape([A, c, u * d])),
              (v = e[1].reshape([1, y, c])),
              (M = [A, y, g * b]),
              N.push(v),
              N.push(z);
          ...
          K < 8 && q < 8
            ? t.compute(on(N, r, i, M, o, n), { inputs: N })
            : t.compute(ir(N, r, i, M, o, n), { inputs: N });
          return;
        }
        const S = !0,
          x =
      ...
      (Zh = (t, e) => {
        ...
        const o = [0, e.pads[0], 0, e.pads[1]],
          i = [1].concat(e.strides),
          s = [1].concat(e.dilations),
          u = [1].concat(e.kernelShape),
          d = So(
            { ...e, pads: o, strides: i, dilations: s, kernelShape: u },
            n
          );
        Rd(t, n, d, (c) => (r ? [c[0], c[2], c[3]] : [c[0], c[1], c[3]]));
      }),
      (Qh = (t, e, r) => {
        const n = r.format === 'NHWC' ? 'channelsLast' : 'channelsFirst',
          o = So(r, e),
          i = r.autoPad === 'NOTSET' ? r.pads : r.autoPad,
          s = Pd(e[0].dims, e[1].dims, r.strides, r.dilations, i, !1, n);
        t.compute(
          Od(
            e,
            o,
    ...
    Nd = (t, e, r) => {
      ...
      const $ = ['rank', 'rank'],
        ...
        A = [
          I[0] +
            (e.dilations[0] <= 1
              ? 0
              : (e.kernelShape[i ? 1 : 2] - 1) * (e.dilations[0] - 1)),
          I[1] +
            (e.dilations[1] <= 1
              ? 0
              : (e.kernelShape[i ? 2 : 3] - 1) * (e.dilations[1] - 1)),
        ],
        z = [
      ...
      const M = (N) => {
        const K = [
          ...
          D = i ? 2 : 3,
          W = i ? 3 : 1,
          j = O('W', t[1].dataType, t[1].dims.length, w),
          Y = O('Dy', t[0].dataType, t[0].dims.length, p),
          Z = [Y, j];
        n && Z.push(O('bias', t[2].dataType, [o[W]].length, y));
        const te = R('result', t[0].dataType, o.length, y),
          ie = () => {
            let re = '';
            if (m)
              p === 4
...
var Yh,
  ...
  Fd = V(() => {
    ...
    St();
    pt();
    (Yh = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i),
      (Xh = (t, e, r, n, o) => {
      ...
      (Jh = (t, e, r, n, o, i, s, u, d, c) => {
        ...
        for (let y = 0, w = t.length - p - (u ? 1 : 0); y < p; ++y, ++w) {
          const S = t[w],
            x = m ? S * s[y] : c[y],
            $ = Yh(S, s[y], i[y], e[w], r[y], x);
          Xh($, n, i, y, y + p),
            m &&
              c.push(
                s[y] * (S - 1) + d[y] + (e[w] - 1) * r[y] + 1 - i[y] - i[y + p]
              );
        }
      ...
      (eg = (t, e) => {
        ...
        if (r !== n)
          throw new Error('FILTER_IN_CHANNEL should be equal to DATA_CHANNEL');
        const o = t[1].dims[1] * e.group;
        if (t.length === 3 && (t[2].dims.length !== 1 || t[2].dims[0] !== o))
          throw new Error('invalid bias');
        const i = t[0].dims.length - 2;
        if (
          e.dilations.reduce((p, m) => p + m, 0) > 0 &&
          e.dilations.length !== i
        )
        ...
        if (
          ...
          e.outputShape.length !== t[0].dims.length - 2
        )
  ...
  jd = V(() => {
    ...
    (rg = (t, e, r, n) => {
      const o = k.size(e),
        ...
        p = (m) => {
          const g = ` i32(${s.indicesGet('inputIndices', 'uniforms.axis')}) `,
            b = F('uniforms.input_shape', 'uniforms.axis', i),
            y = n.reverse ? g + (n.exclusive ? ' + 1' : '') : '0',
            w = n.reverse ? b : g + (n.exclusive ? '' : ' + 1');
          return `
...
`)
      ...
      (ig = (t, e) => {
        ...
        d
          ? (([r, n, o, i] = t.dims),
            (s = p ? [r, n, o, c, c, i / c ** 2] : [r, n, o, i / c ** 2, c, c]),
            (u = p ? [0, 1, 3, 2, 4, 5] : [0, 1, 4, 2, 5, 3]))
          : (([r, n, o, i] = [t.dims[0], t.dims[2], t.dims[3], t.dims[1]]),
            (s = p ? [r, c, c, i / c ** 2, n, o] : [r, i / c ** 2, c, c, n, o]),
    ...
    ${w.setByOffset('global_idx', y.getByIndices('aIndices'))}
        ...
        return {
          ...
          getRunData: (x) => {
            ...
            return {
              outputs: [{ dims: $, dataType: x[0].dataType }],
              dispatchGroup: { x: Math.ceil(T / 64) },
              programUniforms: [{ type: 12, data: T }, ...L(I, E)],
            };
          },
          getShaderSource: S,
        };
      ...
      (Qd = (t) =>
        ee({ blocksize: t.blocksize, mode: t.mode, format: t.format }));
  });
var Co,
  dn,
  Xd,
    ...
    (Co = '[a-zA-Z]|\\.\\.\\.'),
      ...
      (Eo = class {
        constructor(e, r) {
          ...
          if (
            (n.split(',').forEach((u, d) => {
              const c = e[d].dims.slice();
              if (!u.match(RegExp(Xd))) throw new Error('Invalid LHS term');
              const p = this.processTerm(u, !0, c, d);
              this.lhs.push(p);
            }),
            o === '')
          )
          ...
          o.match(RegExp(Co, 'g'))?.forEach((u) => {
            if (u === '...')
              ...
              const d = this.symbolToInfo.get(u);
            ...
            c?.forEach((m, g) => {
              if (m === '...') {
                ...
                for (let y = 0; y < u.length; y++) {
                  const w = String.fromCharCode(48 + y);
      ...
      (Jd = (t) => t + '_max'),
      (ug = (t, e, r, n) => {
        const i = t.map((p) => p.length).map((p, m) => O(`input${m}`, e, p)),
          s = k.size(n),
          u = R('output', e, n.length),
          d = [...r.symbolToInfo.keys()].filter(
            (p) => !r.rhs.symbolToIndices.has(p)
          ),
          c = (p) => {
            const m = [],
              g = 'var prod = 1.0;',
            ...
            r.symbolToInfo.forEach((E, A) => {
              if (r.rhs.symbolToIndices.has(A)) {
                const z = r.rhs.symbolToIndices.get(A)?.[0];
                z !== void 0 &&
                  r.lhs.forEach((v, M) => {
                    if (E.inputIndices.includes(M)) {
                      const N = v.symbolToIndices.get(A);
                      if (N === void 0) throw new Error('Invalid symbol error');
                      N.forEach((K) => {
                        m.push(
                          `${i[M].indicesSet(`input${M}Indices`, K, u.indicesGet('outputIndices', z))}`
                        );
                      });
                    }
                  });
                ...
                r.lhs.forEach((z, v) => {
                  if (E.inputIndices.includes(v)) {
                    const M = z.symbolToIndices.get(A);
                    if (M === void 0) throw new Error('Invalid symbol error');
                    M.forEach((N) => {
                      w.push(
                        `${i[v].indicesSet(`input${v}Indices`, N, `${A}`)}`
                      );
                    }),
                      $.push(
                        `prod *= ${i[v].getByIndices(`input${v}Indices`)};`
                      );
                  }
                }),
                  S.push(
                    `for(var ${A}: u32 = 0; ${A} < uniforms.${Jd(A)}; ${A}++) {`
                  ),
                  x.push('}');
            });
            const I = T
            ...
            ${i
              .map((E, A) => `var input${A}Indices: ${i[A].type.indices};`)
              .join(`
`)}
            ${I.join(`
`)};
      ...
      (el = (t, e) => {
        const r = new Eo(t.inputs, e.equation),
          n = r.outputDims,
          o = t.inputs.map((i, s) => i.dims);
        t.compute(ug(o, t.inputs[0].dataType, r, n));
      }),
      (tl = (t) => {
        const e = t.equation.replace(/\s+/g, '');
...
var dg,
  ...
  il = V(() => {
    ...
    (dg = (t) => {
      ...
      (lg = (t, e) => (t.length > e.length ? nl(t, e) : nl(e, t))),
      (cg = (t) => {
        const e = t[0].dims,
          r = Array.from(t[1].getBigInt64Array(), Number),
          n = lg(e, r),
          o = t[0].dataType,
          i = o === 9 || k.size(e) === 1,
          s = o === 9 || (e.length > 0 && e[e.length - 1] % 4 === 0) ? 4 : 1,
          u = i || (n.length > 0 && n[n.length - 1] % 4 === 0) ? 4 : 1,
          d = Math.ceil(k.size(n) / u),
          c = (m) => {
            let g = O('input', o, e.length, s),
              b = R('output', o, n.length, u),
              y;
            if (o === 9) {
              const w = (S, x, $ = '') => `
...
var pg,
  ...
  sl = V(() => {
    ...
    (pg = (t) => {
      ...
      let bias${b} = ${d.getByOffset(`bias${b}_offset / 4`)}[bias${b}_offset % 4];`,
            g = o
              ? `
    ...
    ${s.mainStart(Dt)}
      ...
      (al = (t) => {
        t.inputs.length < 2 || k.size(t.inputs[1].dims) === 0
          ? rd(t)
          : t.compute(pg(t.inputs));
      });
  });
var mg,
  fg,
    ...
    (mg = (t) => {
      ...
      (fg = (t, e) => {
        ...
        const u = r[i],
          ...
          m = (g) => {
            let b = O('data', t[0].dataType, t[0].dims.length, d),
              y = O('inputIndices', t[1].dataType, t[1].dims.length),
              w = R('output', t[0].dataType, s.length, d),
              S = ($) => {
                let T = n.length,
                  I = `var indicesIndices${$}  = ${y.type.indices}(0);`;
                for (let E = 0; E < T; E++)
        ...
        `;
                for (let E = 0, A = 0; E < o; E++)
                  E === i
                    ? ((I += `${o > 1 ? `dataIndices${$}[${E}]` : `dataIndices${$}`} = u32(idx${$});`),
                      (A += T))
                    : ((I += `${o > 1 ? `dataIndices${$}[${E}]` : `dataIndices${$}`} = ${s.length > 1 ? `outputIndices${$}[${A}]` : `outputIndices${$}`};`),
                      A++);
                return I;
              },
              x;
...
var hg,
  ...
  ml = V(() => {
    ...
    (hg = (t, e, r, n, o, i, s, u, d) => {
      ...
      c.push(...L(e.dims, p));
      const m = (g) => {
        const b = O('indices_data', e.dataType, e.dims.length),
          y = R('input_slice_offsets_data', 12, 1, 1),
          w = [b, y],
          S = [
            { name: 'output_size', type: 'u32' },
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
      ...
      (cl = (t, e) => {
        let r = t.inputs,
          ...
          d = k.sizeFromDimension(n, e.batchDims + s),
        ...
        const y = hg(t, r[1], g, e.batchDims, n, u, m, p, s),
          w = e.batchDims + s;
        if (w > n.length)
          throw new Error(
            'last dimension of indices must not be larger than rank of input tensor'
          );
        const S = i.slice(0, -1).concat(n.slice(w)),
          x = k.size(S),
          $ = [
            { type: 12, data: x },
            { type: 12, data: d },
          ...
          T = (I) => {
            const E = O('data', r[0].dataType, r[0].dims.length),
              A = O('slice_offsets', 12, y.dims.length),
              z = R('output', r[0].dataType, S.length);
            return `
...
var gg,
  ...
  gl = V(() => {
    ...
    (gg = (t, e) => {
      ...
      const r = k.normalizeAxis(e.quantizeAxis, t[0].dims.length),
        n = e.blockSize,
        o = t[0],
        i = t[2],
        s = t.length === 4 ? t[3] : void 0;
      if (
        i.dims.length !== o.dims.length ||
        !o.dims
          .map((u, d) =>
            d === r ? Math.ceil(u / n) === i.dims[d] : u === i.dims[d]
          )
          .reduce((u, d) => u && d, !0)
      )
        throw new Error(
      ...
      if (s) {
        ...
        if (
          ...
          !s.dims.map((u, d) => u === i.dims[d]).reduce((u, d) => u && d, !0)
        )
          throw new Error(
      ...
      (yg = (t, e) => {
        const r = t[0].dims,
          ...
          s = k.normalizeAxis(e.quantizeAxis, o),
          u = r.slice(0);
        u.splice(i, 1, ...n);
        const d = k.size(u),
          c = t[2].dataType,
    ...
    (bg = (t) => {
      ...
      (wg = (t, e) => {
        const r = t[0].dims,
          ...
          p = k.size(c),
          m = O('input', n, o),
          g = O('indicesInput', s, i.length),
          b = R('output', n, c.length),
          y = [
            { type: 12, data: p },
            { type: 6, data: d },
            { type: 12, data: u },
...
var _g,
  ...
  $l = V(() => {
    ...
    (_g = (t) => {
      ...
      if (
        ...
        (t.length === 3 && t[0].dataType !== t[2].dataType)
      )
      ...
      (vg = (t, e) => {
        ...
        const d = 16,
          ...
          y = ['type', 'type'];
        t.length === 3 && (b.push(...L(t[2].dims)), y.push('rank')),
          b.push(...L(u));
        const w = (x) => {
            let $ = '';
            e.transA && e.transB
            ...
            let T = e.alpha === 1 ? '' : 'value *= uniforms.alpha;',
              ...
              v = [I, E];
            t.length === 3 &&
              ((z = O('c', t[2].dataType, t[2].dims.length)), v.push(z));
            const M = R('output', t[0].dataType, u.length);
            v.push(M);
            const N = [
              { name: 'output_size', type: 'u32' },
              { name: 'M', type: 'u32' },
  ...
  ${x.mainStart()}
    ...
    output[global_idx] = value;
          ...
          S = (x) => {
            let $ = O('a', t[0].dataType, t[0].dims),
              T = O('b', t[1].dataType, t[1].dims),
              I = null,
              E = [$, T];
            t.length === 3 &&
              ((I = O('c', t[2].dataType, t[2].dims.length)), E.push(I));
            const A = R('output', t[0].dataType, u.length);
            E.push(A);
            let z = [
      ...
      `),
                (v = 'value += tile_a[k][local_id.y] * tile_b[local_id.x][k];'))
              : e.transA && !e.transB
                ? ((M = `
      var col = tile_row_start + local_id.x;
      var row = k_start + local_id.y;
      ...
      `),
            ...
            const N = e.alpha === 1 ? '' : 'value *= uniforms.alpha;';
            return `
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
        ...
        return m
          ? {
              name: 'GemmShared',
              shaderCache: { hint: `${e.cacheKey}`, inputDependencies: y },
              getRunData: () => ({
    ...
    ([mt, Tt, Gt, Ht] = [0, 1, 2, 3]),
      ($g = (t) => {
        ...
        if (t[0].dims.length - 2 !== t[1].dims[t[1].dims.length - 1])
          throw new Error(
            `last dimension of grid must be equal to ${t[0].dims.length - 2}`
          );
...
`),
      ...
      (Eg = (t, e) => {
        ...
        e.format === 'NHWC' &&
          ...
          ([mt, Tt, Gt, Ht] = [0, 3, 1, 2]));
        const s = R('output', t[0].dataType, i.length),
          u = r.type.value,
          d = k.size(i),
          c = [{ type: 12, data: d }, ...L(t[0].dims, n, i)],
          p = (m) => `
...
var Re,
  ...
  ko = V(() => {
    ...
    ae();
    pt();
    (Re = (t, e) => (t.length > e && t[e].dims.length > 0 ? t[e] : void 0)),
      (Og = (t, e) => {
        const r = t[0],
          n = Re(t, 1),
          o = Re(t, 2),
      ...
      (zg = (t, e, r, n, o, i, s) => {
        const u = [n, o, i],
          ...
          p = (m) => {
            const g = R('qkv_with_bias', e.dataType, u),
              b = O('qkv', e.dataType, u),
              y = O('bias', r.dataType, u),
              w = [
                { name: 'output_size', type: 'u32' },
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
      ...
      (ar = (t, e, r, n, o, i, s, u) => {
        ...
        if (s && k.size(s.dims) > 0) {
          ...
          return (
            (d = zg(t, i, s, e, n, r * o, u)),
            (d = d.reshape([e, n, r, o])),
            r === 1 || n === 1
              ? d
              : t.compute(Oe(d, Il.perm), { inputs: [d], outputs: [-1] })[0]
          );
        } else
          return (
      ...
      (Al = (t, e) => {
        ...
        const m = o && i && o.dims.length === 4 && i.dims.length === 4,
          g = ar(
            t,
            r.batchSize,
            r.numHeads,
  ...
  Oo = V(() => {
    ...
    (Dg = (t) => {
      ...
      (Bg = (t, e) => {
        ...
        return (
          t[1].dims[0] > 0 &&
            (t[1].getBigInt64Array().forEach((o) => r.push(Number(o))),
            (n = r.length)),
          ee({ numOutputs: n, axis: e.axis, splitSizes: r })
        );
      }),
      (Mg = (t) => `
    ...
    return ${t}u;
      ...
      (Rg = (t) => {
        const e = t.length,
          r = [];
        for (let n = 0; n < e; ++n) {
          const o = t[n].setByIndices('indices', 'input[global_idx]');
          e === 1
            ? r.push(o)
            : n === 0
...
`)}
      ...
      (Po = (t, e) => {
        ...
        for (let y = 0; y < e.numOutputs; y++) {
          ...
          (w[i] = e.splitSizes[y]),
            p.push(w),
            (s[y] = R(`output${y}`, o, w.length)),
            c.push({ dims: p[y], dataType: t[0].dataType });
        }
  ...
  ${y.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
      ...
      (El = (t, e) => {
        Dg(t.inputs);
        const r = t.inputs.length === 1 ? e : Bg(t.inputs, e);
...
var Ug,
  ...
  zo = V(() => {
    ...
    (Ug = (t, e) => {
      const [r, n, o, i] = t,
        { numHeads: s, rotaryEmbeddingDim: u } = e;
      ...
      (ln = (t, e) => {
        const {
          ...
          m = o === 0 ? p * 2 : c / n,
          g = [s, d, c / m, m - p],
          b = k.computeStrides(g),
          y = [
            { type: 1, data: i },
            { type: 12, data: g },
            { type: 12, data: b },
            ...(t[0].dims.length === 3
              ? new Array({ type: 12, data: [u, c, m, 1] })
              : []),
            ...(t[0].dims.length === 4
              ? new Array({ type: 12, data: [u, m, d * m, 1] })
              : []),
            ...L(t[0].dims, t[1].dims, t[2].dims, t[3].dims, t[0].dims),
          ],
          w = (S) => {
            const x = O('input', t[0].dataType, t[0].dims.length),
              $ = O('position_ids', t[1].dataType, t[1].dims.length),
            ...
            return (
              S.registerUniforms([
                ...
                { name: 'global_strides', type: 'u32', length: b.length },
                { name: 'input_output_strides', type: 'u32', length: b.length },
              ]),
              `
  ...
  Dl = V(() => {
    ...
    (Ng = (t, e) => {
      ...
      let u = !1,
        ...
        b = !n || n.dims.length === 0,
        y = Math.floor(
          b ? p / (e.numHeads + 2 * e.kvNumHeads) : p / e.numHeads
        );
      b && (p = y * e.numHeads);
      const w = i && i.dims.length !== 0,
        S = s && s.dims.length !== 0;
      if (
        w &&
        i.dims.length === 4 &&
      ...
      if (n && n.dims.length > 0) {
        ...
        if (
          r.dims.length === 5 &&
          (r.dims[2] !== e.numHeads || r.dims[3] !== 3)
        )
          throw new Error(
            'Expect "query" shape (batch_size, kv_sequence_length, num_heads, 3, head_size) for packed kv'
          );
      ...
      let T = 0,
        I = !1,
        E = e.kvNumHeads ? y * e.kvNumHeads : p;
      ...
      (Ol = (t, e, r) => {
        ...
        return (
          e.dims.length === 3 &&
            ...
            (n = t.compute(Oe(n, Vg.perm), { inputs: [n], outputs: [-1] })[0])),
          n
        );
      }),
      (Lg = (t, e, r, n) => {
        const o = 7,
          ...
          c = (p) => {
            const m = O('seq_lens', r.dataType, r.dims),
  ...
  `;
      ...
      (zl = (t, e) => {
        ...
        let n = t.inputs[0],
          ...
          s =
            t.inputs[3] && t.inputs[3].dims.length !== 0 ? t.inputs[3] : void 0,
          u =
            t.inputs[4] && t.inputs[4].dims.length !== 0 ? t.inputs[4] : void 0,
          ...
          [g, b, y] =
            !o && !i
              ? t.compute(Po([n], m), { inputs: [n], outputs: [-1, -1, -1] })
              : [n, o, i],
          w,
          S;
        if (e.doRotary) {
          const I = t.compute(Lg(r.batchSize, r.sequenceLength, d, c), {
              inputs: [d, c],
              outputs: [-1],
            })[0],
            E = t.inputs[7],
            ...
            v = [g, I, E, A],
            M = [-1];
          (w = t.compute(ln(v, z), { inputs: v, outputs: M })[0]),
            v.splice(0, 1, b);
          const N = ee({
            interleaved: e.rotaryInterleaved !== 0,
...
var Bl,
    ...
    if (local_idx == 0) {
      ...
      (Wg = (t, e, r) => {
        const n = e[0].dims,
          ...
          c = fe(d),
          p = k.size(o) / c,
          m = Bl(t, e[0], e[1], e[2], s, d, u, r.epsilon),
          g = [s, u, d / c],
          b = [s, u],
          y = ['type', 'none'],
          w = (S) => {
            const x = O('x', e[0].dataType, g.length, c),
              $ = O('scale_shift', 1, b.length, 2),
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes('uniforms.output_size')}
        ...
        t.compute(
          {
            ...
            shaderCache: { hint: `${c}`, inputDependencies: y },
            getRunData: () => ({
              outputs: [{ dims: o, dataType: e[0].dataType }],
              dispatchGroup: { x: Math.ceil(p / 64) },
              programUniforms: [{ type: 12, data: p }, ...L(g, b, g)],
            }),
            getShaderSource: w,
          },
          { inputs: [e[0], m] }
      ...
      (Gg = (t, e, r) => {
        ...
        g = g && n[n.length - 1] !== 1;
        const y = g
            ? t.compute(Oe(t.inputs[0], b), {
                inputs: [t.inputs[0]],
                outputs: [-1],
              })[0]
            : t.inputs[0].reshape(
                Array.from({ length: n.length }, (x, $) => n[b[$]])
              ),
          w = Bl(t, y, e[1], e[2], i, u, s, r.epsilon),
          S = (x) => {
            const $ = be(e[0].dataType),
...
var Hg,
      ...
      (Fg = (t, e, r) => {
       ...
       Got scale size of ${m} and bias size of ${g}`);
        ...
        const x = r > 1,
          $ = r > 2,
          T = (E) => {
            const A = be(t[0].dataType),
              z = [
                O('x', t[0].dataType, t[0].dims, y),
                O('scale', i.dataType, i.dims, y),
              ];
            s && z.push(O('bias', s.dataType, s.dims, y)),
              z.push(R('output', t[0].dataType, u, y)),
              x && z.push(R('mean_data_output', 1, b)),
              $ && z.push(R('inv_std_output', 1, b));
            const v = [
  ...
  ${E.mainStart()}
    ...
    ${$ ? 'inv_std_output[global_idx] = inv_std_dev' : ''};
        ...
        return (
          x && I.push({ dims: b, dataType: 1 }),
          $ && I.push({ dims: b, dataType: 1 }),
          {
            name: 'LayerNormalization',
            shaderCache: { hint: `${y};${r};${n}`, inputDependencies: w },
            getRunData: () => ({
              outputs: I,
              dispatchGroup: { x: Math.ceil(c / 64) },
              programUniforms: S,
...
var qg,
  ...
  Ll = V(() => {
    ...
    (qg = (t) => {
      ...
      (Vl = (t) => {
        qg(t.inputs);
        const e = ot.calcShape(t.inputs[0].dims, t.inputs[1].dims, !0);
        ...
        if (r < 8 && n < 8) t.compute(on(t.inputs, { activation: '' }, e));
          ...
          const o = e[e.length - 2],
            ...
            s = k.size(t.inputs[1].dims.slice(0, -2));
          if (i !== 1 && o === 1 && s === 1) {
            const u = t.inputs[0].reshape([1, i, n]),
...
var Kg,
  ...
  Hl = V(() => {
    ...
    (Kg = (t, e) => {
      ...
      const o = Math.floor((e.k + e.blockSize - 1) / e.blockSize),
      ...
      (jg = (t, e) => {
        ...
        E.splice(-1, 1, p / b),
          ...
          T.push(...L(E)),
          T.push(...L(t[2].dims)),
          t.length === 4 && T.push(...L(k.convertShape(t[3].dims)));
        const A = [d, o, s / y];
        T.push(...L(A));
        const z = (v) => {
          const M = I.length,
            N = O('a', t[0].dataType, M, g),
            K = O('b', 12, E.length, b),
            q = O('scales', t[2].dataType, t[2].dims.length),
            Q = [N, K, q],
            D =
              t.length === 4 ? O('zero_points', 12, t[3].dims.length) : void 0;
          D && Q.push(D);
          const W = A.length,
            j = R('output', t[0].dataType, W, y),
            Y = be(t[0].dataType),
            Z = (() => {
              switch (g) {
                case 1:
          ...
          `;
            ...
            b_dequantized_values = ${
              g === 1
                ? `${Z}(${Array.from({ length: 8 }, (U, X) => `(b_quantized_values[${X}] - ${D ? `zero_point${re}` : 'zero_point'}) * scale${re}`).join(', ')});`
                : `(b_quantized_values - ${Z}(${Array(8)
                    .fill(`${D ? `zero_point${re}` : 'zero_point'}`)
                    .join(',')})) * scale${re};`
            };
      ...
      (Zg = (t, e) => {
        ...
        v.splice(-1, 1, p / b),
          ...
          A.push(...L(v)),
          A.push(...L(t[2].dims)),
          t.length === 4 && A.push(...L(k.convertShape(t[3].dims)));
        const M = [d, o, s];
        A.push(...L(M));
        const N = (K) => {
          const q = z.length,
            Q = O('a', t[0].dataType, q, g),
            D = O('b', 12, v.length, b),
            W = O('scales', t[2].dataType, t[2].dims.length),
            j = [Q, D, W],
            Y =
              t.length === 4 ? O('zero_points', 12, t[3].dims.length) : void 0;
          Y && j.push(Y);
          const Z = M.length,
            te = R('output', t[0].dataType, Z),
            ie = be(t[0].dataType),
            we = () => {
              switch (g) {
                case 1:
      ...
      (Wl = (t, e) => {
        Kg(t.inputs, e),
          ...
          t.adapterInfo.isArchitecture('gen-12lp')
            ? t.compute(Zg(t.inputs, e))
            : t.compute(jg(t.inputs, e));
      }),
      (Gl = (t) => ee(t));
  });
var Qg,
  ...
  ql = V(() => {
    ...
    (Qg = (t) => {
      ...
      (ry = (t, e) => {
        const r = k.padShape(t[0].dims.slice(), e.pads),
          n = t[0].dims,
          o = k.size(r),
          i = [
            { type: 12, data: o },
        ...
        e.mode === 0 && i.push({ type: s ? t[2].dataType : 1, data: e.value }),
          i.push(...L(t[0].dims, r));
        const u = ['rank'],
          d = (c) => {
            const p = R('output', t[0].dataType, r.length),
            ...
            return (
              e.mode === 0 &&
                y.push({ name: 'constant_value', type: s ? g : 'f32' }),
              `
        ...
        return {
          name: 'Pad',
          shaderCache: { hint: `${e.mode}${s}`, inputDependencies: u },
          getRunData: () => ({
            outputs: [{ dims: r, dataType: t[0].dataType }],
      ...
      (ny = (t, e) => {
        if (t.length > 1) {
          ...
          if (t.length >= 4) {
            const u = t[3].getBigInt64Array();
            for (let d = 0; d < u.length; d++)
              (i[Number(u[d])] = Number(r[d])),
                (i[Number(u[d]) + o] = Number(r[d + u.length]));
          } else r.forEach((u, d) => (i[Number(d)] = Number(u)));
          const s = [];
          return (
            i.forEach((u) => s.push(u)), { mode: e.mode, value: n, pads: s }
          );
        } else return e;
      }),
      (Fl = (t, e) => {
        Qg(t.inputs);
        const r = ny(t.inputs, e);
...
var cn,
  ...
  dc = V(() => {
    ...
    (cn = (t) => {
      ...
      (Kl = (t, e, r) => {
        const n = e.format === 'NHWC',
          o = t.dims.slice();
        n && o.splice(1, 0, o.pop());
        const i = Object.hasOwn(e, 'dilations'),
          s = e.kernelShape.slice(),
          u = e.strides.slice(),
          d = i ? e.dilations.slice() : [],
          c = e.pads.slice();
        zt.adjustPoolAttributes(r, o, s, u, d, c);
        const p = zt.computePoolOutputShape(r, o, u, d, s, c, e.autoPad),
          m = Object.assign({}, e);
        i
          ? Object.assign(m, {
              kernelShape: s,
      ...
      (jl = (t, e) => {
        ...
        if (e.kernelShape.length <= 2) {
          const u = e.kernelShape[e.kernelShape.length - 1],
          ...
          let g = !1;
          if (e.kernelShape.length === 2) {
            const b = e.kernelShape[e.kernelShape.length - 2],
              y = e.strides[e.strides.length - 2],
              w = e.pads[e.pads.length / 2 - 2],
          ...
          const u = k.computeStrides(e.kernelShape);
          i.push(
            { type: 12, data: u },
            { type: 12, data: e.pads },
            { type: 12, data: e.strides }
          ...
          const d = e.pads.reduce((c, p) => c + p);
          return [i, s, !!d, !1, !1];
        }
      }),
      (Zl = (t, e, r, n, o, i, s, u, d, c, p, m) => {
        const g = o.format === 'NHWC',
          b = e.type.value,
          y = R('output', e.type.tensor, n);
      ...
      (Ql = (t) =>
        `${t.format};${t.ceilMode};${t.autoPad};${t.kernelShape.length}`),
      (oy = (t) => `${Ql(t)};${t.countIncludePad}`),
      (iy = (t) => `${Ql(t)};${t.storageOrder};${t.dilations}`),
      (Yl = (t) => ({
        format: t.format,
      ...
      (Xl = (t, e, r, n) => {
        let [o, i] = Kl(e, n, r),
          s = O('x', e.dataType, e.dims.length),
          u = s.type.value,
          d = 'value += x_val;',
          c = '';
        o.countIncludePad
        ...
        return {
          ...
          getShaderSource: (S) =>
            Zl(S, s, e.dims.length, i.length, o, d, c, 0, m, g, b, y),
        };
      }),
      (Jl = (t) => {
        const e = t.count_include_pad !== 0,
          r = Yl(t);
        if (r.ceilMode !== 0)
          throw new Error(
            'using ceil() in shape computation is not yet supported for AveragePool'
          );
        const n = { countIncludePad: e, ...r, cacheKey: '' };
    ...
    `,
      ...
      (ac = (t) => {
        ...
        const o = { storageOrder: e, dilations: r, ...n, cacheKey: '' };
  ...
  pc = V(() => {
    ...
    (sy = (t, e) => {
      ...
      if (
        t[1].dims.length !== 0 &&
        t[1].dims.length !== 1 &&
        t[1].dims.length !== t[0].dims.length
      )
        throw new Error(
      ...
      if (e.blockSize > 0) {
        ...
        const r = t[0].dims[e.axis],
          n = t[1].dims[e.axis];
        if (
          e.blockSize < Math.ceil(r / n) ||
          e.blockSize > Math.ceil(r / (n - 1) - 1)
        )
          throw new Error(
      ...
      (uy = (t, e) => {
        const r = k.normalizeAxis(e.axis, t[0].dims.length),
          n = t[0].dataType,
          o = n === 3,
          i = t[0].dims,
          s = t[1].dataType,
          ...
          b = p.length === 0 || (p.length === 1 && p[0] === 1),
          y = b === !1 && p.length === 1,
          w = fe(u),
          S = b && (!d || w === 4),
          x = S ? w : 1,
          $ = S && !d ? w : 1,
          T = O('input', d ? 12 : n, c.length, $),
          I = O('scale', s, p.length),
          E = m ? O('zero_point', d ? 12 : n, g.length) : void 0,
          A = R('output', s, i.length, x),
          z = [T, I];
        E && z.push(E);
        const v = [c, p];
        m && v.push(g);
...
var dy,
  ...
  fc = V(() => {
    ...
    (dy = (t, e, r) => {
      ...
      (ly = (t, e, r, n) => {
        const o = Math.abs(Math.ceil((e - t) / r)),
          i = [o],
          s = o,
          u = [
            { type: 12, data: s },
      ...
      (mc = (t) => {
        ...
        t.inputs[0].dataType === 6
          ...
          ye.webgpu.validateInputContent && dy(e, r, n),
          t.compute(ly(e, r, n, t.inputs[0].dataType), { inputs: [] });
      });
  });
var cy,
  py,
    ...
    (cy = (t, e, r, n) => {
      ...
      (py = (t, e) => {
        const r = t[0].dims,
          ...
          o = r,
          i = 1,
          s = Math.ceil(k.sizeToDimension(n, n.length - 1) / i),
          u = n[n.length - 1],
          ...
          p = (m) => {
            const g = O('indices', t[1].dataType, t[1].dims.length),
              b = O('updates', t[2].dataType, t[2].dims.length, i),
              y =
                e.reduction !== 'none' && e.reduction !== ''
                  ? Gs('output', t[0].dataType, o.length)
  ...
  $c = V(() => {
    ...
    (my = (t, e) => {
      ...
      (fy = (t, e, r) => {
        ...
        const n = new Array(r).fill(1);
        return e.forEach((o, i) => (n[o] = t[i])), n;
      }),
      (hy = (t, e, r, n, o, i) => {
        const [s, u, d] = r > 10 ? [1, 2, 3] : [-1, t.length > 1 ? 1 : -1, -1],
          c = t[0].dims.length;
...
`),
     ...
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${e} { ` +
        ...
        `;
            ...
            default:
              throw new Error(
                `Coordinate transform mode ${t} is not supported`
              );
          }
        })() +
        '}'),
      (yy = (t, e, r) =>
        ...
        '}'),
      (by = (t, e, r) => {
        const n = new Array(r).fill(0).concat(new Array(r).fill(1)),
      ...
      (_y = (t, e, r) => {
        ...
        return (
          r.axes.length > 0
            ...
            : (e.fill(n, 0, e.length),
              o.forEach((i, s) => (o[s] = Math.round(i * e[s])))),
          o
        );
      }),
      (vy = (t, e, r, n, o) => `
...
`
          : ''),
      (Sy = (t, e, r, n, o) => {
        const [s, u, d, c] = r.length === 2 ? [-1, 0, 1, -1] : [0, 2, 3, 1],
          p = t.type.value;
        return `
  ...
  fn bicubicInterpolation(output_indices: ${e.type.indices}) -> ${y} {
    ...
    depth = max(0, min(depth, ${r[u]} - 1));
      ...
      (Cy = (t, e, r, n, o, i) => {
        let s = t.dims,
          u = by(i, e.axes, s.length),
          d = wy(s, n, o, e.axes),
          c = n.slice();
        n.length === 0 &&
          ((c = s.map(($, T) => ($ === 0 ? 1 : d[T] / $))),
          e.keepAspectRatioPolicy !== 'stretch' && (d = _y(s, c, e)));
        const p = R('output', t.dataType, d.length),
          m = O('input', t.dataType, s.length),
          g = k.size(d),
          b = s.length === d.length && s.every(($, T) => $ === d[T]),
          y = e.coordinateTransformMode === 'tf_crop_and_resize',
          w = e.extrapolationValue,
          S = m.type.value,
          x = ($) => `
      ${
        b
...
`
      ...
      (_c = (t, e) => {
        ...
        hy(t.inputs, e, i, r, n, o),
          t.compute(Cy(t.inputs[0], e, i, r, n, o), { inputs: [0] });
      }),
      (vc = (t) => {
        const e = t.antialias,
          r = t.axes,
...
var Ey,
  ...
  Sc = V(() => {
    ...
    (Ey = (t) => {
      ...
      const o = e.dims[e.dims.length - 1],
      ...
      (ky = (t, e, r, n) => {
        const o = e.simplified,
          ...
          T = (E) => {
            ...
            m && z.push(O('beta', t[3].dataType, t[3].dims, x)),
              g && z.push(O('bias', t[4].dataType, t[4].dims, x)),
              z.push(R('output', t[0].dataType, u, x)),
              b && z.push(R('mean_output', 1, p)),
              y && z.push(R('inv_std_output', 1, p)),
              w && z.push(R('input_skip_bias_sum', t[0].dataType, u, x));
            const v = be(t[0].dataType),
              M = be(1, x);
            return `
      ...
      (xc = (t, e) => {
        ...
        t.outputCount > 1 && n.push(-3),
          ...
          t.compute(ky(t.inputs, e, t.outputCount, !1), { outputs: n });
      });
  });
var Py,
  pn,
  ...
  Ac = V(() => {
    ...
    (Py = (t, e) => {
      ...
      if (e.axes.length !== 0) {
        if (
          e.axes.length !== e.starts.length ||
          e.axes.length !== e.ends.length
        )
      ...
      (Tc = (t, e, r, n, o) => {
        ...
        return (
          t < 0 && (i += r[n[e]]),
          o[e] < 0
            ? Math.max(0, Math.min(i, r[n[e]] - 1))
            : Math.max(0, Math.min(i, r[n[e]]))
        );
      }),
      (zy = (
        t,
      ...
      (Dy = (t, e) => {
        let r = t[0].dims,
          ...
          o =
            e.axes.length > 0
              ? k.normalizeAxes(e.axes, r.length)
              : [...Array(r.length).keys()],
          i = pn(t, 4);
        i.forEach(
          (x) =>
        ...
        const s = e.starts.map((x, $) => Tc(x, $, r, o, i)),
          u = e.ends.map((x, $) => Tc(x, $, r, o, i));
        ...
        if (o.length !== r.length)
          for (let x = 0; x < r.length; ++x)
            o.includes(x) ||
              (s.splice(x, 0, 0), u.splice(x, 0, r[x]), i.splice(x, 0, 1));
        const d = i.map((x) => Math.sign(x));
        i.forEach((x, $, T) => {
          if (x < 0) {
            const I = (u[$] - s[$]) / x,
              E = s[$],
        ...
        const p = { dims: c, dataType: t[0].dataType },
    ...
    (By = (t) => {
      ...
      (My = (t, e) => {
        let r = t.inputs[0],
          ...
          o = k.size(n),
          i = n.length,
          s = k.normalizeAxis(e.axis, i),
          u = s < n.length - 1,
          d,
          c = [];
        u
          ? ((c = Array.from({ length: i }, (z, v) => v)),
            (c[s] = i - 1),
            (c[i - 1] = s),
            (d = t.compute(Oe(r, c), { inputs: [r], outputs: [-1] })[0]))
          : (d = r);
        let p = d.dims,
          m = p[i - 1],
          g = o / m,
            ...
            v === 4
              ...
              : v === 2
                ...
                : v === 3
                  ? `max(max(${z}.x, ${z}.y), ${z}.z)`
                  : z,
          x = O('x', d.dataType, d.dims, b),
          $ = R('result', d.dataType, d.dims, b),
          T = x.type.value,
          I =
            be(d.dataType) === 'f32'
      ...
      ${z.mainStart(w)}
        ...
        for (var col = lindex; col < cols; col += wg) {
          ...
          A = t.compute(
            {
              name: 'Softmax',
              shaderCache: { hint: `${b};${w}`, inputDependencies: ['type'] },
              getRunData: () => ({
                outputs: [{ dims: p, dataType: d.dataType }],
                dispatchGroup: { x: g },
                programUniforms: [{ type: 6, data: y }],
              }),
              getShaderSource: E,
            },
...
var Oc,
  ...
  Dc = V(() => {
    ...
    ne();
    ae();
    (Oc = (t) => Array.from(t.getBigInt64Array(), Number)),
      (Ry = (t) => {
      ...
      ${d.setByOffset('global_idx', u.getByIndices('input_indices'))}
        ...
        return {
          ...
          getRunData: () => ({
            outputs: [{ dims: o, dataType: t[0].dataType }],
            dispatchGroup: { x: Math.ceil(i / 64) },
            programUniforms: [{ type: 12, data: i }, ...L(t[0].dims, o)],
          }),
          getShaderSource: c,
        };
      }),
  ...
  Mc = V(() => {
    ...
    (Vy = (t, e, r, n, o) => {
      ...
      if (!n)
        ...
        const m = (g, b, y = '') => {
          const w = `a_data[index_a${b}][component_a${b}]`,
            S = `b_data[index_b${b}][component_b${b}]`,
            x = `bool(c_data[index_c${b}] & (0xffu << (component_c${b} * 8)))`;
          return `
      ...
      (Ly = (t) => {
        let e = t[1].dims,
          ...
          u = k.size(e);
        if (i) {
          const c = ot.calcShape(ot.calcShape(e, r, !1), n, !1);
          if (!c)
            throw new Error("Can't perform where op on the given tensors");
          (s = c), (u = k.size(s));
        }
        const d = Math.ceil(u / 4);
        return {
          name: 'Where',
          ...
          getRunData: () => ({
            ...
            programUniforms: [{ type: 12, data: d }, ...L(n, e, r, s)],
          }),
        };
      }),
      (Bc = (t) => {
    ...
    mn = class {
      ...
      run(e, r, n, o, i) {
        ...
        u.setPipeline(e.computePipeline),
          ...
          Me(e.programInfo.name);
      }
      dispose() {}
      build(e, r) {
        Ne(e.name);
        const n = this.backend.device,
          o = [];
        [
        ...
        const s = Hs(r, this.backend.device.limits),
          u = e.getShaderSource(s),
          d = `${o.join(`
`)}
...
${u}`,
        ...
        const p = n.createComputePipeline({
    ...
    (Wy = (t, e) => {
      ...
      for (let n = 0; n < t.length; ++n) {
        ...
        switch (e[n]) {
          ...
          case 'rank': {
            const i = t[n].dims.length;
            r.push(`${o};${i}`);
            break;
          }
          case 'dims': {
            const i = t[n].dims.join(',');
            r.push(`${o};${i}`);
            break;
          }
          default:
      ...
      (Gy = (t, e, r) => {
        ...
        return (
          ...
          (n +=
            ':' +
            r +
            `:${Wy(e, t.shaderCache?.inputDependencies ?? new Array(e.length).fill('dims'))}`),
          n
        );
      }),
      (Do = class {
      ...
      (Bo = class {
        ...
        async initialize(e, r) {
          ...
          i('chromium-experimental-timestamp-query-inside-passes') ||
            ...
            (this.adapterInfo = new Do(
              r.info || (await r.requestAdapterInfo())
            )),
            (this.gpuDataManager = Ls(this)),
            (this.programManager = new mn(this)),
        ...
        getComputePassEncoder() {
          if (!this.computePassEncoder) {
            const e = this.getCommandEncoder(),
              r = {};
          ...
          this.queryType !== 'none' &&
            ...
            this.queryType !== 'none' &&
              e.mapAsync(GPUMapMode.READ).then(() => {
                const r = new BigUint64Array(e.getMappedRange()),
                ...
                for (let o = 0; o < r.length / 2; o++) {
                  ...
                  const w = Number(b - this.queryTimeBase),
                    S = Number(y - this.queryTimeBase);
                  ...
                  if (this.env.webgpu.profiling?.ondata)
                    ...
                    g.forEach((T, I) => {
                      ...
                      console.log(
                        `[profiling] kernel "${s}|${d}|${c}|${p}" ${x}${$}start time: ${w} ns, execution time: ${S - w} ns`
                      );
                  }
                  Sr('GPU', `${p}::${b}::${y}`);
                }
        ...
        run(e, r, n, o, i, s) {
          ...
          for (let T = 0; T < r.length; ++T) {
            const I = r[T].data;
            if (I === 0) continue;
            const E = this.gpuDataManager.get(I);
          ...
          if (m.length !== d.length)
            throw new Error(
              `Output size ${m.length} must be equal to ${d.length}.`
            );
          const g = [],
            b = [];
          for (let T = 0; T < d.length; ++T) {
            ...
            const I = m[T] === -1,
              ...
              A =
                I || E
                  ? i(d[T].dataType, d[T].dims)
                  : o(m[T], d[T].dataType, d[T].dims);
            if ((g.push(A), A.data === 0)) continue;
            const z = this.gpuDataManager.get(A.data);
          ...
          if (p) {
            let T = 0,
              I = [];
            p.forEach((v) => {
              const M = typeof v.data == 'number' ? [v.data] : v.data;
              if (M.length === 0) return;
              let N = v.type === 10 ? 2 : 4,
                K,
                q;
              v.type === 10
                ? ((q = M.length > 4 ? 16 : M.length > 2 ? 8 : M.length * N),
                  (K = M.length > 4 ? 16 : N * M.length))
                : ((q = M.length <= 2 ? M.length * N : 16), (K = 16)),
                (T = Math.ceil(T / q) * q),
                I.push(T);
              const Q = v.type === 10 ? 8 : 4;
            ...
            p.forEach((v, M) => {
              const N = I[M],
                K = typeof v.data == 'number' ? [v.data] : v.data;
            ...
            const z = this.gpuDataManager.create(
              T,
              GPUBufferUsage.COPY_DST | GPUBufferUsage.UNIFORM
            );
            this.device.queue.writeBuffer(z.buffer, 0, A, 0, T),
              this.gpuDataManager.release(z.id),
              (y = { offset: 0, size: T, buffer: z.buffer });
          }
          let w = this.programManager.normalizeDispatchGroupSize(c),
            S = w[1] === 1 && w[2] === 1,
            x = Gy(e, r, S),
            $ = this.programManager.getArtifact(x);
          if (
            ($ ||
              (($ = this.programManager.build(e, w)),
              this.programManager.setArtifact(x, $),
              se('info', () => `[artifact] key: ${x}, programName: ${e.name}`)),
            p && $.uniformVariablesInfo)
          ) {
            if (p.length !== $.uniformVariablesInfo.length)
              throw new Error(
                `Uniform variables count mismatch: expect ${$.uniformVariablesInfo.length}, got ${p.length} in program "${$.programInfo.name}".`
              );
            for (let T = 0; T < p.length; T++) {
              const I = p[T],
                E = I.type,
                A = typeof I.data == 'number' ? 1 : I.data.length,
                [z, v] = $.uniformVariablesInfo[T];
              if (E !== z || A !== v)
                throw new Error(
                  `Uniform variable ${T} mismatch: expect type ${z} with size ${v}, got type ${E} with size ${A} in program "${$.programInfo.name}".`
                );
            }
          }
          if (
            (se(
              'info',
              () =>
                `[ProgramManager] run "${e.name}" (key=${x}) with ${w[0]}x${w[1]}x${w[2]}`
            ),
        ...
        releaseKernel(e) {
          const r = this.kernelPersistentData.get(e);
          if (r) {
            for (const n of r) this.gpuDataManager.release(n.id);
            this.kernelPersistentData.delete(e);
          }
          this.kernelCustomData.delete(e), this.kernels.delete(e);
        }
        computeKernel(e, r, n) {
          const o = this.kernels.get(e);
          if (!o) throw new Error(`kernel not created: ${e}`);
          const i = o.kernelType,
            s = o.kernelName,
            u = o.kernelEntry,
            d = o.attributes;
          if (this.currentKernelId !== null)
          ...
          (this.currentKernelId = e),
            ...
            se('info', () => `[WebGPU] Start to run kernel "[${i}] ${s}"...`);
          const c = this.env.debug;
          this.temporaryData = [];
          try {
            ...
            return (
              n.push(
                Promise.resolve(`[WebGPU] Kernel "[${i}] ${s}" failed. ${p}`)
              ),
              1
            );
          } finally {
            c &&
              n.push(
                this.device
                  ...
                  .then((p) =>
                    p
                      ? `GPU validation error for kernel "[${i}] ${s}": ${p.message}`
                      : null
                  )
              );
            for (const p of this.temporaryData)
        ...
        registerBuffer(e, r, n, o) {
          ...
          const s = i.get(r),
            u = this.gpuDataManager.registerExternalBuffer(n, o, s);
          return i.set(r, [u, n]), u;
        }
        unregisterBuffers(e) {
          const r = this.sessionExternalDataMapping.get(e);
          r &&
            (r.forEach((n) =>
              this.gpuDataManager.unregisterExternalBuffer(n[0])
            ),
            this.sessionExternalDataMapping.delete(e));
        }
        getBuffer(e) {
          const r = this.gpuDataManager.get(e);
          if (!r) throw new Error(`no GPU data for buffer: ${e}`);
          return r.buffer;
        }
        createDownloader(e, r, n) {
          return async () => {
            const o = await co(this, e, r);
        ...
        replay() {
          ...
          const e = this.capturedCommandList.get(this.currentSessionId),
            r = this.capturedPendingKernels.get(this.currentSessionId),
            n = e.length;
          this.pendingKernels = [];
          for (let o = 0; o < n; o++) {
            const i = this.getComputePassEncoder(),
              s = e[o];
    ...
    (sr = class t {
      ...
      (Mo = class {
        constructor(e, r, n) {
          ...
          const u = Number(e.getValue(o * i++, s));
          (this.outputCount = Number(e.getValue(o * i++, s))),
            (this.customDataOffset = Number(e.getValue(o * i++, '*'))),
            (this.customDataSize = Number(e.getValue(o * i++, s)));
          const d = [];
          for (let c = 0; c < u; c++) {
            const p = Number(e.getValue(o * i++, s)),
              m = Number(e.getValue(o * i++, '*')),
              g = Number(e.getValue(o * i++, s)),
              b = [];
        ...
        compute(e, r) {
          const n =
            ...
            o = r?.outputs ?? [],
            i = (u, d, c) => new sr(this.module, d, this.output(u, c), c),
            s = (u, d) => {
              const c = xt(u, d);
              if (!c) throw new Error(`Unsupported data type: ${u}`);
              const p = c > 0 ? this.backend.gpuDataManager.create(c).id : 0;
              return new sr(this.module, u, p, d);
            };
          return this.backend.run(e, n, o, i, s, this.outputCount);
        }
        output(e, r) {
          const n = this.module.stackSave();
          try {
            const o = this.module.PTR_SIZE,
              i = o === 4 ? 'i32' : 'i64',
              s = this.module.stackAlloc((1 + r.length) * o);
      ...
      (Hy = async (t, e, r, n) => {
        ...
        if (t === 'webgpu') {
          const i = (Lc(), Yt(Vc)).WebGpuBackend,
            s = new i();
            ...
            o('webgpu', [
              ...
              (u, d, c) =>
                s.createKernel(
                  ...
                  Number(d),
                  c,
                  e.UTF8ToString(e._JsepGetNodeName(Number(d)))
                ),
              (u) => s.releaseKernel(u),
              (u, d, c, p) => {
                se(
  ...
  Qn = V(() => {
    ...
    (Fy = (t, e) => {
      ...
      (kr = async (t, e) => {
        ...
        {
          const n = (Gc(), Yt(Wc)).init;
          e === 'webgpu' && (await n('webgpu', ge(), t, r)),
            e === 'webnn' && (await n('webnn', ge(), t));
        }
      }),
      (Mt = new Map()),
      (qy = (t) => {
      ...
      (Hc = (t, e) => {
        ...
        try {
          const i = r.PTR_SIZE,
            s = r.stackAlloc(2 * i);
          r._OrtGetInputOutputMetadata(t, e, s, s + i) !== 0 &&
            me("Can't get session input/output metadata.");
          const d = Number(r.getValue(s, '*'));
          o = Number(r.getValue(s + i, '*'));
          const c = r.HEAP32[o / 4];
          if (c === 0) return [d, 0];
          const p = r.HEAPU32[o / 4 + 1],
            m = [];
          for (let g = 0; g < p; g++) {
            const b = Number(r.getValue(o + 8 + g * i, '*'));
            m.push(
              b !== 0
                ? r.UTF8ToString(b)
                : Number(r.getValue(o + 8 + (g + p) * i, '*'))
            );
          }
          return [d, c, m];
        } finally {
      ...
      (Pr = async (t, e) => {
        ...
        try {
          if (
            (([s, d] = await Ts(e)), e?.externalData && o.mountExternalData)
          ) {
            const I = [];
            for (const E of e.externalData) {
              const A = typeof E == 'string' ? E : E.path;
              I.push(
                rr(typeof E == 'string' ? E : E.data).then((z) => {
          ...
          for (const I of e?.executionProviders ?? [])
            if ((typeof I == 'string' ? I : I.name) === 'webnn') {
              if (((o.shouldTransferToMLTensor = !1), typeof I != 'string')) {
                ...
                z
                  ? (o.currentContext = z)
                  : v
                    ? (o.currentContext = await o.webnnCreateMLContext(v))
          ...
          (i = await o._OrtCreateSession(r, n, s)),
          ...
          for (let I = 0; I < m; I++) {
            ...
            const v = o.UTF8ToString(E);
            y.push(v),
              S.push(
                A === 0
                  ? { name: v, isTensor: !1 }
                  : { name: v, isTensor: !0, type: rt(A), shape: z }
              );
          }
          for (let I = 0; I < g; I++) {
            const [E, A, z] = Hc(i, I + m);
              ...
              );
            {
              ...
              const M =
                  typeof e?.preferredOutputLocation == 'string'
                    ...
                    : (e?.preferredOutputLocation?.[v] ?? 'cpu'),
              ...
              if (
                ...
                throw new Error(
                  `Not supported preferred output location: ${M}.`
                );
              if (b && M !== 'gpu-buffer')
                throw new Error(
                  `Not supported preferred output location: ${M}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`
                );
              $.push(M);
            }
          }
          ...
          return (
            $.some(
              ...
              (T = {
                ...
                outputPreferredLocationsEncoded: $.map((I) =>
                  I === 'ml-tensor-cpu-output' ? 'ml-tensor' : I
                ).map((I) => to(I)),
              })),
            Mt.set(i, [i, c, p, T, b, !1]),
            [i, y, w, S, x]
          );
        } catch (m) {
          throw (
            ...
            u !== 0 &&
              ...
              me("Can't release IO binding."),
            i !== 0 &&
              o._OrtReleaseSession(i) !== 0 &&
              me("Can't release session."),
            m)
          );
        } finally {
          o._free(r),
      ...
      (Or = (t) => {
        ...
        s &&
          (u &&
            e._OrtClearBoundOutputs(s.handle) !== 0 &&
            me("Can't clear bound outputs."),
          e._OrtReleaseBinding(s.handle) !== 0 &&
            me("Can't release IO binding.")),
      ...
      (Fc = async (t, e, r, n, o, i, s = !1) => {
        ...
        if (m === 'gpu-buffer') {
          const x = t[2].gpuBuffer;
          y = xt($t(c), p);
          {
            const $ = u.jsepRegisterBuffer;
            if (!$)
              throw new Error(
          ...
          const x = t[2].mlTensor;
          y = xt($t(c), p);
          const $ = u.webnnRegisterMLTensor;
          if (!$)
            throw new Error(
          ...
          if (Array.isArray(x)) {
            ...
            const $ = u.webnnIsGraphInput,
              T = u.webnnIsGraphOutput;
            if (c !== 'string' && $ && T) {
              const I = u.UTF8ToString(o);
              if ($(n, I) || T(n, I)) {
                const E = $t(c);
                (y = xt(E, p)), (g = 'ml-tensor');
                const A = u.webnnCreateTemporaryTensor,
                  z = u.webnnUploadTensor;
                if (!A || !z)
                  throw new Error(
                    'Tensor location "ml-tensor" is not supported without using WebNN.'
                  );
                const v = await A(n, E, p);
                z(v, new Uint8Array(x.buffer, x.byteOffset, x.byteLength)),
                  (b = v);
              } else
                (y = x.byteLength),
                  (b = u._malloc(y)),
                  r.push(b),
                  u.HEAPU8.set(new Uint8Array(x.buffer, x.byteOffset, y), b);
            } else
              (y = x.byteLength),
                (b = u._malloc(y)),
                r.push(b),
        ...
        try {
          p.forEach(($, T) =>
            u.setValue(S + T * d, $, d === 4 ? 'i32' : 'i64')
          );
          const x = u._OrtCreateTensor($t(c), b, y, S, p.length, to(g));
          x === 0 &&
            me(
      ...
      (zr = async (t, e, r, n, o, i) => {
        ...
        try {
          ...
          for (let W = 0; W < w; W++)
            s.setValue(v + W * u, T[W], '*'),
              s.setValue(M + W * u, p[e[W]], '*');
          for (let W = 0; W < S; W++)
            s.setValue(N + W * u, I[W], '*'),
              s.setValue(K + W * u, m[n[W]], '*');
          if (g && !y) {
            const {
              handle: W,
              outputPreferredLocations: j,
              outputPreferredLocationsEncoded: Y,
            } = g;
            if (p.length !== w)
              throw new Error(
                `input count from feeds (${w}) is expected to be always equal to model's input count (${p.length}).`
              );
            wt('wasm bindInputsOutputs');
            for (let Z = 0; Z < w; Z++) {
              const te = e[Z];
              (await s._OrtBindInput(W, p[te], T[Z])) !== 0 &&
            ...
            for (let Z = 0; Z < S; Z++) {
              ...
              o[Z]?.[3]
                ? (A.push(I[Z]),
                  s._OrtBindOutput(W, m[te], I[Z], 0) !== 0 &&
                    me(
                      `Can't bind pre-allocated output[${Z}] for session=${t}.`
                    ))
                : s._OrtBindOutput(W, m[te], 0, Y[te]) !== 0 &&
                  me(`Can't bind output[${Z}] to ${j[Z]} for session=${t}.`);
            }
            _t('wasm bindInputsOutputs'), Mt.set(t, [c, p, m, g, b, !0]);
          }
          s.jsepOnRunStart?.(c), s.webnnOnRunStart?.(c);
          let q;
          g
            ? (q = await s._OrtRunWithBinding(c, g.handle, S, N, x))
            : (q = await s._OrtRun(c, M, v, w, K, S, N, x)),
            q !== 0 && me('failed to call OrtRun().');
          const Q = [],
            D = [];
          wt('wasm ProcessOutputTensor');
          for (let W = 0; W < S; W++) {
            const j = Number(s.getValue(N + W * u, '*'));
            if (j === I[W] || A.includes(I[W])) {
              Q.push(o[W]),
                j !== I[W] &&
                  s._OrtReleaseTensor(j) !== 0 &&
                  me("Can't release tensor.");
              continue;
            }
            let Y = s.stackSave(),
              Z = s.stackAlloc(4 * u),
              ...
              we = 0;
            try {
              s._OrtGetTensorData(j, Z, Z + u, Z + 2 * u, Z + 3 * u) !== 0 &&
                me(`Can't access output tensor data on index ${W}.`);
              const re = u === 4 ? 'i32' : 'i64',
                U = Number(s.getValue(Z, re));
              we = s.getValue(Z + u, '*');
              const X = s.getValue(Z + u * 2, '*'),
                Se = Number(s.getValue(Z + u * 3, re)),
                Be = [];
              for (let Ce = 0; Ce < Se; Ce++)
                Be.push(Number(s.getValue(X + Ce * u, re)));
              s._OrtFree(X) !== 0 && me("Can't free memory for tensor dims.");
              const ze = Be.reduce((Ce, $e) => Ce * $e, 1);
              ie = rt(U);
              const Xe = g?.outputPreferredLocations[n[W]];
              if (ie === 'string') {
                if (Xe === 'gpu-buffer' || Xe === 'ml-tensor')
                  throw new Error('String tensor is not supported on GPU.');
                const Ce = [];
                for (let $e = 0; $e < ze; $e++) {
                  const Fe = s.getValue(we + $e * u, '*'),
                    Ue = s.getValue(we + ($e + 1) * u, '*'),
                    ve = $e === ze - 1 ? void 0 : Ue - Fe;
                  Ce.push(s.UTF8ToString(Fe, ve));
                }
                Q.push([ie, Be, Ce, 'cpu']);
              } else if (Xe === 'gpu-buffer' && ze > 0) {
                const Ce = s.jsepGetBuffer;
                if (!Ce)
                  throw new Error(
                ...
                const Ce = s.webnnEnsureTensor,
                  $e = s.webnnIsGraphInputOutputTypeSupported;
                if (!Ce || !$e)
                  throw new Error(
                ...
                const Ce = s.webnnCreateMLTensorDownloader(we, ie)(),
                  $e = Q.length;
                (te = !0),
                  D.push(
                    (async () => {
                      const Fe = [$e, await Ce];
                      return (
                        s.webnnReleaseTensorId(we), s._OrtReleaseTensor(j), Fe
                      );
                    })()
                  ),
                  Q.push([ie, Be, [], 'cpu']);
                ...
                new Uint8Array($e.buffer, $e.byteOffset, $e.byteLength).set(
                  s.HEAPU8.subarray(we, we + $e.byteLength)
                ),
                  Q.push([ie, Be, $e, 'cpu']);
              }
            } finally {
              s.stackRestore(Y),
                ie === 'string' && we && s._free(we),
                te || s._OrtReleaseTensor(j);
            }
          }
          g &&
            !b &&
            (s._OrtClearBoundOutputs(g.handle) !== 0 &&
              me("Can't clear bound outputs."),
            Mt.set(t, [c, p, m, g, b, !1]));
          for (const [W, j] of await Promise.all(D)) Q[W][2] = j;
          return _t('wasm ProcessOutputTensor'), Q;
        } finally {
          s.webnnOnRunEnd?.(c),
            s.stackRestore(z),
            T.forEach((q) => s._OrtReleaseTensor(q)),
            I.forEach((q) => s._OrtReleaseTensor(q)),
            E.forEach((q) => s._free(q)),
            x !== 0 && s._OrtReleaseRunOptions(x),
            $.forEach((q) => s._free(q));
        }
      }),
      (Dr = (t) => {
...
var Rt,
  ...
  No = V(() => {
    ...
    vt();
    Cr();
    (Rt = () => !!ye.wasm.proxy && typeof document < 'u'),
      (ur = !1),
      (hn = !1),
      (gn = !1),
      (Uo = new Map()),
      ...
      (jy = (t) => {
        switch (t.data.type) {
          case 'init-wasm':
            (ur = !1),
              t.data.err
                ? ((gn = !0), Ro[1](t.data.err))
                : ((hn = !0), Ro[0]()),
              fn && (URL.revokeObjectURL(fn), (fn = void 0));
            break;
          case 'init-ep':
          case 'copy-from':
          case 'create':
      ...
      (Kc = async (t) => {
        if (Rt())
          return (
            ...
            new Promise((e, r) => {
              Ft('init-ep', [e, r]);
              const n = { type: 'init-ep', in: { epName: t, env: ye } };
              He.postMessage(n);
            })
          );
        await kr(ye, t);
      ...
      (jc = async (t) =>
        Rt()
          ? (qt(),
            new Promise((e, r) => {
              Ft('copy-from', [e, r]);
              const n = { type: 'copy-from', in: { buffer: t } };
      ...
      (Zc = async (t, e) => {
        if (Rt()) {
          ...
          return (
            ...
            new Promise((r, n) => {
              Ft('create', [r, n]);
              const o = { type: 'create', in: { model: t, options: { ...e } } },
                i = [];
        ...
        if (Rt())
          return (
            ...
            new Promise((e, r) => {
              ...
              const n = { type: 'end-profiling', in: t };
              He.postMessage(n);
            })
          );
        Dr(t);
    ...
    (Jc = (t, e) => {
      ...
      (Zy = (t) => {
        switch (t[3]) {
          ...
          case 'gpu-buffer': {
            ...
            const { gpuBuffer: r, download: n, dispose: o } = t[2];
          ...
          case 'ml-tensor': {
            ...
            const { mlTensor: r, download: n, dispose: o } = t[2];
      ...
      (yn = class {
        ...
        async loadModel(e, r) {
          ...
          let n;
          typeof e == 'string'
            ? (n = await this.fetchModelAndCopyToWasmMemory(e))
            : (n = e),
            ([
              this.sessionId,
              this.inputNames,
        ...
        async run(e, r, n) {
          ...
          Object.entries(r).forEach((g) => {
            const b = g[0],
              y = g[1],
              w = this.outputNames.indexOf(b);
            if (w === -1) throw new Error(`invalid output '${b}'`);
            s.push(y), u.push(w);
          });
          const d = o.map((g, b) =>
              Jc(g, () => `input "${this.inputNames[i[b]]}"`)
            ),
            c = s.map((g, b) =>
              g ? Jc(g, () => `output "${this.outputNames[u[b]]}"`) : null
            ),
            p = await Yc(this.sessionId, i, d, u, c, n),
            m = {};
...
var tp,
  ...
  np = V(() => {
    ...
    ep();
    (tp = () => {
      (typeof ye.wasm.initTimeout != 'number' || ye.wasm.initTimeout < 0) &&
        (ye.wasm.initTimeout = 0);
      const t = ye.wasm.simd;
      if (
        (typeof t != 'boolean' &&
          t !== void 0 &&
          t !== 'fixed' &&
          ...
          (ye.wasm.simd = !1)),
        typeof ye.wasm.proxy != 'boolean' && (ye.wasm.proxy = !1),
        typeof ye.wasm.trace != 'boolean' && (ye.wasm.trace = !1),
        typeof ye.wasm.numThreads != 'number' ||
          !Number.isInteger(ye.wasm.numThreads) ||
          ye.wasm.numThreads <= 0)
      )
...
var sT = Zn;
{
  const t = (np(), Yt(rp)).wasmBackend;
  kt('webgpu', t, 5), kt('webnn', t, 5), kt('cpu', t, 10), kt('wasm', t, 10);
}
Object.defineProperty(ye.versions, 'web', { value: ss, enumerable: !0 });
export {
