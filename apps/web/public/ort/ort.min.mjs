...
var vt = (e) => Wu($n({}, '__esModule', { value: !0 }), e);
var xt,
  je,
  Ze,
  Hu,
    ...
    (xt = new Map()),
      ...
      (Ze = (e, t, n) => {
        if (
          ...
          const r = xt.get(e);
          if (r === void 0) xt.set(e, { backend: t, priority: n });
          else {
            ...
            return new Promise((l, c) => {
              ...
              (m.crossOrigin = 'Anonymous'),
                ...
                (m.onload = () => {
                  ...
                  const h = f.getImageData(0, 0, p.width, p.height);
      ...
      (Dr = () => {
        if (!Br) {
          ...
          const e = typeof BigInt64Array < 'u' && BigInt64Array.from,
            ...
            r = typeof n < 'u' && n.from;
          e && (Qe.set('int64', BigInt64Array), lt.set(BigInt64Array, 'int64')),
            t &&
              (Qe.set('uint64', BigUint64Array),
              lt.set(BigUint64Array, 'uint64')),
            r
              ? (Qe.set('float16', n), lt.set(n, 'float16'))
              : Qe.set('float16', Uint16Array);
        }
      });
  });
var Mr,
  ...
  Nr = k(() => {
    ...
    It = class e {
      ...
      async run(t, n, r) {
        ...
        for (const d of this.inputNames)
          if (typeof t[d] > 'u')
            throw new Error(`input '${d}' is missing in 'feeds'.`);
        if (s) for (const d of this.outputNames) o[d] = null;
        const a = await this.handler.run(t, o, i),
          u = {};
        for (const d in a)
        ...
        return Le('InferenceSession.run'), ge(), u;
      }
      async release() {
        return this.handler.dispose();
      }
      static async create(t, n, r, o) {
        be(), Ne('InferenceSession.create');
        let i,
          s = {};
        if (typeof t == 'string') {
        ...
        const [a, u] = await br(s),
          d = await a.createInferenceSessionHandler(i, u);
        return Le('InferenceSession.create'), ge(), new e(d);
      }
      startProfiling() {
...
var Kr,
  ...
  Qr = k(() => {
        ...
        try {
          switch (t) {
            ...
            case 'run': {
              ...
              Dt(r, o, i, s, new Array(s.length).fill(null), a).then(
                (u) => {
                  u.some((d) => d[3] !== 'cpu')
                    ? postMessage({
                        type: t,
                    ...
                    : postMessage({ type: t, out: u }, Mt([...i, ...u]));
                },
                (u) => {
    ...
    Fu = jr ? null : (e) => new Worker(e ?? we, { type: 'module', name: Kr });
  });
var Jr,
  Ku,
  ju,
  ...
  At = k(() => {
    Ct();
    (Jr = typeof location > 'u' ? void 0 : location.origin),
      (Ku = import.meta.url > 'file:' && import.meta.url < 'file;'),
      (ju = () => {
        if (1) {
          if (Ku) {
            const e = URL;
      ...
      (we = ju()),
      (Ut = () => {
        if (we && !we.startsWith('blob:'))
          return we.substring(0, we.lastIndexOf('/') + 1);
      }),
      (kn = (e, t) => {
        try {
          const n = t ?? we;
      ...
      (Qu = (e, t) => `${t ?? './'}${e}`),
      (eo = async (e) => {
        const n = await (await fetch(e, { credentials: 'same-origin' })).blob();
    ...
    ($e = (e, t) => {
      ...
      (Y = (e) => {
        ...
        try {
          ...
          const i = Number(t.getValue(o, r === 4 ? 'i32' : 'i64')),
            s = t.getValue(o + r, '*'),
      ...
      (so = async (e) => {
        ...
        try {
          ...
          if (
            ...
            o.executionProviders && (await od(n, o, r)),
          ...
          if (o.freeDimensionOverrides)
            for (const [c, p] of Object.entries(o.freeDimensionOverrides)) {
              if (typeof c != 'string')
                throw new Error(
  ...
  Dn = k(() => {
    ...
    ft = async (e) => {
      if (typeof e == 'string')
        if (!1)
          try {
            const { readFile: t } = vn('node:fs/promises');
            return new Uint8Array(await t(e));
          } catch (t) {
            if (t.code === 'ERR_FS_FILE_TOO_LARGE') {
              const { createReadStream: n } = vn('node:fs'),
                r = n(e),
                o = [];
              for await (const i of r) o.push(i);
...
var id,
  ...
  ke = k(() => {
    ...
    (id = ['V', 'I', 'W', 'E', 'F']),
      (sd = (e, t) => {
        console.log(`[${id[e]},${new Date().toISOString()}]${t}`);
      }),
      (Wt = (e, t) => {
        (uo = e), (lo = t);
      }),
      ...
      (Pe = class {
        static calcShape(t, n, r = !1) {
          ...
          for (let u = r ? 3 : 1; u <= s; u++) {
            const d = o - u < 0 ? 1 : t[o - u],
              l = i - u < 0 ? 1 : n[i - u];
            if (d !== l && d > 1 && l > 1) return;
            const c = Math.max(d, l);
    ...
    (fo = new Map([
      ...
      (Rn = (e, t) => {
        ...
        const o = e.byteLength / r,
          i = new (rt(t))(e.buffer, e.byteOffset, o);
        switch (t) {
          case 'int64':
          case 'uint64': {
      ...
      (ho = (e, t) => {
        ...
        const n = e.byteLength / 4,
          r = new Int32Array(e.buffer, e.byteOffset, n);
        switch (t) {
          case 'int64': {
            const o = BigInt64Array.from(r, BigInt);
          ...
          case 'uint64': {
            ...
            const o = BigUint64Array.from(r, BigInt);
            return new Uint8Array(o.buffer);
          }
          case 'int8': {
            ...
            const o = Int8Array.from(r, Number);
            return new Uint8Array(o.buffer);
          }
          case 'uint8': {
          ...
          case 'uint32': {
            ...
            const o = Uint32Array.from(r, Number);
            return new Uint8Array(o.buffer);
          }
          default:
      ...
      (Ft = class {
        ...
        destroy() {
          Z('verbose', () => '[WebNN] TensorWrapper.destroy'),
        ...
        async read(t) {
          if (this.fallbackDataType) {
            const n = await this.mlContext.readTensor(this.mlTensor),
              r = ho(new Uint8Array(n), this.dataType);
            if (t) {
              (t instanceof ArrayBuffer
                ? new Uint8Array(t)
      ...
      (Kt = class {
        ...
        async ensureTensor(t, n, r, o) {
          ...
          if (!s?.input.dataTypes.includes(n)) {
            if (((a = dd.get(n)), !a || s?.input.dataTypes.includes(a)))
        ...
        async download(t) {
          if (this.activeUpload) {
            const n = this.wrapper?.isDataConverted
              ? ho(this.activeUpload, this.wrapper?.type)
              : this.activeUpload;
            if (t) {
              t instanceof ArrayBuffer
      ...
      (Un = class {
        ...
        getMLContext(t) {
          const n = this.backend.getMLContext(t);
        ...
        releaseTensorId(t) {
          const n = this.tensorTrackersById.get(t);
          n &&
        ...
        async ensureTensor(t, n, r, o, i) {
          ...
          const s = this.tensorTrackersById.get(n);
          if (!s) throw new Error('Tensor not found.');
          return s.ensureTensor(t, r, o, i);
        }
        upload(t, n) {
          const r = this.tensorTrackersById.get(t);
        ...
        releaseTensorsForSession(t) {
          for (const n of this.freeTensors) n.sessionId === t && n.destroy();
          this.freeTensors = this.freeTensors.filter((n) => n.sessionId !== t);
        }
        registerTensor(t, n, r, o) {
          const i = this.getMLContext(t),
            s = mo(),
            a = new Ft({
              sessionId: t,
              context: i,
          ...
          return (
            this.tensorTrackersById.set(s, new Kt(this, a)),
            this.externalTensors.add(a),
            s
          );
        }
        async getCachedTensor(t, n, r, o, i, s, a) {
          const u = this.getMLContext(t);
          for (const [l, c] of this.freeTensors.entries())
            if (c.canReuseTensor(u, n, r)) {
              ...
              const p = this.freeTensors.splice(l, 1)[0];
    ...
    (jt = new Map([
      ...
      (Zt = class {
        ...
        onRunEnd(t) {
          ...
          const n = this.temporarySessionTensorIds.get(t);
          if (n) {
            for (const r of n)
              Z(
                'verbose',
        ...
        async createMLContext(t) {
          if (t instanceof GPUDevice) {
            const r = this.mlContextCache.findIndex((o) => o.gpuDevice === t);
            if (r !== -1) return this.mlContextCache[r].mlContext;
            {
              const o = await navigator.ml.createContext(t);
              return (
                this.mlContextCache.push({ gpuDevice: t, mlContext: o }), o
              );
            }
          } else if (t === void 0) {
            const r = this.mlContextCache.findIndex(
          ...
          const n = this.mlContextCache.findIndex((r) => ld(r.options, t));
          if (n !== -1) return this.mlContextCache[n].mlContext;
          {
            const r = await navigator.ml.createContext(t);
        ...
        onReleaseSession(t) {
          ...
          const n = this.mlContextBySessionId.get(t);
          if (!n) return;
          ...
          const r = this.sessionIdsByMLContext.get(n);
          if ((r.delete(t), r.size === 0)) {
            this.sessionIdsByMLContext.delete(n);
            const o = this.mlContextCache.findIndex((i) => i.mlContext === n);
        ...
        async createTemporaryTensor(t, n, r) {
          ...
          const s = this.temporarySessionTensorIds.get(t);
        ...
        createMLTensorDownloader(t, n) {
          return async () => {
            const r = await this.tensorManager.download(t);
            return qt(r, n);
          };
        }
        registerMLTensor(t, n, r, o) {
          ...
          const s = this.tensorManager.registerTensor(t, n, i, o);
          return (
            Z(
              'verbose',
              () =>
        ...
        registerMLConstant(t, n, r, o, i, s, a = !1) {
          ...
          switch (i.dataType) {
            ...
            case 'int64':
              if (a) {
                const p = Rn(new Uint8Array(l), 'int64');
        ...
        isGraphInput(t, n) {
          const r = this.sessionGraphInputs.get(t);
          return r ? r.includes(n) : !1;
        }
        isGraphOutput(t, n) {
          const r = this.sessionGraphOutputs.get(t);
          return r ? r.includes(n) : !1;
        }
    ...
    (wo = new Map([
      ...
      (Ln = class {
        ...
        upload(t, n) {
          ...
          const u = this.backend.device.createBuffer({
              mappedAtCreation: !0,
              size: s,
          ...
          const l = this.backend.device.createCommandEncoder();
        ...
        memcpy(t, n) {
          const r = this.storageCache.get(t);
          if (!r) throw new Error('source gpu data for memcpy does not exist');
          const o = this.storageCache.get(n);
          if (!o)
        ...
        create(
          ...
          if (i || s) {
            const d = (i ? this.freeBuffers : this.freeUniformBuffers).get(r);
            d
              ? d.length > 0
                ? (o = d.pop())
        ...
        async download(t, n) {
          const r = this.storageCache.get(Number(t));
        ...
        refreshPendingBuffers() {
          if (this.buffersPending.length !== 0)
            if (this.backend.sessionStatus === 'default') {
              for (const t of this.buffersPending) {
                const n = wo.get(t.size);
                if (
                  (t.usage & GPUBufferUsage.STORAGE) ===
                  GPUBufferUsage.STORAGE
                ) {
                  const r = this.freeBuffers.get(t.size) || [];
                  n === void 0 || r.length >= n ? t.destroy() : r.push(t);
                } else if (
                  (t.usage & GPUBufferUsage.UNIFORM) ===
                  GPUBufferUsage.UNIFORM
                ) {
                  const r = this.freeUniformBuffers.get(t.size) || [];
                  n === void 0 || r.length >= n ? t.destroy() : r.push(t);
                } else t.destroy();
              }
              this.buffersPending = [];
              ...
              for (const n of this.buffersPending) t.push(n);
              this.buffersPending = [];
            }
        }
        dispose() {
        ...
        onReleaseSession(t) {
          const n = this.capturedPendingBuffers.get(t);
          n &&
            (n.forEach((r) => {
              r.destroy();
            }),
...
var Je,
  ...
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join('+')};
          ...
          A = (E, N) => (s < 2 ? `${E}` : `${B(E, N, s)}`),
          z = (E, N, se) => (s < 2 ? `${E}=${se};` : `${B(E, N, s)}=${se};`),
          R = {},
          D = (E, N) => {
            m.broadcastedIndicesToOffset = !0;
            const se = `${N.name}broadcastedIndicesTo${e}Offset`;
            if (se in R) return `${se}(${E})`;
            const ve = [];
            for (let he = s - 1; he >= 0; he--) {
              const Ke = N.indicesGet('outputIndices', he + N.rank - s);
              ve.push(`${A(y, he)} * (${Ke} % ${A(b, he)})`);
            }
            return (
          ...
          U = (E, N) =>
            (() => {
              ...
              if (p.storage === 'vec2<u32>' && p.value === 'i32')
                return `${e}[${E}]=vec2<u32>(u32(${N}), select(0u, 0xFFFFFFFFu, ${N} < 0));`;
              if (p.storage === 'vec2<u32>' && p.value === 'u32')
                return `${e}[${E}]=vec2<u32>(u32(${N}), 0u);`;
              if (p.storage === 'u32' && p.value === 'vec4<bool>')
                return `${e}[${E}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${N}));`;
              throw new Error(
    ...
    return ${Q(`i2o_${e}(indices)`)};
          ...
          M =
            s < 2
              ? ''
              : (() => {
                  const E = a.map((se) => `d${se}: u32`).join(', '),
                    N = a.map((se) => `d${se}`).join(', ');
                  return `
  fn get_${e}(${E}) -> ${l} {
        ...
        return {
          impl: () => {
            let E = [],
              N = !1;
            return (
              m.offsetToIndices && (E.push(_), (N = !0)),
              m.indicesToOffset && (E.push($), (N = !0)),
              m.broadcastedIndicesToOffset &&
                (Object.values(R).forEach((se) => E.push(se)), (N = !0)),
              m.set && (E.push(X), (N = !0)),
              m.setByIndices && (E.push(H), (N = !0)),
              m.get && (E.push(M), (N = !0)),
              m.getByIndices && (E.push(O), (N = !0)),
              !i &&
                N &&
                E.unshift(
...
`)
          ...
          set: (...E) => {
            ...
            const se = E.slice(0, s).map(f).join(',');
            return s === 0
              ? U('0u', N)
              : s === 1
                ? U(se[0], N)
      ...
      (S = (e, t, n, r = 1) => Xt(e, t, n, 'input', r)),
      (C = (e, t, n, r = 1) => Xt(e, t, n, 'output', r)),
      (To = (e, t, n) => Xt(e, t, n, 'atomicOutput', 1)),
      (Yt = (e, t, n, r = 1) => Xt(e, t, n, 'internal', r)),
      (Hn = class {
        constructor(t, n) {
  ...
  `;
        ...
        declareVariable(t, n) {
          ...
          const r = t.usage === 'input' ? 'read' : 'read_write',
...
`);
        ...
        uniformDeclaration() {
          ...
          const t = [];
          for (const { name: n, type: r, length: o } of this.uniforms)
            if (o && o > 4)
              r === 'f16'
                ? t.push(
...
var md,
  ...
  Ue = k(() => {
    ...
    (md = (e, t) => {
      ...
      (fd = (e, t) => x.sortBasedOnPerm(e, Co(e.length, t))),
      (hd = (e, t, n, r) => {
  ...
  ${h.mainStart()}
    ...
    output[global_idx] = input[global_idx];
        ...
        const { newShape: l, newPerm: c } = gd(e.dims, o),
  ...
  ${h.mainStart()}
    ...
    ${y.setByOffset('global_idx', b.getByIndices('aIndices'))}
      ...
      (Ao = (e, t) => {
        md(e.inputs, t.perm), e.compute(pe(e.inputs[0], t.perm));
      }),
      (Eo = (e) => G({ perm: e.perm }));
  });
var bd,
  ...
  No = k(() => {
    ...
    (bd = {
      ...
      (ze = (e, t, n, r) => {
        let o = e.inputs.length === 1 ? n : Kn(e.inputs, n),
          i = o.axes;
        i.length === 0 &&
          !o.noopWithEmptyAxes &&
        ...
        let s = x.normalizeAxes(i, e.inputs[0].dims.length),
          a = s,
          u = e.inputs[0],
          d = Id(a, e.inputs[0].dims.length);
        d.length > 0 &&
          ((u = e.compute(pe(e.inputs[0], d), {
            inputs: [0],
            outputs: [-1],
          })[0]),
          (a = vd(a.length, u.dims.length)));
        let [l, c] = xd(u.dims, a),
          p = l;
        o.keepDims && (p = Sd(l, s)),
          e.compute(Cd(t, o.cacheKey, [u], r, e.inputs[0].dataType, p, c), {
            inputs: [u],
          });
      }),
      (ko = (e, t) => {
...
`)
      ...
      (De = (e, t, n, r) => {
        const o = e.inputs,
          i = o.length === 1 ? n : Kn(o, n);
        e.compute(
          en(
            t,
            { hint: i.cacheKey, inputDependencies: ['rank'] },
            [o[0]],
            i.noopWithEmptyAxes && i.axes.length === 0 ? Ad : r,
            i.axes,
            o[0].dataType,
            i.keepDims,
            i.noopWithEmptyAxes
...
`)}`,
      ...
      (Lo = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Dd(e, t) : ko(e, t);
      }),
      (Go = (e, t) => {
      ...
      (Zo = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Rd(e, t) : Ro(e, t);
      }),
      (Qo = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ed(e, t) : Vo(e, t);
      });
  });
var Xo,
  Yo,
...
var Vd,
  ...
  tn = k(() => {
    ...
    (Vd = (e, t) => {
      ...
      if (t.qkvHiddenSizes.length > 0) {
        ...
        for (const _ of t.qkvHiddenSizes)
          if (_ % t.numHeads !== 0)
            throw new Error(
    ...
    `),
      (Nd = (e, t, n, r, o, i, s, a) => {
        ...
        const b = (y) => {
          const g = C('x', e.dataType, e.dims, u),
            _ = [g],
    ...
    if (sum == 0) {
      ...
      (Ld = (e, t, n, r, o, i, s, a, u) => {
        ...
        v && $.push('type'),
          ...
          a && $.push('type'),
          u && $.push('type');
        const T = [{ dims: l, dataType: t.dataType, gpuDataType: 0 }];
        c && T.push({ dims: f, dataType: t.dataType, gpuDataType: 0 });
        const I = (A) => {
          const z = S('q', t.dataType, t.dims, b),
            R = S('key', n.dataType, n.dims, b),
            D = [z, R];
          if (v) {
            const H = S('past_key', r.dataType, r.dims, b);
            D.push(H);
          }
          o && D.push(S('attention_bias', o.dataType, o.dims));
          const U = a ? S('seq_lens', a.dataType, a.dims) : void 0;
          U && D.push(U);
          const Q = u
            ? S('total_sequence_length_input', u.dataType, u.dims)
            : void 0;
          Q && D.push(Q);
          const O = C('output', t.dataType, l),
            M = [O];
  ...
  ${A.mainStart([g, g, 1])}
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      (Gd = (e, t, n, r, o, i, s = void 0, a = void 0) => {
        const u = i + o.kvSequenceLength,
          d = o.nReps ? o.nReps : 1,
          l = o.vHiddenSize * d,
          c = e > 1 && r,
        ...
        const w = [{ dims: m, dataType: t.dataType, gpuDataType: 0 }];
        c && w.push({ dims: f, dataType: t.dataType, gpuDataType: 0 });
        const v = ($) => {
          const T = S('probs', t.dataType, t.dims),
            I = S('v', n.dataType, n.dims),
            A = [T, I];
          g && A.push(S('past_value', r.dataType, r.dims));
          const z = s ? S('seq_lens', s.dataType, s.dims) : void 0;
          s && A.push(z);
          const R = a
            ? S('total_sequence_length_input', a.dataType, a.dims)
            : void 0;
          a && A.push(R);
          const U = [C('output', t.dataType, m)];
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
      ...
      (ot = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
        const p = Math.min(e.outputCount, 1 + (s ? 1 : 0) + (a ? 1 : 0)),
        ...
        p > 1 && s && x.size(s.dims) > 0 && b.push(s),
          ...
          l && b.push(l),
          c && b.push(c);
        const y = e.compute(Ld(p, t, n, s, h, d, f, l, c), {
          inputs: b,
          outputs: p > 1 ? [-1, 1] : [-1],
        })[0];
        e.compute(
          Nd(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c),
        ...
        p > 1 && a && x.size(a.dims) > 0 && g.push(a),
          l && g.push(l),
          c && g.push(c),
          e.compute(Gd(p, y, r, a, d, f, l, c), {
            inputs: g,
            outputs: p > 1 ? [0, 2] : [0],
          });
      }),
      (Wd = (e, t) => {
        const n = [t.batchSize, t.numHeads, t.sequenceLength, t.headSize],
          r = t.sequenceLength,
          o = t.inputHiddenSize,
          i = t.headSize,
          s = 12,
          ...
          l = (c) => {
            const p = C('output_q', u[0].dataType, n),
...
var Hd,
  ...
  ri = k(() => {
    ...
    (Hd = (e, t) => {
      ...
      (qd = (e, t) => {
        const { epsilon: n, spatial: r, format: o } = t,
          i = e[0].dims,
  ...
  ${_.guardAgainstOutOfBoundsWorkgroupSizes('uniforms.outputSize')}
    ...
    ${b.setByOffset('global_idx', 'value')}
      ...
      (Fd = (e) => G(e)),
      (ni = (e, t) => {
        const { inputs: n, outputCount: r } = e,
          o = Fd({ ...t, outputCount: r });
        if ((ne.webgpu.validateInputContent && Hd(n, o), t.trainingMode))
          throw new Error(
  ...
  ${e.mainStart()}
    ...
    ${l.setByOffset('global_idx', u)}
      ...
      (ee = (e, t, n, r, o, i = e.dataType, s, a) => {
        const u = [{ type: 12, data: Math.ceil(x.size(e.dims) / 4) }];
        return (
          s && u.push(...s),
          {
            name: t,
            ...
            getShaderSource: (d) =>
              Zd(d, x.size(e.dims), e.dataType, i, n, r, a),
            getRunData: (d) => ({
      ...
      (ht = (e) => G(e)),
      (_i = (e, t) => {
        const n = ce(e.inputs[0].dataType);
        e.compute(
          ee(
            e.inputs[0],
            'Elu',
...
fn erf_vf32(v: vec4<${e}>) -> vec4<${e}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
      ...
      (wi = (e) => {
        const t = ce(e.inputs[0].dataType);
      ...
      (Ei = (e) => {
        e.compute(
          ee(e.inputs[0], 'Sigmoid', (t) => `(1.0 / (1.0 + exp(-${t})))`)
        );
      }),
      (ki = (e) => G(e)),
      (Pi = (e, t) => {
...
`),
      ...
      (Ri = (e) => {
        const t = ce(e.inputs[0].dataType);
        e.compute(
          ee(e.inputs[0], 'FastGelu', Xn, Qn(t), void 0, e.inputs[0].dataType)
        );
      }),
      (Vi = (e, t) => {
        const n = ce(e.inputs[0].dataType);
...
var Jd,
  ...
  Hi = k(() => {
    ...
    (Jd = (e) => {
      ...
      (el = (e) => {
        const t = e[0].dims.slice();
        t[2] = t[2] / 2;
        const n = S('input', e[0].dataType, e[0].dims, 4),
  ...
  ts = k(() => {
    ...
    (tl = (e, t, n, r, o, i, s, a, u, d, l, c) => {
      ...
      if (o)
        ...
        const g = (_, w, v = '') => {
          const $ = `aData[indexA${w}][componentA${w}]`,
      ...
      (nl = (e, t, n, r, o, i, s = n.dataType) => {
        ...
        return (
          m.push(p),
          {
            ...
            getShaderSource: (h) =>
              tl(h, a, u, l, p, d, f, o, n.dataType, r.dataType, s, i),
            getRunData: () => ({
      ...
      (Zi = (e) => {
        const t = S('input', e.inputs[0].dataType, e.inputs[0].dims).type.value;
        Me(
          e,
          'Pow',
          {
    ...
    return ${e}u;
      ...
      (sl = (e, t) => {
        const n = e.length,
          r = [];
        for (let o = 0; o < n; ++o) {
          const i = t.setByOffset('global_idx', e[o].getByIndices('indices'));
          n === 1
            ? r.push(i)
            : o === 0
  ...
  ${h.mainStart()}
    ...
    ${sl(s, c)}
      ...
      (ns = (e, t) => {
        ...
        const s = n.filter((a) => x.size(a.dims) > 0);
  ...
  qe = k(() => {
    ...
    (Ie = (e, t, n = 'f32') => {
      ...
      (on = (e) => {
        ...
        if (t === 'HardSigmoid') {
          const [n, r] = e?.activation_params || [0.2, 0.5];
          return { activation: t, alpha: n, beta: r };
        } else if (t === 'Clip') {
          const [n, r] = e?.activation_params || [co, po];
          return { activation: t, clipMax: r, clipMin: n };
        } else if (t === 'LeakyRelu') {
          const [n] = e?.activation_params || [0.01];
...
`;
      ...
      (an = (e, t, n, r, o = !1, i) => {
        ...
        Ce(t, _),
          ...
          _.push(...P(g));
        const w = (v) => {
          let $ = Yt('batch_dims', e[0].dataType, b.length),
            T = S('a', e[0].dataType, s.length, p),
            I = S('b', e[1].dataType, a.length, c),
            A = C('output', e[0].dataType, g.length, c),
            z = re(A.type.tensor),
            R = Ie(t, A.type.value, z),
            D = [T, I],
            U = '';
          if (h) {
            const M = o ? c : 1;
            D.push(S('bias', e[2].dataType, e[2].dims.length, M)),
              (U = `${o ? `value += bias[col / ${M}];` : `value += ${A.type.value}(bias[row + i]);`}`);
          }
          const Q = [
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      ...
      (Jn = (e, t, n = 'f32', r, o = !1, i = 32, s = !1, a = 32, u = !1) => {
        const d = e[1] * t[1],
          l = e[0] * t[0],
          c = o ? d : i,
          p = o ? i : d;
...
`;
    ...
    `;
      ...
      (yt = (e, t, n, r, o = !1, i) => {
        ...
        const D = (U) => {
          const Q = l.length,
            O = Yt('batchDims', e[0].dataType, Q, 1),
            M = re(e[0].dataType),
            V = S('a', e[0].dataType, v, _),
            W = S('b', e[1].dataType, T, _),
            H = C('result', e[0].dataType, I.length, _),
            X = [V, W];
          if (R) {
            const N = o ? _ : 1;
          ...
          Ae(t, oe);
          const de = re(H.type.tensor),
            q = Ie(t, H.type.value, de),
            E = cl(_, R, q, [O, V, W, H], o);
          return `
  ${U.registerUniforms(oe)
    .registerInternalVariables(O)
    .declareVariables(...X, H)}
  ${E}
...
var pl,
  ...
  ls = k(() => {
    ...
    as();
    dn();
    (pl = (e, t, n, r, o = !1, i, s = 4, a = 4, u = 4, d = 'f32') => {
      const l = (z) => {
          switch (z) {
            case 1:
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${H}>` : H}) {
        ...
        setOutputAtIndex(flatIndex ${h ? '/ 4' : ''}, value);
            ...
            oe = S('x', e[0].dataType, e[0].dims.length, v === 3 ? 1 : v),
            de = S('w', e[1].dataType, e[1].dims.length, W),
            q = [oe, de],
            E = C('result', e[0].dataType, n.length, W);
          if (s) {
            const N = S('bias', e[2].dataType, e[2].dims.length, W);
            q.push(N),
              (X += `
        ...
        ${h ? Yn(_, g, H, void 0, !d, I) : Jn(_, g, H, void 0, !d, I, !1, void 0, a)}`;
        };
        return {
          name: 'Conv2DMatMul',
          shaderCache: {
            hint: `${t.cacheKey};${v};${h};${A};${z};${R};${$};${T};${I}`,
            inputDependencies: Q,
          },
          getRunData: () => ({
...
var ml,
  ...
  hs = k(() => {
    ...
    (ml = (e) => {
      ...
      (cs = (e) => (typeof e == 'number' ? [e, e, e] : e)),
      (ln = (e, t) => (t <= 1 ? e : e + (e - 1) * (t - 1))),
      (fl = (e, t, n, r = 1) => {
        const o = ln(t, r);
        return Math.floor((e[0] * (n - 1) - n + o) / 2);
      }),
      (ps = (e, t, n, r, o) => {
        o == null && (o = fl(e, t[0], r[0]));
        const i = [0, 0, 0, n];
        for (let s = 0; s < 3; s++)
          e[s] + 2 * o >= t[s] &&
      ...
      (hl = (e, t, n, r, o, i, s, a, u, d) => {
        ...
        if ((e === 'VALID' && (e = 0), typeof e == 'number')) {
          ...
          const m = ps([t, n, r, 1], [a, u, d], 1, [o, i, s], e);
          (c = m[0]), (p = m[1]), (f = m[2]);
          ...
          const m = ps([t, n, r, 1], [a, u, d], 1, [o, i, s], e[0]);
          (c = m[0]), (p = m[1]), (f = m[2]);
      ...
      (ms = (e, t, n, r, o, i = !1, s = 'channelsLast') => {
        ...
        let [p, , f, m, h] = t,
          ...
          I = ln(h, v),
          {
            ...
            outHeight: R,
            outWidth: D,
          } = hl(o, u, d, l, b, y, g, $, T, I),
          U = i ? p * c : p,
          Q = [0, 0, 0, 0, 0];
        return (
          s === 'channelsFirst'
            ? (Q = [a, U, z, R, D])
            : s === 'channelsLast' && (Q = [a, z, R, D, U]),
          {
            batchSize: a,
            dataFormat: s,
            inDepth: u,
      ...
      (fs = (e, t, n, r, o, i) => {
        const s = i === 'channelsLast',
          ...
          d = [64, 1, 1],
          l = { x: n.map((g, _) => _) },
          c = [Math.ceil(ml(l.x.map((g) => n[g])) / d[0]), 1, 1];
        Z('verbose', () => `[conv3d_naive_webgpu] dispatch = ${c}`);
        const p = u ? (s && a % 4 !== 0 ? 3 : 4) : 1,
          f = x.size(n),
          m = [
            { type: 12, data: f },
            { type: 12, data: r },
        ...
        const y = (g) => {
          ...
          let w = u ? 4 : 1,
            ...
            z = '';
          if (b) {
            const U = S('bias', e[2].dataType, e[2].dims.length, w);
            I.push(U),
              (z += `
...
var gs,
  ...
  bs = k(() => {
    ...
    (gs = (e, t, n, r) => {
      ...
      const m = o ? ['rank', 'rank', 'rank'] : ['rank', 'rank'];
      f.push(...P([n[0], n[1], n[2], n[3] / c]));
      const h = (b) => {
        const y = C('output', e[0].dataType, n.length, c),
          g = re(y.type.tensor),
  ...
  ${b.mainStart()}
    ...
    ${y.setByOffset('global_idx', 'value')}
      ...
      (ys = (e, t, n, r) => {
        ...
        const p = (s - 1) * t.strides[1] + d[1],
          f = (m) => {
            const h = C('output', e[0].dataType, l.length, i),
              b = re(h.type.tensor),
            ...
            const v = o ? 'value += b[output_channel];' : '',
              $ = [
                { name: 'output_size', type: 'u32' },
  ...
  ws = k(() => {
    ...
    (gl = (e, t, n, r, o, i) => {
      ...
      (yl = (e, t) => {
        ...
        const n = e[0].dims[t.format === 'NHWC' ? e[0].dims.length - 1 : 1],
      ...
      (_s = (e, t, n, r) => {
        const o = n.format === 'NHWC',
          i = gl(t[0].dims, t[1].dims, n.dilations, n.pads, n.strides, o);
        if (n.group !== 1) {
          const $ = [t[0]];
          if (o) {
            const I =
        ...
        if (
          ...
          s && z.push(t[2]);
          const R = A[2],
            D = z[0].dims[z[0].dims.length - 1];
          R < 8 && D < 8
            ? e.compute(an(z, n, i, A, o, r), { inputs: z })
            : e.compute(yt(z, n, i, A, o, r), { inputs: z });
          return;
        }
        const b = !0,
          y =
      ...
      (_l = (e, t, n) => {
        const r = n.format === 'NHWC' ? 'channelsLast' : 'channelsFirst',
          o = tr(n, t),
          i = n.autoPad === 'NOTSET' ? n.pads : n.autoPad,
          s = ms(t[0].dims, t[1].dims, n.strides, n.dilations, i, !1, r);
        e.compute(
          fs(
            t,
            o,
    ...
    $s = (e, t, n) => {
      ...
      const A = (z) => {
        const R = [
          ...
          Q = i ? 2 : 3,
          O = i ? 3 : 1,
          M = S('W', e[1].dataType, e[1].dims.length, h),
          V = S('Dy', e[0].dataType, e[0].dims.length, l),
          W = [V, M];
        r && W.push(S('bias', e[2].dataType, [o[O]].length, m));
        const H = C('result', e[0].dataType, o.length, m),
          X = () => {
            let q = '';
            if (c)
              l === 4
...
var wl,
  ...
  Cs = k(() => {
    ...
    qe();
    Ue();
    (wl = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i),
      ($l = (e, t, n, r, o) => {
      ...
      (xl = (e, t) => {
        ...
        if (n !== r)
          throw new Error('FILTER_IN_CHANNEL should be equal to DATA_CHANNEL');
        const o = e[1].dims[1] * t.group;
        if (e.length === 3 && (e[2].dims.length !== 1 || e[2].dims[0] !== o))
          throw new Error('invalid bias');
        const i = e[0].dims.length - 2;
        if (
  ...
  ks = k(() => {
    ...
    (Tl = (e, t, n, r) => {
      const o = x.size(t),
        ...
        l = (c) => {
          const p = ` i32(${s.indicesGet('inputIndices', 'uniforms.axis')}) `,
...
`)
  ...
  ${y.mainStart()}
    ...
    ${h.setByOffset('global_idx', m.getByIndices('aIndices'))}
      ...
      (zs = (e) =>
        G({ blocksize: e.blocksize, mode: e.mode, format: e.format }));
  });
var or,
  cn,
  Ds,
    ...
    (or = '[a-zA-Z]|\\.\\.\\.'),
      ...
      (sr = class {
        constructor(t, n) {
          ...
          if (
            (r.split(',').forEach((a, u) => {
              const d = t[u].dims.slice();
              if (!a.match(RegExp(Ds))) throw new Error('Invalid LHS term');
              const l = this.processTerm(a, !0, d, u);
              this.lhs.push(l);
            }),
            o === '')
          )
          ...
          o.match(RegExp(or, 'g'))?.forEach((a) => {
            if (a === '...')
              ...
              const u = this.symbolToInfo.get(a);
            ...
            d?.forEach((c, p) => {
              if (c === '...') {
                ...
                for (let m = 0; m < a.length; m++) {
                  const h = String.fromCharCode(48 + m);
      ...
      (Os = (e) => e + '_max'),
      (Pl = (e, t, n, r) => {
        const i = e.map((l) => l.length).map((l, c) => S(`input${c}`, t, l)),
          s = x.size(r),
          ...
          d = (l) => {
            ...
            n.symbolToInfo.forEach((v, $) => {
              if (n.rhs.symbolToIndices.has($)) {
                const T = n.rhs.symbolToIndices.get($)?.[0];
                T !== void 0 &&
                  n.lhs.forEach((I, A) => {
                    if (v.inputIndices.includes(A)) {
                      const z = I.symbolToIndices.get($);
                      if (z === void 0) throw new Error('Invalid symbol error');
                      z.forEach((R) => {
                        c.push(
                          `${i[A].indicesSet(`input${A}Indices`, R, a.indicesGet('outputIndices', T))}`
                        );
                      });
                    }
                  });
...
`)};
      ...
      (Ms = (e, t) => {
        const n = new sr(e.inputs, t.equation),
          r = n.outputDims,
          o = e.inputs.map((i, s) => i.dims);
        e.compute(Pl(o, e.inputs[0].dataType, n, r));
      }),
      (Us = (e) => {
        const t = e.equation.replace(/\s+/g, '');
        return G({ equation: t });
      });
  });
var zl,
  ...
  Ls = k(() => {
    ...
    (zl = (e) => {
      ...
      (Bl = (e, t) => (e.length > t.length ? Vs(e, t) : Vs(t, e))),
      (Dl = (e) => {
        const t = e[0].dims,
          n = Array.from(e[1].getBigInt64Array(), Number),
          r = Bl(t, n),
...
var Rl,
  ...
  Zs = k(() => {
    ...
    (Rl = (e, t, n, r, o, i, s, a, u) => {
      ...
      d.push(...P(t.dims, l));
      const c = (p) => {
        const f = S('indices_data', t.dataType, t.dims.length),
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
      ...
      (Ks = (e, t) => {
        ...
        const m = Rl(e, n[1], p, t.batchDims, r, a, c, l, s),
          h = t.batchDims + s;
        if (h > r.length)
          throw new Error(
            'last dimension of indices must not be larger than rank of input tensor'
          );
        const b = i.slice(0, -1).concat(r.slice(h)),
          y = x.size(b),
          g = [
            { type: 12, data: y },
            { type: 12, data: u },
          ...
          _ = (w) => {
            const v = S('data', n[0].dataType, n[0].dims.length),
...
var Vl,
  ...
  Ys = k(() => {
    ...
    (Vl = (e, t) => {
      ...
      const n = x.normalizeAxis(t.quantizeAxis, e[0].dims.length),
        r = t.blockSize,
        o = e[0],
        i = e[2],
      ...
      (Nl = (e, t) => {
        ...
        const u = x.size(a),
          ...
          f = (m) => {
            const h = S('data', e[0].dataType, e[0].dims.length),
...
var Wl,
    ...
    (Wl = (e) => {
      ...
      (Hl = (e, t) => {
        ...
        const h = (y) => {
            ...
            const A = C('output', e[0].dataType, a.length);
            I.push(A);
            const z = [
              { name: 'output_size', type: 'u32' },
              { name: 'M', type: 'u32' },
  ...
  ${y.mainStart()}
    ...
    output[global_idx] = value;
          ...
          b = (y) => {
            ...
            const $ = C('output', e[0].dataType, a.length);
            v.push($);
            let T = [
      ...
      `),
            ...
            const z = t.alpha === 1 ? '' : 'value *= uniforms.alpha;';
            return `
  ...
  ${y.mainStart([u, u, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      (ra = (e, t) => {
        Wl(e.inputs), e.compute(Hl(e.inputs, t));
      });
  });
var Re,
  Fe,
...
`),
      ...
      (Yl = (e, t) => {
        ...
        t.format === 'NHWC' &&
          ...
          ([Re, Fe, it, st] = [0, 3, 1, 2]));
        const s = C('output', e[0].dataType, i.length),
          a = n.type.value,
          u = x.size(i),
...
var ye,
  ...
  ar = k(() => {
    ...
    j();
    Ue();
    (ye = (e, t) => (e.length > t && e[t].dims.length > 0 ? e[t] : void 0)),
      (tc = (e, t) => {
        const n = e[0],
          r = ye(e, 1),
          o = ye(e, 2),
      ...
      (nc = (e, t, n, r, o, i, s) => {
        const a = [r, o, i],
          ...
          l = (c) => {
            const p = C('qkv_with_bias', t.dataType, a),
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
      ...
      (bt = (e, t, n, r, o, i, s, a) => {
        ...
        if (s && x.size(s.dims) > 0) {
          ...
          return (
            (u = nc(e, i, s, t, r, n * o, a)),
            (u = u.reshape([t, r, n, o])),
            n === 1 || r === 1
              ? u
              : e.compute(pe(u, ua.perm), { inputs: [u], outputs: [-1] })[0]
          );
        } else
          return (
      ...
      (la = (e, t) => {
        ...
        const c = o && i && o.dims.length === 4 && i.dims.length === 4,
          p = bt(
            e,
            n.batchSize,
            n.numHeads,
        ...
        if (c) return ot(e, p, o, i, a, void 0, d, l, u, n);
      ...
      (oc = (e, t) => {
        ...
        return (
          e[1].dims[0] > 0 &&
            ...
            (r = n.length)),
          G({ numOutputs: r, axis: t.axis, splitSizes: n })
        );
      }),
      (ic = (e) => `
    ...
    return ${e}u;
      ...
      (sc = (e) => {
        const t = e.length,
          n = [];
        for (let r = 0; r < t; ++r) {
          const o = e[r].setByIndices('indices', 'input[global_idx]');
          t === 1
            ? n.push(o)
            : r === 0
...
`)}
  ...
  ${m.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
      ...
      (ca = (e, t) => {
        rc(e.inputs);
        const n = e.inputs.length === 1 ? t : oc(e.inputs, t);
    ...
    (ac = (e, t) => {
      ...
      (pn = (e, t) => {
        const {
          ...
          h = (b) => {
            const y = S('input', e[0].dataType, e[0].dims.length),
      ...
      (fa = (e, t, n) => {
        ...
        return (
          t.dims.length === 3 &&
            ...
            (r = e.compute(pe(r, dc.perm), { inputs: [r], outputs: [-1] })[0])),
          r
        );
      }),
      (lc = (e, t, n, r) => {
        const o = 7,
          ...
          d = (l) => {
            const c = S('seq_lens', n.dataType, n.dims),
  ...
  `;
      ...
      (ha = (e, t) => {
        ...
        let r = e.inputs[0],
          ...
          [p, f, m] =
            !o && !i
              ? e.compute(ur([r], c), { inputs: [r], outputs: [-1, -1, -1] })
              : [r, o, i],
          h,
          b;
        if (t.doRotary) {
          const w = e.compute(lc(n.batchSize, n.sequenceLength, u, d), {
              inputs: [u, d],
              outputs: [-1],
            })[0],
            v = e.inputs[7],
            ...
            I = [p, w, v, $],
            A = [-1];
          (h = e.compute(pn(I, T), { inputs: I, outputs: A })[0]),
            I.splice(0, 1, f);
          const z = G({
            interleaved: t.rotaryInterleaved !== 0,
    ...
    if (local_idx == 0) {
      ...
      (cc = (e, t, n) => {
        const r = t[0].dims,
          ...
          d = J(u),
          l = x.size(o) / d,
          c = ya(e, t[0], t[1], t[2], s, u, a, n.epsilon),
          p = [s, a, u / d],
          f = [s, a],
          m = ['type', 'none'],
          h = (b) => {
            const y = S('x', t[0].dataType, p.length, d),
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes('uniforms.output_size')}
      ...
      (pc = (e, t, n) => {
        ...
        const m = p
          ...
          h = ya(e, m, t[1], t[2], i, a, s, n.epsilon),
          b = (y) => {
            const g = re(t[0].dataType),
...
var hc,
  ...
  xa = k(() => {
    ...
    (hc = (e) => {
      ...
      (va = (e) => {
        hc(e.inputs);
        const t = Pe.calcShape(e.inputs[0].dims, e.inputs[1].dims, !0);
        ...
        if (n < 8 && r < 8) e.compute(an(e.inputs, { activation: '' }, t));
          ...
          if (i !== 1 && o === 1 && s === 1) {
            const a = e.inputs[0].reshape([1, i, r]),
              u = e.inputs[1].reshape([1, r, n]),
              d = [1, i, n],
              l = [a, u];
            e.compute(yt(l, { activation: '' }, t, d), { inputs: l });
          } else e.compute(yt(e.inputs, { activation: '' }, t));
        }
      });
  });
var gc,
  ...
  Ia = k(() => {
    ...
    (gc = (e, t) => {
      ...
      const o = Math.floor((t.k + t.blockSize - 1) / t.blockSize),
      ...
      (yc = (e, t) => {
        ...
        const T = (I) => {
          const A = w.length,
            ...
            R = S('b', 12, v.length, f),
            D = S('scales', e[2].dataType, e[2].dims.length),
            U = [z, R, D],
            Q =
              e.length === 4 ? S('zero_points', 12, e[3].dims.length) : void 0;
          Q && U.push(Q);
          const O = $.length,
            M = C('output', e[0].dataType, O, m),
            V = re(e[0].dataType),
            W = (() => {
              switch (p) {
                case 1:
          ...
          `;
            ...
            b_dequantized_values = ${
              p === 1
                ? `${W}(${Array.from({ length: 8 }, (E, N) => `(b_quantized_values[${N}] - ${Q ? `zero_point${q}` : 'zero_point'}) * scale${q}`).join(', ')});`
                : `(b_quantized_values - ${W}(${Array(8)
                    .fill(`${Q ? `zero_point${q}` : 'zero_point'}`)
                    .join(',')})) * scale${q};`
            };
...
var _c,
  ...
  Aa = k(() => {
    ...
    (_c = (e) => {
      ...
      (Tc = (e, t) => {
        const n = x.padShape(e[0].dims.slice(), t.pads),
          r = e[0].dims,
          o = x.size(n),
          i = [
            { type: 12, data: o },
        ...
        const a = ['rank'],
          u = (d) => {
            const l = C('output', e[0].dataType, n.length),
...
var mn,
  ...
  qa = k(() => {
    ...
    (mn = (e) => {
      ...
      (Ea = (e, t, n) => {
        const r = t.format === 'NHWC',
          o = e.dims.slice();
        r && o.splice(1, 0, o.pop());
        const i = Object.hasOwn(t, 'dilations'),
          s = t.kernelShape.slice(),
          a = t.strides.slice(),
          u = i ? t.dilations.slice() : [],
          d = t.pads.slice();
        Ye.adjustPoolAttributes(n, o, s, a, u, d);
        const l = Ye.computePoolOutputShape(n, o, a, u, s, d, t.autoPad),
          c = Object.assign({}, t);
        i
          ? Object.assign(c, {
              kernelShape: s,
      ...
      (ka = (e, t) => {
        ...
        if (t.kernelShape.length <= 2) {
          const a = t.kernelShape[t.kernelShape.length - 1],
          ...
          let p = !1;
          if (t.kernelShape.length === 2) {
            const f = t.kernelShape[t.kernelShape.length - 2],
          ...
          const a = x.computeStrides(t.kernelShape);
          i.push(
            { type: 12, data: a },
            { type: 12, data: t.pads },
            { type: 12, data: t.strides }
          ...
          const u = t.pads.reduce((d, l) => d + l);
          return [i, s, !!u, !1, !1];
        }
      }),
      (Pa = (e, t, n, r, o, i, s, a, u, d, l, c) => {
        const p = o.format === 'NHWC',
          f = t.type.value,
      ...
      (Cc = (e) => `${za(e)};${e.countIncludePad}`),
      (Ac = (e) => `${za(e)};${e.storageOrder};${e.dilations}`),
      (Ba = (e) => ({
        format: e.format,
      ...
      (Da = (e, t, n, r) => {
        ...
        return {
          ...
          getShaderSource: (b) =>
            Pa(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m),
        };
      }),
      (Oa = (e) => {
        const t = e.count_include_pad !== 0,
          n = Ba(e);
        if (n.ceilMode !== 0)
          throw new Error(
            'using ceil() in shape computation is not yet supported for AveragePool'
          );
        const r = { countIncludePad: t, ...n, cacheKey: '' };
    ...
    `,
      ...
      (Ga = (e) => {
        ...
        const o = { storageOrder: t, dilations: n, ...r, cacheKey: '' };
...
var kc,
  ...
  ja = k(() => {
    ...
    (kc = (e, t) => {
      ...
      (Pc = (e, t) => {
        const n = x.normalizeAxis(t.axis, e[0].dims.length),
          r = e[0].dataType,
          o = r === 3,
          i = e[0].dims,
          s = e[1].dataType,
...
var zc,
  ...
  Qa = k(() => {
    ...
    (zc = (e, t, n) => {
      ...
      (Bc = (e, t, n, r) => {
        const o = Math.abs(Math.ceil((t - e) / n)),
          i = [o],
          s = o,
          a = [
            { type: 12, data: s },
      ...
      (Za = (e) => {
        ...
        e.inputs[0].dataType === 6
          ...
          ne.webgpu.validateInputContent && zc(t, n, r),
          e.compute(Bc(t, n, r, e.inputs[0].dataType), { inputs: [] });
      });
  });
var Dc,
  Oc,
    ...
    (Dc = (e, t, n, r) => {
      ...
      (Oc = (e, t) => {
        const n = e[0].dims,
          ...
          l = (c) => {
            const p = S('indices', e[1].dataType, e[1].dims.length),
              f = S('updates', e[2].dataType, e[2].dims.length, i),
              m =
                t.reduction !== 'none' && t.reduction !== ''
                  ? To('output', e[0].dataType, o.length)
...
var Mc,
  ...
  ou = k(() => {
    ...
    (Mc = (e, t) => {
      ...
      (Rc = (e, t, n, r, o, i) => {
        const [s, a, u] = n > 10 ? [1, 2, 3] : [-1, e.length > 1 ? 1 : -1, -1],
          d = e[0].dims.length;
        ...
        if (
          ...
          Mc(r, t),
            t.axes.length > 0 && Uc(r, t.axes, d).forEach((l, c) => (r[c] = l));
        }
        if (
          u > 0 &&
          e.length > u &&
...
`),
     ...
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { ` +
      ...
      (Nc = (e, t, n) =>
        ...
        '}'),
      (Lc = (e, t, n) => {
        const r = new Array(n).fill(0).concat(new Array(n).fill(1)),
...
`
          : ''),
      (Kc = (e, t, n, r, o) => {
        const [s, a, u, d] = n.length === 2 ? [-1, 0, 1, -1] : [0, 2, 3, 1],
          l = e.type.value;
        return `
      ...
      ${(() => {
        switch (t.mode) {
          ...
          case 'cubic':
            ...
            ${(() => {
              if (s.length === 2 || s.length === 4)
                return `${jc(c, l, s, u, d, a, t.cubicCoeffA, m, t.extrapolationValue, t.excludeOutside)}`;
              throw Error(
...
`
      ...
      (nu = (e, t) => {
        ...
        Rc(e.inputs, t, i, n, r, o),
          e.compute(Qc(e.inputs[0], t, i, n, r, o), { inputs: [0] });
      }),
      (ru = (e) => {
        const t = e.antialias,
          n = e.axes,
...
var Yc,
  ...
  su = k(() => {
    ...
    (Yc = (e) => {
      ...
      const o = t.dims[t.dims.length - 1],
      ...
      (iu = (e, t) => {
        ...
        e.outputCount > 1 && r.push(-3),
          ...
          e.compute(Jc(e.inputs, t, e.outputCount, !1), { outputs: r });
      });
  });
var ep,
  fn,
  ...
  lu = k(() => {
    ...
    (ep = (e, t) => {
      ...
      (rp = (e, t) => {
        ...
        const s = t.starts.map((y, g) => au(y, g, n, o, i)),
          a = t.ends.map((y, g) => au(y, g, n, o, i));
        ...
        const l = { dims: d, dataType: e[0].dataType },
...
var fu,
  ...
  gu = k(() => {
    ...
    F();
    j();
    (fu = (e) => Array.from(e.getBigInt64Array(), Number)),
      (sp = (e) => {
  ...
  bu = k(() => {
    ...
    (dp = (e, t, n, r, o) => {
      ...
      if (!r)
        ...
        const c = (p, f, m = '') => {
          const h = `a_data[index_a${f}][component_a${f}]`,
      ...
      (lp = (e) => {
        let t = e[1].dims,
          ...
          a = x.size(t);
        if (i) {
          const d = Pe.calcShape(Pe.calcShape(t, n, !1), r, !1);
          if (!d)
            throw new Error("Can't perform where op on the given tensors");
          (s = d), (a = x.size(s));
        }
        const u = Math.ceil(a / 4);
        return {
          name: 'Where',
          shaderCache: { inputDependencies: ['rank', 'rank', 'rank'] },
          getShaderSource: (d) => dp(d, e, s, i, o),
          getRunData: () => ({
            outputs: [{ dims: s, dataType: o }],
  ...
  $u = k(() => {
    ...
    hn = class {
      ...
      build(t, n) {
        ...
        const s = Io(n, this.backend.device.limits),
...
${a}`,
        ...
        const l = r.createComputePipeline({
    ...
    (cp = (e, t) => {
      ...
      for (let r = 0; r < e.length; ++r) {
        ...
        switch (t[r]) {
          ...
          case 'rank': {
            const i = e[r].dims.length;
            n.push(`${o};${i}`);
            break;
          }
          case 'dims': {
            const i = e[r].dims.join(',');
            n.push(`${o};${i}`);
            break;
          }
          default:
      ...
      (pp = (e, t, n) => {
        ...
        return (
          ...
          (r +=
            ':' +
            n +
            `:${cp(t, e.shaderCache?.inputDependencies ?? new Array(t.length).fill('dims'))}`),
          r
        );
      }),
      (cr = class {
      ...
      (pr = class {
        ...
        async initialize(t, n) {
          ...
          i('chromium-experimental-timestamp-query-inside-passes') ||
            ...
            (this.adapterInfo = new cr(
              n.info || (await n.requestAdapterInfo())
            )),
            (this.gpuDataManager = xo(this)),
            (this.programManager = new hn(this)),
        ...
        getComputePassEncoder() {
          if (!this.computePassEncoder) {
            const t = this.getCommandEncoder(),
              n = {};
          ...
          this.queryType !== 'none' &&
            ...
            this.queryType !== 'none' &&
              t.mapAsync(GPUMapMode.READ).then(() => {
                const n = new BigUint64Array(t.getMappedRange()),
                ...
                for (let o = 0; o < n.length / 2; o++) {
                  ...
                  const h = Number(f - this.queryTimeBase),
        ...
        run(t, n, r, o, i, s) {
          ...
          for (let _ = 0; _ < n.length; ++_) {
            const w = n[_].data;
            if (w === 0) continue;
            const v = this.gpuDataManager.get(w);
          ...
          for (let _ = 0; _ < u.length; ++_) {
            ...
            const T = this.gpuDataManager.get($.data);
          ...
          if (a.length !== n.length || f.length !== p.length) {
            if (f.length === 0) return ge(t.name), p;
            throw new Error(
          ...
          if (l) {
            let _ = 0,
              w = [];
            l.forEach((I) => {
              const A = typeof I.data == 'number' ? [I.data] : I.data;
              if (A.length === 0) return;
              let z = I.type === 10 ? 2 : 4,
                R,
                D;
              I.type === 10
                ? ((D = A.length > 4 ? 16 : A.length > 2 ? 8 : A.length * z),
                  (R = A.length > 4 ? 16 : z * A.length))
                : ((D = A.length <= 2 ? A.length * z : 16), (R = 16)),
                (_ = Math.ceil(_ / D) * D),
                w.push(_);
              const U = I.type === 10 ? 8 : 4;
              _ += A.length > 4 ? Math.ceil(A.length / U) * R : A.length * z;
            });
            const v = 16;
            _ = Math.ceil(_ / v) * v;
            const $ = new ArrayBuffer(_);
            l.forEach((I, A) => {
              const z = w[A],
                R = typeof I.data == 'number' ? [I.data] : I.data;
            ...
            const T = this.gpuDataManager.create(
              _,
          ...
          return this.programManager.run(g, a, f, h, m), ge(t.name), p;
        }
        upload(t, n) {
        ...
        releaseKernel(t) {
          const n = this.kernelPersistentData.get(t);
          if (n) {
            for (const r of n) this.gpuDataManager.release(r.id);
            this.kernelPersistentData.delete(t);
          }
          this.kernelCustomData.delete(t), this.kernels.delete(t);
        }
        computeKernel(t, n, r) {
          const o = this.kernels.get(t);
          ...
          try {
            ...
            for (const l of this.temporaryData)
        ...
        unregisterBuffers(t) {
          const n = this.sessionExternalDataMapping.get(t);
          n &&
            (n.forEach((r) =>
        ...
        replay() {
          ...
          const t = this.capturedCommandList.get(this.currentSessionId),
    ...
    (_t = class e {
      ...
      (mr = class {
        constructor(t, n, r) {
          ...
          const a = Number(t.getValue(o * i++, s));
        ...
        compute(t, n) {
          const r =
            ...
            o = n?.outputs ?? [],
            i = (a, u, d) => new _t(this.module, u, this.output(a, d), d),
            s = (a, u) => {
              const d = He(a, u);
              if (!d) throw new Error(`Unsupported data type: ${a}`);
              const l = d > 0 ? this.backend.gpuDataManager.create(d).id : 0;
              return new _t(this.module, a, l, u);
            };
          return this.backend.run(t, r, o, i, s, this.outputCount);
        }
        output(t, n) {
          const r = this.module.stackSave();
          try {
      ...
      (mp = async (e, t, n, r) => {
        ...
        if (e === 'webgpu') {
          const i = (xu(), vt(vu)).WebGpuBackend,
            s = new i();
...
var fp,
  ...
  En = k(() => {
    ...
    (fp = (e, t) => {
      ...
      (kt = async (e) => {
        fp(e.wasm.numThreads, mt(e.logLevel));
      }),
      (Pt = async (e, t) => {
        te().asyncInit?.();
      ...
      (Iu = (e, t) => {
        ...
        try {
          ...
          const u = Number(n.getValue(s, '*'));
          o = Number(n.getValue(s + i, '*'));
          const d = n.HEAP32[o / 4];
          if (d === 0) return [u, 0];
          const l = n.HEAPU32[o / 4 + 1],
            c = [];
          for (let p = 0; p < l; p++) {
            const f = Number(n.getValue(o + 8 + p * i, '*'));
            c.push(
              f !== 0
                ? n.UTF8ToString(f)
      ...
      (zt = async (e, t) => {
        ...
        try {
          if (
            (([s, u] = await so(t)), t?.externalData && o.mountExternalData)
          ) {
            const w = [];
            for (const v of t.externalData) {
              const $ = typeof v == 'string' ? v : v.path;
              w.push(
                ft(typeof v == 'string' ? v : v.data).then((T) => {
          ...
          for (const w of t?.executionProviders ?? [])
      ...
      (Cu = async (e, t, n, r, o, i, s = !1) => {
        ...
        if (c === 'gpu-buffer') {
          const y = e[2].gpuBuffer;
          m = He(We(d), l);
          {
            const g = a.jsepRegisterBuffer;
            if (!g)
              throw new Error(
          ...
          const y = e[2].mlTensor;
          m = He(We(d), l);
          const g = a.webnnRegisterMLTensor;
          if (!g)
            throw new Error(
          ...
          if (Array.isArray(y)) {
            ...
            const g = a.webnnIsGraphInput,
              _ = a.webnnIsGraphOutput;
            if (d !== 'string' && g && _) {
              const w = a.UTF8ToString(o);
              if (g(r, w) || _(r, w)) {
                const v = We(d);
                (m = He(v, l)), (p = 'ml-tensor');
                const $ = a.webnnCreateTemporaryTensor,
        ...
        try {
          ...
          const y = a._OrtCreateTensor(We(d), f, m, b, l.length, Bn(p));
          y === 0 &&
            Y(
      ...
      (Dt = async (e, t, n, r, o, i) => {
        ...
        let d = u[0],
          ...
          R = s.stackAlloc(b * a);
        try {
          ([y, g] = oo(i)), Ne('wasm prepareInputOutputTensor');
          for (let O = 0; O < h; O++) await Cu(n[O], _, v, e, l[t[O]], t[O], f);
          for (let O = 0; O < b; O++)
            await Cu(o[O], w, v, e, c[r[O]], h + r[O], f);
          Le('wasm prepareInputOutputTensor');
          for (let O = 0; O < h; O++)
            s.setValue(I + O * a, _[O], '*'),
              s.setValue(A + O * a, l[t[O]], '*');
          for (let O = 0; O < b; O++)
            s.setValue(z + O * a, w[O], '*'),
              s.setValue(R + O * a, c[r[O]], '*');
          if (p && !m) {
            const {
              handle: O,
            ...
            for (let W = 0; W < h; W++) {
              const H = t[W];
              (await s._OrtBindInput(O, l[H], _[W])) !== 0 &&
                Y(`Can't bind input[${W}] for session=${e}.`);
            }
            for (let W = 0; W < b; W++) {
              const H = r[W];
              o[W]?.[3]
                ? ($.push(w[W]),
                  s._OrtBindOutput(O, c[H], w[W], 0) !== 0 &&
                    Y(
                      `Can't bind pre-allocated output[${W}] for session=${e}.`
                    ))
                : s._OrtBindOutput(O, c[H], 0, V[H]) !== 0 &&
                  Y(`Can't bind output[${W}] to ${M[W]} for session=${e}.`);
            }
            Le('wasm bindInputsOutputs'), tt.set(e, [d, l, c, p, f, !0]);
          }
          s.jsepOnRunStart?.(d), s.webnnOnRunStart?.(d);
          let D;
          p
            ? (D = await s._OrtRunWithBinding(d, p.handle, b, z, y))
            : (D = await s._OrtRun(d, A, I, h, R, b, z, y)),
            D !== 0 && Y('failed to call OrtRun().');
          const U = [],
            Q = [];
          Ne('wasm ProcessOutputTensor');
          for (let O = 0; O < b; O++) {
            const M = Number(s.getValue(z + O * a, '*'));
            if (M === w[O] || $.includes(w[O])) {
              U.push(o[O]),
                M !== w[O] &&
                  s._OrtReleaseTensor(M) !== 0 &&
            ...
            let V = s.stackSave(),
              ...
              oe = 0;
            try {
              s._OrtGetTensorData(M, W, W + a, W + 2 * a, W + 3 * a) !== 0 &&
                Y(`Can't access output tensor data on index ${O}.`);
              const q = a === 4 ? 'i32' : 'i64',
                E = Number(s.getValue(W, q));
              oe = s.getValue(W + a, '*');
              const N = s.getValue(W + a * 2, '*'),
                se = Number(s.getValue(W + a * 3, q)),
                ve = [];
              for (let me = 0; me < se; me++)
                ve.push(Number(s.getValue(N + me * a, q)));
              s._OrtFree(N) !== 0 && Y("Can't free memory for tensor dims.");
              const he = ve.reduce((me, ae) => me * ae, 1);
              X = Ee(E);
              const Ke = p?.outputPreferredLocations[r[O]];
              if (X === 'string') {
                if (Ke === 'gpu-buffer' || Ke === 'ml-tensor')
                  throw new Error('String tensor is not supported on GPU.');
                const me = [];
                for (let ae = 0; ae < he; ae++) {
                  const Ve = s.getValue(oe + ae * a, '*'),
                    $t = s.getValue(oe + (ae + 1) * a, '*'),
                    yr = ae === he - 1 ? void 0 : $t - Ve;
                  me.push(s.UTF8ToString(Ve, yr));
                }
                U.push([X, ve, me, 'cpu']);
              } else if (Ke === 'gpu-buffer' && he > 0) {
                const me = s.jsepGetBuffer;
                if (!me)
                  throw new Error(
                ...
                (H = !0),
                  U.push([
                    ...
                    {
                      gpuBuffer: ae,
                      download: s.jsepCreateDownloader(ae, Ve, X),
                      dispose: () => {
                        s._OrtReleaseTensor(M) !== 0 &&
                          Y("Can't release tensor.");
                      },
                ...
                (H = !0),
                  U.push([
                    ...
                    {
                      mlTensor: $t,
                      download: s.webnnCreateMLTensorDownloader(oe, X),
                      dispose: () => {
              ...
              } else if (Ke === 'ml-tensor-cpu-output' && he > 0) {
                const me = s.webnnCreateMLTensorDownloader(oe, X)(),
                  ae = U.length;
                (H = !0),
                  Q.push(
                    (async () => {
                      const Ve = [ae, await me];
                      return (
                        s.webnnReleaseTensorId(oe), s._OrtReleaseTensor(M), Ve
                      );
                    })()
                  ),
                  U.push([X, ve, [], 'cpu']);
                ...
                new Uint8Array(ae.buffer, ae.byteOffset, ae.byteLength).set(
                  s.HEAPU8.subarray(oe, oe + ae.byteLength)
                ),
                  U.push([X, ve, ae, 'cpu']);
              }
            } finally {
              s.stackRestore(V),
                X === 'string' && oe && s._free(oe),
                H || s._OrtReleaseTensor(M);
            }
          }
          p &&
            !f &&
            (s._OrtClearBoundOutputs(p.handle) !== 0 &&
              Y("Can't clear bound outputs."),
            tt.set(e, [d, l, c, p, f, !1]));
          for (const [O, M] of await Promise.all(Q)) U[O][2] = M;
          return Le('wasm ProcessOutputTensor'), U;
        } finally {
          s.webnnOnRunEnd?.(d),
            s.stackRestore(T),
            _.forEach((D) => s._OrtReleaseTensor(D)),
            w.forEach((D) => s._OrtReleaseTensor(D)),
            v.forEach((D) => s._free(D)),
            y !== 0 && s._OrtReleaseRunOptions(y),
            g.forEach((D) => s._free(D));
        }
      }),
      (Ot = (e) => {
        const t = te(),
...
var nt,
  ...
  gr = k(() => {
    ...
    Ge();
    At();
    (nt = () => !!ne.wasm.proxy && typeof document < 'u'),
      (wt = !1),
      (yn = !1),
      (bn = !1),
      (hr = new Map()),
      ...
      (ut = () => {
        if (wt || !yn || bn || !xe) throw new Error('worker not ready');
      }),
      (yp = (e) => {
        switch (e.data.type) {
          case 'init-wasm':
            (wt = !1),
              e.data.err
                ? ((bn = !0), fr[1](e.data.err))
                : ((yn = !0), fr[0]()),
              gn && (URL.revokeObjectURL(gn), (gn = void 0));
            break;
          case 'init-ep':
          case 'copy-from':
          case 'create':
      ...
      (Au = async () => {
        if (!yn) {
          if (wt) throw new Error("multiple calls to 'initWasm()' detected.");
          ...
          try {
            await Et(ne.wasm), await kt(ne), (yn = !0);
          } catch (e) {
            throw ((bn = !0), e);
          } finally {
            wt = !1;
      ...
      (Eu = async (e) => {
        if (nt())
          return (
            ...
            new Promise((t, n) => {
              at('init-ep', [t, n]);
              const r = { type: 'init-ep', in: { epName: e, env: ne } };
              xe.postMessage(r);
            })
          );
        await Pt(ne, e);
      ...
      (ku = async (e) =>
        nt()
          ? (ut(),
            new Promise((t, n) => {
              at('copy-from', [t, n]);
              const r = { type: 'copy-from', in: { buffer: e } };
      ...
      (Pu = async (e, t) => {
        if (nt()) {
          ...
          return (
            ...
            new Promise((n, r) => {
              at('create', [n, r]);
              const o = { type: 'create', in: { model: e, options: { ...t } } },
                i = [];
    ...
    (Ou = (e, t) => {
      ...
      (bp = (e) => {
        switch (e[3]) {
          ...
          case 'gpu-buffer': {
            ...
            const { gpuBuffer: n, download: r, dispose: o } = e[2];
          ...
          case 'ml-tensor': {
            ...
            const { mlTensor: n, download: r, dispose: o } = e[2];
      ...
      (_n = class {
        ...
        async run(t, n, r) {
          ...
          const u = o.map((p, f) =>
              Ou(p, () => `input "${this.inputNames[i[f]]}"`)
            ),
            d = s.map((p, f) =>
              p ? Ou(p, () => `output "${this.outputNames[a[f]]}"`) : null
            ),
            l = await Bu(this.sessionId, i, u, a, d, r),
            c = {};
          for (let p = 0; p < l.length; p++)
            c[this.outputNames[a[p]]] = s[p] ?? bp(l[p]);
          return ge(), c;
        }
        startProfiling() {}
        endProfiling() {
...
var kv = An;
{
  const e = (Vu(), vt(Ru)).wasmBackend;
  Ze('webgpu', e, 5), Ze('webnn', e, 5), Ze('cpu', e, 10), Ze('wasm', e, 10);
}
Object.defineProperty(ne.versions, 'web', { value: Fr, enumerable: !0 });
export {
  be as TRACE_FUNC_BEGIN,
  ge as TRACE_FUNC_END,
  kv as default,
  Le as TRACE_EVENT_END,
  Ne as TRACE_EVENT_BEGIN,
  ne as env,
  qu as InferenceSession,
  Se as Tensor,
  Tt as TRACE,
  Ze as registerBackend,
};
/**
 * @license
